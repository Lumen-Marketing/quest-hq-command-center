(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const _e={buildId:"Quest HQ Company Workspace v1",localUsername:"lumen123",localPassword:"lumen123",supabaseUrl:"https://lpzotcznihwyyudxycmd.supabase.co",supabaseKey:"sb_publishable_Gd1aHMtItu-7daoq2YofeA_9wl1pQ07"},ge=new URL("/quest-hq-command-center/",window.location.origin).pathname.replace(/\/$/,""),he="quest-hq-local-session",ma="quest-hq-local-profile",fa="quest-hq-job-cache-v2",ba="quest-hq-task-cache-v1",ga="quest-hq-file-cache-v1",va="quest-hq-drive-folder-cache-v1",ya="quest-hq-team-cache-v1",_a="quest-hq-company-membership-cache-v1",Pe="quest-hq-company-form-cache-v1",kt="quest-hq-company-form-response-cache-v1",ha="quest-hq-finance-invoice-cache-v1",$a="quest-hq-finance-payment-cache-v1",wa="quest-hq-finance-expense-cache-v1",Sa="quest-hq-finance-vendor-cache-v1",jt="quest-hq-time-entry-cache-v1",Dt="quest-hq-active-timer-v1",Se="quest-hq-active-company",ka="quest-hq-task-view",ja="quest-hq-drive-view",Zt={developer:["*"],admin:["*"],owner:["*"],manager:["jobs.view","jobs.manage","tasks.view","tasks.manage","files.view","files.manage","forms.view","forms.manage","finance.view","team.view","clock.manage","approvals.manage","approvals.view","users.view","settings.view","billing.view","roles.view"],member:["jobs.view","tasks.view","tasks.manage","files.view","forms.view","time.track","approvals.view","users.view"]},fi=[["jobs.view","View jobs"],["jobs.manage","Create/edit jobs"],["tasks.view","View tasks"],["tasks.manage","Create/edit tasks"],["files.view","View files"],["files.manage","Upload/delete files"],["forms.view","View forms"],["forms.manage","Create/edit forms"],["crm.view","View CRM"],["finance.view","View finance"],["finance.manage","Create/edit finance"],["users.view","View users"],["users.manage","Invite/manage users"],["roles.view","View roles"],["roles.manage","Create/edit roles"],["billing.view","View billing"],["billing.manage","Manage subscription"],["settings.view","View settings"],["settings.manage","Manage settings"],["time.track","Track own time"],["clock.manage","Manage clock dashboard"],["approvals.view","View approvals"],["approvals.manage","Manage approvals"]],Xe=[{id:"jobs",group:"Workspace",label:"Jobs",icon:"ti-briefcase",symbol:"q-symbol-jobs",status:"live",permission:"jobs.view"},{id:"tasks",group:"Workspace",label:"Tasks",icon:"ti-list-check",symbol:"q-symbol-tasks",status:"live",permission:"tasks.view"},{id:"files",group:"Workspace",label:"Files",icon:"ti-folder",symbol:"q-symbol-files",status:"live",permission:"files.view"},{id:"forms",group:"Workspace",label:"Forms",icon:"ti-clipboard-list",symbol:"q-symbol-forms",status:"live",permission:"forms.view"},{id:"analytics",group:"Workspace",label:"Analytics",icon:"ti-chart-bar",symbol:"q-symbol-analytics",status:"live",permission:"jobs.view"},{id:"crm",group:"Workspace",label:"CRM",icon:"ti-users-group",symbol:"q-symbol-crm",status:"live",permission:"crm.view"},{id:"tickets",group:"Workspace",label:"Tickets",icon:"ti-ticket",symbol:"q-symbol-tickets",status:"planned"},{id:"finance",group:"Workspace",label:"Finance",icon:"ti-receipt-dollar",symbol:"q-symbol-finance",status:"live",permission:"finance.view"},{id:"knowledge",group:"Workspace",label:"Knowledge Base",icon:"ti-books",symbol:"q-symbol-knowledge",status:"planned"},{id:"automations",group:"Workspace",label:"Automations",icon:"ti-automation",symbol:"q-symbol-automations",status:"planned"},{id:"templates",group:"Workspace",label:"Templates",icon:"ti-template",symbol:"q-symbol-templates",status:"planned"},{id:"users",group:"Company",label:"Users",icon:"ti-users",symbol:"q-symbol-users",status:"live",permission:"users.view"},{id:"settings",group:"Company",label:"Settings",icon:"ti-settings",symbol:"q-symbol-settings",status:"live",permission:"settings.view"},{id:"team-chart",group:"Company",label:"Team chart",icon:"ti-hierarchy-3",symbol:"q-symbol-team-chart",status:"live",permission:"team.view"},{id:"time",group:"Operations",label:"My time",icon:"ti-clock",symbol:"q-symbol-time",status:"live",permission:"time.track"},{id:"approvals",group:"Operations",label:"Approvals",icon:"ti-user-check",symbol:"q-symbol-approvals",status:"live",permission:"approvals.view"},{id:"team-workload",group:"Operations",label:"Team workload",icon:"ti-users",symbol:"q-symbol-team-workload",status:"planned"},{id:"clock",group:"Operations",label:"Clock dashboard",icon:"ti-clock-hour-4",symbol:"q-symbol-clock",status:"live",permission:"clock.manage"}],bi={"/admin.html":"settings","/automations.html":"automations","/crm.html":"crm","/dashboards.html":"analytics","/files.html":"files","/finance.html":"finance","/forms.html":"forms","/jobs.html":"jobs","/knowledge.html":"knowledge","/templates.html":"templates","/tickets.html":"tickets"},Re=["Lead","Site Review","Estimate","Approved","Active","Closed"],Da=["pipeline","list","profile"],Ne=["todo","pending","hold","review","done"],Ye=["critical","urgent","high","medium","low"],Ca=["lead","bid","admin","invoicing","ar","meeting","web_dev"],gi=["All categories","Shared","Jobs","Forms","Photos","Permits","Contracts","Archive"],Ct=[["jobs","Jobs","Job-linked folders and deliverables","ti-folders"],["shared","Shared","Company-wide files","ti-folder-share"],["forms","Forms","Completed forms and templates","ti-clipboard-list"],["photos","Photos","Site photos and field media","ti-photo"],["permits","Permits","Permit packets and approvals","ti-file-certificate"],["contracts","Contracts","Signed agreements and estimates","ti-file-dollar"],["archive","Archive","Closed or historical files","ti-archive"]],Le=["Inspection","Client approval","Intake","Survey","Safety","Internal"],qt=["Draft","Published","Archived"],qa=["Draft","Sent","Partially paid","Paid","Overdue","Void"],Fa=["Pending","Approved","Paid","Rejected"],Ia=["Active","On hold","Inactive"],xa=["ACH","Check","Card","Cash","Wire","Other"],et=["Materials","Labor","Subcontractor","Permit","Equipment","Marketing","Software","Travel","Other"],Ue=[["short","Short answer"],["paragraph","Paragraph"],["multiple","Multiple choice"],["checkbox","Checkboxes"],["dropdown","Dropdown"],["date","Date"],["rating","Rating"],["yesno","Yes / No"],["file","File upload"]],$e=[{id:"roofing",name:"Quest Roofing",short_name:"Roofing",color:"#f0b23b"},{id:"drafting",name:"Quest Drafting",short_name:"Drafting",color:"#60a5fa"},{id:"lumen",name:"Lumen Marketing",short_name:"Lumen",color:"#a78bfa"}],vi=[{id:"11111111-1111-4111-8111-111111111111",company_id:"roofing",name:"Queen Creek Leak Follow-up",client_name:"Rosales Residence",contact_name:"Maya Rosales",site_address:"Queen Creek, AZ",job_type:"Roofing repair",stage:"Active",priority:"Urgent",owner_name:"Andre Lee",scope:"Emergency leak inspection, dry-in, and repair proposal.",notes:"Client reported active leak after monsoon storm.",estimate_total:6800,invoice_total:0,task_count:4,file_count:5,updated_at:new Date().toISOString()},{id:"22222222-2222-4222-8222-222222222222",company_id:"roofing",name:"Mesa Storage Roof Repair",client_name:"Mesa Storage Partners",contact_name:"D. Harris",site_address:"Mesa, AZ",job_type:"Commercial repair",stage:"Estimate",priority:"High",owner_name:"Maya Rosales",scope:"Inspect roof membrane, prepare repair estimate, and attach permit packet.",notes:"Board wants estimate and permit notes before approval.",estimate_total:18400,invoice_total:0,task_count:3,file_count:4,updated_at:new Date(Date.now()-864e5).toISOString()},{id:"33333333-3333-4333-8333-333333333333",company_id:"drafting",name:"Drafting Permit Package",client_name:"Horizon HVAC",contact_name:"Noah Park",site_address:"Chandler, AZ",job_type:"Drafting",stage:"Site Review",priority:"Medium",owner_name:"Noah Park",scope:"Prepare drawing package and client approval form.",notes:"Waiting on latest measurements.",estimate_total:4200,invoice_total:0,task_count:2,file_count:3,updated_at:new Date(Date.now()-1728e5).toISOString()}],yi=[{id:"abraham",name:"Abraham",full_name:"Abraham Flores",email:"abraham@quest-hq.local",color:"#f0b23b",active:!0,company_ids:["roofing","drafting"],supervisor_id:""},{id:"maya",name:"Maya",full_name:"Maya Rosales",email:"maya@quest-hq.local",color:"#60a5fa",active:!0,company_ids:["roofing"],supervisor_id:"abraham"},{id:"andre",name:"Andre",full_name:"Andre Lee",email:"andre@quest-hq.local",color:"#f97316",active:!0,company_ids:["roofing"],supervisor_id:"maya"},{id:"noah",name:"Noah",full_name:"Noah Park",email:"noah@quest-hq.local",color:"#a78bfa",active:!0,company_ids:["drafting"],supervisor_id:"abraham"},{id:"lumen-ops",name:"Lumen Ops",full_name:"Lumen Operations",email:"ops@lumen.local",color:"#7c3aed",active:!0,company_ids:["lumen"],supervisor_id:""}],_i=[{company_id:"roofing",profile_id:"basic-quest-user",role:"developer",status:"active"},{company_id:"drafting",profile_id:"basic-quest-user",role:"developer",status:"active"},{company_id:"lumen",profile_id:"basic-quest-user",role:"developer",status:"active"}],hi=[{id:"task-roofing-leak-1",title:"Call client and confirm active leak area",description:"Confirm access window, roof area, and whether temporary dry-in is still holding.",type:"lead",company_id:"roofing",project_id:"11111111-1111-4111-8111-111111111111",creator_id:"abraham",assignee_id:"maya",due:h(0),priority:"urgent",urgency:"urgent",status:"todo"},{id:"task-roofing-leak-2",title:"Upload inspection photos",description:"Attach site photos to the company drive and tag the Queen Creek job folder.",type:"admin",company_id:"roofing",project_id:"11111111-1111-4111-8111-111111111111",creator_id:"maya",assignee_id:"andre",due:h(1),priority:"high",urgency:"high",status:"pending"},{id:"task-roofing-mesa-1",title:"Prepare repair estimate packet",description:"Draft scope, estimate total, and permit notes for board review.",type:"bid",company_id:"roofing",project_id:"22222222-2222-4222-8222-222222222222",creator_id:"abraham",assignee_id:"maya",due:h(3),priority:"high",urgency:"high",status:"review"},{id:"task-drafting-package-1",title:"Request final measurements",description:"Get latest field measurements before starting permit drawings.",type:"admin",company_id:"drafting",project_id:"33333333-3333-4333-8333-333333333333",creator_id:"abraham",assignee_id:"noah",due:h(2),priority:"medium",urgency:"medium",status:"hold"},{id:"task-lumen-ops-1",title:"Create client onboarding checklist",description:"Internal Lumen setup task to prove company workspace isolation.",type:"meeting",company_id:"lumen",project_id:"",creator_id:"abraham",assignee_id:"lumen-ops",due:h(5),priority:"medium",urgency:"medium",status:"todo"}],$i=[{id:"file-roofing-1",company_id:"roofing",job_id:"11111111-1111-4111-8111-111111111111",folder:"photos",file_name:"queen-creek-leak-photos.zip",mime_type:"application/zip",size_bytes:184e5,category:"Photos",uploaded_by_label:"Maya Rosales",created_at:new Date(Date.now()-36e5).toISOString()},{id:"file-roofing-2",company_id:"roofing",job_id:"22222222-2222-4222-8222-222222222222",folder:"permits",file_name:"mesa-storage-permit-notes.pdf",mime_type:"application/pdf",size_bytes:86e4,category:"Permits",uploaded_by_label:"Andre Lee",created_at:new Date(Date.now()-864e5).toISOString()},{id:"file-drafting-1",company_id:"drafting",job_id:"33333333-3333-4333-8333-333333333333",folder:"contracts",file_name:"horizon-hvac-drawing-agreement.pdf",mime_type:"application/pdf",size_bytes:42e4,category:"Contracts",uploaded_by_label:"Noah Park",created_at:new Date(Date.now()-1728e5).toISOString()},{id:"file-lumen-1",company_id:"lumen",job_id:"",folder:"shared",file_name:"lumen-shared-brand-assets.zip",mime_type:"application/zip",size_bytes:32e5,category:"Shared",uploaded_by_label:"Lumen Operations",created_at:new Date(Date.now()-2592e5).toISOString()}],wi=[{id:"form-roofing-inspection",company_id:"roofing",title:"Roof Inspection Checklist",description:"Field checklist for leak calls, roof condition notes, photos, and repair recommendations.",type:"Inspection",status:"Published",audience:"Field team",creator_id:"abraham",linked_job_id:"11111111-1111-4111-8111-111111111111",theme_color:"#f0b23b",background:"paper",submit_label:"Submit inspection",collect_email:!0,require_approval:!1,created_at:new Date(Date.now()-6048e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString(),questions:[{id:"q-roof-1",type:"short",label:"Inspection address",help:"Confirm the address before submitting.",required:!0},{id:"q-roof-2",type:"multiple",label:"Primary roof condition",help:"",required:!0,options:["Active leak","Storm damage","Aged underlayment","Maintenance issue"]},{id:"q-roof-3",type:"paragraph",label:"Recommended scope",help:"Write the repair or estimate recommendation.",required:!0},{id:"q-roof-4",type:"file",label:"Attach inspection photos",help:"Upload photos into the company drive after submit.",required:!1}]},{id:"form-roofing-estimate-approval",company_id:"roofing",title:"Estimate Approval",description:"Client-facing approval form for estimate review and signature follow-up.",type:"Client approval",status:"Draft",audience:"Client",creator_id:"maya",linked_job_id:"22222222-2222-4222-8222-222222222222",theme_color:"#f45d22",background:"clean",submit_label:"Approve estimate",collect_email:!0,require_approval:!0,created_at:new Date(Date.now()-432e6).toISOString(),updated_at:new Date(Date.now()-72e5).toISOString(),questions:[{id:"q-est-1",type:"short",label:"Client name",required:!0},{id:"q-est-2",type:"yesno",label:"Do you approve the attached estimate?",required:!0},{id:"q-est-3",type:"paragraph",label:"Questions or requested changes",required:!1}]},{id:"form-drafting-intake",company_id:"drafting",title:"Drafting Permit Intake",description:"Collect measurements, equipment details, and permit packet requirements.",type:"Intake",status:"Published",audience:"Client",creator_id:"noah",linked_job_id:"33333333-3333-4333-8333-333333333333",theme_color:"#60a5fa",background:"grid",submit_label:"Send intake",collect_email:!0,require_approval:!1,created_at:new Date(Date.now()-5184e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString(),questions:[{id:"q-draft-1",type:"short",label:"Project address",required:!0},{id:"q-draft-2",type:"paragraph",label:"Permit notes",required:!1},{id:"q-draft-3",type:"date",label:"Needed by",required:!0}]},{id:"form-lumen-onboarding",company_id:"lumen",title:"Client Onboarding Intake",description:"Initial Lumen setup form for client goals, assets, users, and launch timing.",type:"Intake",status:"Draft",audience:"Client",creator_id:"lumen-ops",linked_job_id:"",theme_color:"#a78bfa",background:"clean",submit_label:"Submit onboarding",collect_email:!0,require_approval:!1,created_at:new Date(Date.now()-3456e5).toISOString(),updated_at:new Date(Date.now()-2592e5).toISOString(),questions:[{id:"q-lumen-1",type:"short",label:"Company name",required:!0},{id:"q-lumen-2",type:"checkbox",label:"Needed services",required:!0,options:["Website","SEO","Paid ads","CRM setup"]},{id:"q-lumen-3",type:"paragraph",label:"Launch goals",required:!1}]}],Si=[{id:"response-roofing-1",company_id:"roofing",form_id:"form-roofing-inspection",submitted_by:"Maya Rosales",created_at:new Date(Date.now()-36e5).toISOString(),answers:{"q-roof-1":"Queen Creek, AZ","q-roof-2":"Active leak","q-roof-3":"Dry-in held. Prepare repair estimate and photo packet."}}],ki=[{id:"vendor-roofing-materials",company_id:"roofing",name:"Valley Roofing Supply",contact_name:"Elena Ortiz",email:"orders@valleyroofingsupply.local",phone:"(480) 555-0190",category:"Materials",status:"Active",notes:"Primary tile, flashing, and underlayment vendor.",created_at:new Date(Date.now()-12096e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"vendor-roofing-dryin",company_id:"roofing",name:"Monsoon Dry-In Crew",contact_name:"R. Alvarez",email:"dispatch@monsoondryin.local",phone:"(602) 555-0144",category:"Subcontractor",status:"Active",notes:"Emergency dry-in support during storm calls.",created_at:new Date(Date.now()-10368e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()},{id:"vendor-drafting-permits",company_id:"drafting",name:"Permit Runner AZ",contact_name:"Sofia Chen",email:"permits@runneraz.local",phone:"(602) 555-0171",category:"Permit",status:"Active",notes:"Permit filing support for drafting packets.",created_at:new Date(Date.now()-864e6).toISOString(),updated_at:new Date(Date.now()-2592e5).toISOString()},{id:"vendor-lumen-software",company_id:"lumen",name:"Lumen SaaS Stack",contact_name:"Ops Billing",email:"billing@lumenstack.local",phone:"",category:"Software",status:"Active",notes:"Internal software subscriptions for client onboarding.",created_at:new Date(Date.now()-7776e5).toISOString(),updated_at:new Date(Date.now()-3456e5).toISOString()}],ji=[{id:"invoice-roofing-queen-creek",company_id:"roofing",job_id:"11111111-1111-4111-8111-111111111111",client_name:"Rosales Residence",invoice_number:"QR-1007",status:"Partially paid",issue_date:h(-10),due_date:h(5),subtotal:6800,tax:0,total:6800,notes:"Emergency leak repair billing with deposit received.",created_at:new Date(Date.now()-864e6).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"invoice-roofing-mesa-storage",company_id:"roofing",job_id:"22222222-2222-4222-8222-222222222222",client_name:"Mesa Storage Partners",invoice_number:"QR-1008",status:"Sent",issue_date:h(-18),due_date:h(-2),subtotal:18400,tax:0,total:18400,notes:"Estimate packet sent to board for approval.",created_at:new Date(Date.now()-15552e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()},{id:"invoice-drafting-horizon",company_id:"drafting",job_id:"33333333-3333-4333-8333-333333333333",client_name:"Horizon HVAC",invoice_number:"QD-2031",status:"Sent",issue_date:h(-7),due_date:h(14),subtotal:4200,tax:0,total:4200,notes:"Drafting permit package milestone invoice.",created_at:new Date(Date.now()-6048e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()},{id:"invoice-lumen-onboarding",company_id:"lumen",job_id:"",client_name:"Lumen Internal Launch",invoice_number:"LM-3004",status:"Draft",issue_date:h(-3),due_date:h(27),subtotal:3200,tax:0,total:3200,notes:"Demo onboarding package used for finance workspace.",created_at:new Date(Date.now()-2592e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()}],Di=[{id:"payment-roofing-queen-creek-deposit",company_id:"roofing",invoice_id:"invoice-roofing-queen-creek",amount:2500,method:"ACH",received_at:h(-4),reference:"ACH-4421",notes:"Deposit received after dry-in visit.",created_at:new Date(Date.now()-3456e5).toISOString()},{id:"payment-drafting-horizon-retainer",company_id:"drafting",invoice_id:"invoice-drafting-horizon",amount:1e3,method:"Check",received_at:h(-1),reference:"CHK-117",notes:"Retainer collected before permit packet completion.",created_at:new Date(Date.now()-864e5).toISOString()}],Ci=[{id:"expense-roofing-queen-creek-materials",company_id:"roofing",job_id:"11111111-1111-4111-8111-111111111111",vendor_id:"vendor-roofing-materials",category:"Materials",amount:1850,status:"Approved",spent_at:h(-6),notes:"Underlayment, flashing, and tile replacement materials.",created_at:new Date(Date.now()-5184e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"expense-roofing-mesa-permit",company_id:"roofing",job_id:"22222222-2222-4222-8222-222222222222",vendor_id:"vendor-roofing-materials",category:"Permit",amount:620,status:"Pending",spent_at:h(-2),notes:"Permit and document prep allowance.",created_at:new Date(Date.now()-1728e5).toISOString(),updated_at:new Date(Date.now()-72e5).toISOString()},{id:"expense-drafting-horizon-runner",company_id:"drafting",job_id:"33333333-3333-4333-8333-333333333333",vendor_id:"vendor-drafting-permits",category:"Permit",amount:480,status:"Approved",spent_at:h(-3),notes:"Permit runner package review.",created_at:new Date(Date.now()-2592e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"expense-lumen-software-stack",company_id:"lumen",job_id:"",vendor_id:"vendor-lumen-software",category:"Software",amount:540,status:"Paid",spent_at:h(-5),notes:"Client onboarding software stack.",created_at:new Date(Date.now()-432e6).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()}],n={route:null,session:Ce(he,null),profileDraft:Ce(ma,null),authReady:!1,authMode:"signin",jobs:V(fa,vi).map(Ae),tasks:V(ba,hi).map(Te),files:V(ga,$i).map(Ge),driveFolders:V(va,[]).map(Ka),forms:V(Pe,wi).map(ct),formResponses:V(kt,Si).map(Ga),financeInvoices:V(ha,ji).map(Qt),financePayments:V($a,Di).map(Vt),financeExpenses:V(wa,Ci).map(Jt),financeVendors:V(Sa,ki).map(Bt),timeEntries:Ce(jt,[]),activeTimer:Ce(Dt,null),teamMembers:V(ya,yi).map(Za),memberships:V(_a,_i),profiles:[],subscriptions:[],roles:[],rolePermissions:[],roleAssignments:[],resourceAcl:[],fieldPermissions:[],companyInvites:[],joinRequests:[],auditEvents:[],companies:$t($e.map(xe)),activeCompanyId:localStorage.getItem(Se)||"",selectedJobId:"",selectedTaskId:"",selectedFileId:"",selectedFormId:"",selectedQuestionId:"",selectedFinanceInvoiceId:"",selectedFinanceExpenseId:"",selectedFinanceVendorId:"",expandedFormIds:new Set,formStartTemplateId:"",formStartTab:"blank",query:"",fileQuery:"",formQuery:"",crmQuery:"",stageFilter:"all",crmStageFilter:"all",crmOwnerFilter:"all",taskStatusFilter:"all",taskPriorityFilter:"all",fileCategoryFilter:"All categories",formTypeFilter:"all",formsTab:"library",formEditorTab:"questions",taskView:localStorage.getItem(ka)||"table",driveFolder:"home",driveView:localStorage.getItem(ja)||"list",sync:{label:"Loading workspace...",mode:"loading"},dataLoaded:!1,dataLoading:!1,loginError:"",authMessage:"",modal:""},tt=document.getElementById("app");qi();function qi(){Es(),window.addEventListener("popstate",u),document.addEventListener("click",os),document.addEventListener("submit",ds),document.addEventListener("input",ys),document.addEventListener("change",_s),Fi(),u()}async function Fi(){const e=N();if(!e?.auth){n.authReady=!0,n.loginError="Supabase auth is unavailable in this browser session.";return}try{const{data:t}=await e.auth.getSession();await Fe(t?.session||null),e.auth.onAuthStateChange((a,i)=>{Fe(i||null).finally(()=>{n.dataLoaded=!1,u()})})}catch(t){n.loginError=t.message||"Unable to initialize Supabase auth."}finally{n.authReady=!0,u()}}async function Fe(e){if(!e?.user){n.session=null,localStorage.removeItem(he);return}const t=await Ii(e.user);n.session=fr(e,t),I(he,n.session)}async function Ii(e){const t={id:e.id,email:e.email||"",full_name:e.user_metadata?.full_name||e.email||"Quest user",role:"member",role_label:"Member",member_id:"",company_ids:[],avatar_url:"",approved:!1},a=N();if(!a)return t;const i=await a.from("profiles").select("*").eq("id",e.id).maybeSingle();return i.error||!i.data?t:Ht(i.data,t)}function u(){if(n.route=at(),!n.authReady){Ti();return}if(Ai(n.route)){S("/login?return_url="+encodeURIComponent(Ps()),{replace:!0});return}if(n.route.name==="login"){Yn();return}if(Mi(),n.session?.auth==="supabase"&&n.dataLoaded&&!ke().length){xi();return}const e=Os(n.route);if(e){S(e,{replace:!0});return}Qs(n.route),Oa(n.route),n.route.params.get("account")==="profile"&&(n.modal="profile"),document.title=`${Rs(n.route)} | ${k(p())} | Quest HQ`,tt.innerHTML=Pi(n.route,Ma(n.route))}function xi(){document.title="Company access pending | Quest HQ",tt.innerHTML=`
  ...
  `}function Ai(e){return e.name==="login"?!1:!n.session}function Ti(){document.title="Loading | Quest HQ",tt.innerHTML=`
    <main class="login-shell">
      <section class="login-panel">
        <div class="login-brand">
          <span class="side-mark">Q</span>
  ...
  `}function Mi(){n.dataLoaded||n.dataLoading||(n.dataLoading=!0,Ei().catch(()=>{n.sync={label:"Local fallback",mode:"local"}}).finally(()=>{n.dataLoaded=!0,n.dataLoading=!1,B(),u()}))}async function Ei(){const e=N();if(!e){n.sync={label:"Supabase unavailable",mode:"local"};return}const[t,a,i,s,o,c,l,m,y,f,j,L,C,H,je,le]=await Promise.all([e.from("companies").select("*").order("name",{ascending:!0}),e.from("jobs").select("*").order("updated_at",{ascending:!1}),e.from("tasks").select("*").order("updated_at",{ascending:!1}),e.from("job_files").select("*").is("deleted_at",null).order("created_at",{ascending:!1}),e.from("team_members").select("*").order("name",{ascending:!0}),e.from("company_memberships").select("*"),e.from("profiles").select("*"),e.from("company_subscriptions").select("*"),e.from("roles").select("*").order("priority",{ascending:!1}),e.from("role_permissions").select("*"),e.from("user_role_assignments").select("*"),e.from("resource_acl").select("*"),e.from("field_permissions").select("*"),e.from("company_invites").select("*").order("created_at",{ascending:!1}),e.from("company_join_requests").select("*").order("created_at",{ascending:!1}),e.from("audit_events").select("*").order("created_at",{ascending:!1}).limit(100)]);let W=0;t.error||(n.companies=t.data?.length?$t($e.concat(t.data).map(xe)):$t($e.map(xe)),W+=1),a.error||(a.data?.length&&(n.jobs=a.data.map(Ae)),W+=1),i.error||(i.data?.length&&(n.tasks=i.data.map(Te)),W+=1),s.error||(s.data?.length&&(n.files=s.data.map(Ge)),W+=1),o.error||(o.data?.length&&(n.teamMembers=o.data.map(Za)),W+=1),c.error||(c.data?.length&&(n.memberships=c.data.map(Xs)),W+=1),l.error||(n.profiles=(l.data||[]).map(mi=>Ht(mi)),W+=1),m.error||(n.subscriptions=(m.data||[]).map(er),W+=1),y.error||(n.roles=(y.data||[]).map(ve),W+=1),f.error||(n.rolePermissions=(f.data||[]).map(wt)),j.error||(n.roleAssignments=(j.data||[]).map(tr)),L.error||(n.resourceAcl=(L.data||[]).map(ar)),C.error||(n.fieldPermissions=(C.data||[]).map(ir)),H.error||(n.companyInvites=(H.data||[]).map(nr)),je.error||(n.joinRequests=(je.data||[]).map(sr)),le.error||(n.auditEvents=le.data||[]),n.sync=W?{label:"Quest Supabase live",mode:"live"}:{label:"Local fallback",mode:"local"}}function N(){return!window.supabase||typeof window.supabase.createClient!="function"?null:window.supabase.createClient(_e.supabaseUrl,_e.supabaseKey)}function Oi(){return`
  ...
  `}function G(e,t="symbol-icon"){return`<svg class="${r(t)}" aria-hidden="true" focusable="false"><use href="#${r(e)}"></use></svg>`}function Aa(e=n.route?.section||"jobs"){return Xe.find(t=>t.id===e)?.symbol||"q-empty"}function Ta(e){const t=String(e||"").toLowerCase();return t.includes("job")||t.includes("pipeline")?"q-symbol-jobs":t.includes("task")||t.includes("review")?"q-symbol-tasks":t.includes("file")?"q-symbol-files":t.includes("form")?"q-symbol-forms":t.includes("account")||t.includes("customer")||t.includes("member")||t.includes("user")||t.includes("lead")?"q-symbol-crm":t.includes("invoice")||t.includes("collected")||t.includes("expense")||t.includes("net")||t.includes("outstanding")?"q-symbol-finance":t.includes("time")||t.includes("today")||t.includes("days")||t.includes("timer")||t.includes("entries")?"q-symbol-clock":t.includes("approval")||t.includes("access")?"q-symbol-approvals":Aa()}function Pi(e,t){const a=E(),i=p();return`
        ...
        <div class="topbar-right">
          <label class="company-switch">
            ...
            <select data-company-switch aria-label="Active company">
              ${za().map(s=>`<option value="${r(s.id)}" ${s.id===i?"selected":""}>${r(rt(s))}</option>`).join("")}
            </select>
          </label>
    ...
    ${Zn(e,a)}
  `}function Ri(e){const t=p();return`
    ...
    ${["Workspace","Company","Operations"].map(a=>Ni(a,Xe.filter(i=>i.group===a&&Qi(i,t)).map(i=>i.status==="planned"?Ui(i.symbol,i.label):Li(e,d(i.id,{},t),i.symbol,i.label,Vi(i.id,t))))).join("")}
  `}function Ni(e,t){return`
    <section class="side-group">
      <div class="side-label">${r(e)}</div>
      <div class="side-items">${t.join("")}</div>
    </section>
  `}function Li(e,t,a,i,s=""){return`
    <a class="side-item ${Ns(e,t)?"active":""}" href="${b(t)}" data-router>
      ${G(a)}
      <span>${r(i)}</span>
      ${s!==""?`<b>${r(String(s))}</b>`:""}
    </a>
  ...
  `}function Qi(e,t=p()){return e.status==="planned"?!0:!Ut(t)&&!["settings","users"].includes(e.id)?!1:Wa(e.permission||`${e.id}.view`,t)}function Vi(e,t=p()){return e==="jobs"?A(t).length:e==="tasks"?z(t).length:e==="files"?pe(t).length:e==="forms"?re(t).length:e==="crm"?it(t).length:e==="finance"?ue(t).length:e==="users"?ne(t).length:e==="time"?Ra(t).focus.length:e==="approvals"?Na(t).length:e==="clock"&&nt(t)?"On":""}function Ft(e,t){return`
    <nav class="tabbar compact-tabbar" aria-label="${r(e)}">
      ${t.map(([a,i,s])=>`<a class="${s?"active":""}" href="${b(a)}" data-router>${r(i)}</a>`).join("")}
    </nav>
  `}function Ma(e){if(e.name==="command")return Hi(p());if(e.name!=="company")return na(e.name);const t=e.companyId,a=Xe.find(i=>i.id===e.section);if(a?.status!=="planned"){if(!Ut(t)&&!["settings","users"].includes(e.section))return Ji(t);if(a?.permission&&!Wa(a.permission,t))return Bi(t,a.permission)}return e.section==="jobs"?Wi(e,t):e.section==="tasks"?Xi(e,t):e.section==="files"?sn(e,t):e.section==="users"?yn(e,t):e.section==="settings"?hn(e,t):e.section==="forms"?kn(t):e.section==="analytics"?zi(e,t):e.section==="crm"?On(e,t):e.section==="finance"?Rn(e,t):e.section==="team-chart"?_n(t):e.section==="time"||e.section==="approvals"||e.section==="clock"?Bn(e,t):na(e.section)}function Ji(e){return`
    ...
    `)}
    <section class="panel">
      ${P([["Company",k(e)],["Subscription",Ya(e)],["Allowed area","Billing and settings remain available to owners/admins"]])}
    </section>
  ...
  `}function Hi(e){const t=A(e),a=z(e),i=a.filter(o=>["critical","urgent"].includes(o.priority)),s=pe(e);return`
    ...
    `)}
    ${br([["Jobs",t.length],["Open tasks",a.filter(o=>o.status!=="done").length],["Urgent tasks",i.length],["Drive files",s.length]])}
    <section class="dashboard-grid">
      ...
      <article class="panel span-3">
        ...
        <div class="queue-list">
          ${t.slice(0,8).map(o=>gr(o)).join("")||g("No jobs in this company yet.")}
        </div>
      </article>
    </section>
  `}function zi(e,t){const a=e.jobId?D(e.jobId):null,i=a?[a]:A(t),s=z(t).filter(f=>!a||f.project_id===a.id),o=pe(t).filter(f=>!a||f.job_id===a.id),c=re(t).filter(f=>!a||f.linked_job_id===a.id),l=s.filter(f=>f.status!=="done"),m=s.filter(f=>f.status!=="done"&&f.due&&new Date(f.due)<ft()),y=K(i,"estimate_total");return`
    <section class="analytics-workspace">
      ...
      <section class="analytics-grid">
        ...
        <article class="panel analytics-score">
          ...
          <strong>${r(Hr(s.filter(f=>f.status==="done").length,s.length))}</strong>
        ...
        <article class="panel analytics-side">
          ...
          <div class="stage-bars">
            ${Ne.map(f=>{const j=s.filter(L=>L.status===f).length;return`<div><span>${r(oe(f))}</span><b><i style="width:${r(ui(j,s.length))}%"></i></b><strong>${r(j)}</strong></div>`}).join("")}
          </div>
        </article>
        <article class="panel span-3">
  ...
  `}function Wi(e,t){const a=Ls(e.params.get("tab")),i=de();return`
    ...
    <nav class="tabbar" aria-label="Job sections">
      ${Da.map(s=>`<a class="${s===a?"active":""}" href="${b(d("jobs",{tab:s,...i?{job_id:i.id}:{}},t))}" data-router>${r(Us(s))}</a>`).join("")}
    </nav>
    ${Yi(a,t,i)}
  `}function Yi(e,t,a){return e==="pipeline"?Xt(t):e==="list"?Ki(t):e==="profile"?Gi(t,a):Xt(t)}function Xt(e){const t=Pa(e);return`
    <section class="job-board">
      ${Re.map(a=>{const i=t.filter(s=>s.stage===a);return`
          <article class="job-lane">
            <h2><span>${r(a)}</span><b>${i.length}</b></h2>
            ${i.map(s=>vr(s)).join("")||'<div class="lane-empty">No jobs</div>'}
          </article>
        `}).join("")}
    </section>
  `}function Ki(e){const t=Pa(e);return`
    <section class="panel">
  ...
  `:g("Create a job to see the profile workspace.")}function Zi(e,t){const a=t||rr(e);return`
    <form class="job-editor" data-job-form>
      ...
      ${M("Company","company_id",e,za().map(i=>[i.id,rt(i)]))}
  ...
  `}function Xi(e,t){const a=e.jobId?D(e.jobId):null,i=Zs(t,a?.id);return`
    ...
    <section class="task-layout task-layout-flat">
      <article class="panel task-main">
        ${n.taskView==="board"?an(t,i):tn(t,i)}
      </article>
    </section>
  ...
  `:`
      ...
      ${g("No task selected.")}
    `}function ea(e,t,a){const i=a||or(e,t?.id||"");return`
    <form class="task-form" data-task-form>
      ...
      ${M("Type","type",i.type,Ca.map(s=>[s,Qe(s)]))}
  ...
  `}function sn(e,t){const a=e.params.get("folder")||n.driveFolder||"home";n.driveFolder=a;const i=e.jobId?D(e.jobId):null,s=wr(t,a,i?.id||"");return`
  ...
  `}function rn(e,t,a,i){const s=_r(e,t,a),o=s.map(l=>({kind:"folder",...l})).concat(i.map(l=>({kind:"file",file:l}))),c=a?a.name:t==="home"?"This folder":ee(t);return`
    <section class="drive-section-title">
      <div><h3>${r(c)}</h3><span>${s.length} folder${s.length===1?"":"s"} / ${i.length} file${i.length===1?"":"s"}</span></div>
    </section>
    ${n.driveView==="list"?on(o):ln(o)}
  `}function on(e){return`
    <div class="explorer-table" role="table" aria-label="File explorer">
      ...
      ${e.map(t=>t.kind==="folder"?dn(t):pn(t.file)).join("")||g("This folder is empty.")}
    </div>
  ...
  `}function pn(e){return`
    <button type="button" class="explorer-row ${e.id===n.selectedFileId?"active":""}" data-action="select-file" data-file-id="${r(e.id)}" role="row">
      <span class="explorer-name">${un(e)}<strong>${r(e.file_name)}</strong></span>
      <span>${T(e.updated_at||e.created_at)}</span>
      <span>${r(fe(e))}</span>
      <span>${Kt(e.size_bytes)}</span>
    </button>
  `}function un(e){return`
    <span class="file-type ${r(Wt(e))}">
      <i class="ti ${r(di(e))}"></i>
      <small>${r(Sr(e))}</small>
    </span>
  `}function mn(e){return`
    <button type="button" class="file-card-live ${e.id===n.selectedFileId?"active":""}" data-action="select-file" data-file-id="${r(e.id)}">
      <span class="file-thumb">${Yt(e)}</span>
      <strong>${r(e.file_name)}</strong>
      <span>${r(fe(e))} / ${Kt(e.size_bytes)}</span>
    </button>
  ...
  `}function bn(e){const t=Wt(e);return e.signed_url&&t==="image"?`<img class="file-preview-media" src="${r(e.signed_url)}" alt="" />`:e.signed_url&&t==="pdf"?`<iframe class="file-preview-frame" src="${r(e.signed_url)}" title="${r(e.file_name)}"></iframe>`:e.signed_url&&t==="text"?`<iframe class="file-preview-frame text" src="${r(e.signed_url)}" title="${r(e.file_name)}"></iframe>`:["doc","sheet"].includes(t)&&e.signed_url?`<iframe class="file-preview-frame" src="https://view.officeapps.live.com/op/embed.aspx?src=${encodeURIComponent(e.signed_url)}" title="${r(e.file_name)}"></iframe>`:`
  ...
  `}function gn(){const e=p(),t=n.route||at(),a=t.params.get("folder")||n.driveFolder||"home",i=t.jobId?D(t.jobId):null;return q("Drive","New folder",`
    <form class="compact-tool-form" data-folder-form>
      ...
      <input type="hidden" name="parent_key" value="${r(ai(a,i))}" />
  ...
  `,"task-modal")}function vn(){const e=p(),t=n.route?.params?.get("folder")||(n.driveFolder==="home"?"shared":n.driveFolder),a=n.route?.jobId||"";return`
    <div class="modal-overlay">
      <div class="modal-panel file-modal-panel" role="dialog" aria-modal="true" aria-labelledby="upload-title">
        ...
        <form class="file-upload-panel" data-file-form>
          ...
          ${M("Folder","folder",t,Vr(e))}
          ${M("Job","job_id",a,[["","Company shared file"]].concat(A(e).map(i=>[i.id,i.name])))}
          ${M("Category","category",ee(t),gi.filter(i=>i!=="All categories").map(i=>[i,i]))}
  ...
  `}function yn(e,t){const a=ne(t),i=["members","access"].includes(e.params.get("tab"))?e.params.get("tab"):"members",s=n.joinRequests.filter(o=>o.company_id===t&&o.status==="pending");return`
    ...
    `)}
    ${Ft("Users sections",[[d("users",{tab:"members"},t),"Members",i==="members"],[d("users",{tab:"access"},t),"Access model",i==="access"]])}
    ${i==="members"?`
    ...
    `}
  `}function _n(e){const t=ne(e),a=t.filter(i=>!i.supervisor_id||!t.some(s=>s.id===i.supervisor_id));return`
    <section class="tool-page team-chart-page">
      ...
      <section class="metric-grid operations-metrics">
        ${w("Members",t.length)}
        ${w("Leads",a.length)}
        ${w("Open tasks",z(e).filter(Mt).length)}
      ...
      <section class="panel">
        ...
        <div class="team-tree">
          ${a.map(i=>Ea(e,i,t)).join("")||g("No workers assigned.")}
        </div>
      </section>
    </section>
  `}function Ea(e,t,a,i=0){const s=a.filter(o=>o.supervisor_id===t.id);return`
    <article class="team-node" style="--depth:${i}">
      <div class="team-node-card">
        ...
        <b>${z(e).filter(o=>o.assignee_id===t.id&&Mt(o)).length} open</b>
      </div>
      ${s.length?`<div class="team-node-children">${s.map(o=>Ea(e,o,a,i+1)).join("")}</div>`:""}
    </article>
  `}function hn(e,t){const a=st(t),i=["company","billing","roles","access","team"].includes(e.params.get("tab"))?e.params.get("tab"):"company";return`
    ${U("Settings","Company settings, roles, approvals, and admin controls.","")}
    ${Ft("Settings sections",[[d("settings",{tab:"company"},t),"Company",i==="company"],[d("settings",{tab:"billing"},t),"Billing",i==="billing"],[d("settings",{tab:"roles"},t),"Roles",i==="roles"],[d("settings",{tab:"access"},t),"Access",i==="access"],[d("settings",{tab:"team"},t),"Workers",i==="team"]])}
    <section class="dashboard-grid compact-settings-grid">
      ...
      <article class="panel span-3">
        ...
        <div class="team-chart">
          ${ne(t).map(s=>`<div><strong>${r(s.full_name)}</strong><span>${r(Nt(t,s.id))}</span></div>`).join("")||g("No workers assigned.")}
        </div>
      </article>
      `:""}
    </section>
  `}function $n(e){const t=Lt(e);return`
    <article class="panel">
      <div class="section-head">
      ...
      ${P([["Plan","$300/month company workspace"],["Status",Ya(e)],["Stripe customer",t?.stripe_customer_id||"Not connected"],["Renewal / trial",t?.current_period_end||t?.trial_ends_at?T(t.current_period_end||t.trial_ends_at):"Pending"]])}
    </article>
    <article class="panel">
      ...
      ${P([["Workspace access",Ut(e)?"Allowed":"Suspended"],["Finance/files privacy","Requires Auth + RLS"],["Seat billing","Tracked later; not charged in v1"]])}
    </article>
  `}function wn(e){return`
    <article class="panel span-2">
      ...
      <div class="roles-list">
        ${zs(e).map(a=>{const i=n.rolePermissions.filter(o=>o.role_id===a.id&&o.effect==="allow").length,s=n.roleAssignments.filter(o=>o.company_id===e&&o.role_id===a.id).length;return`
  ...
  `}function Sn(e){return q("Settings","New role",`
  ...
  `,"finance-modal")}function kn(e){const t=kr(e),a=Me(e),i=n.formsTab==="builder"&&a?"builder":n.formsTab==="responses"?"responses":"library";return`
    ...
    <article class="question-workbench">
      <div class="question-canvas">
        <div class="gform-floating-toolbar" aria-label="Builder tools">
          ${Ue.map(([t,a])=>`<button type="button" data-action="add-question" data-question-type="${r(t)}" title="${r(a)}" aria-label="Add ${r(a)} question"><i class="ti ${r(Dr(t))}"></i></button>`).join("")}
        </div>
  ...
  `}function In(e,t){return`
    ...
    <div class="forms-settings-grid">
      ...
      ${Be("Status","status",t.status,qt.map(a=>[a,a]))}
  ...
  `}function xn(e,t){const a=mt(t.id),i=a[0]||null;return`
    ...
    <aside class="panel response-detail">
      ${i?oi(i):g("No response selected.")}
    </aside>
  `}function An(e,t){const a=Ue.map(([i,s])=>`<option value="${r(i)}" ${e.type===i?"selected":""}>${r(s)}</option>`).join("");return`
  ...
  `}function On(e,t){const a=Ws(t),i=it(t),s=z(t).filter(l=>l.status!=="done").length,o=K(A(t),"estimate_total"),c=Ks(t);return`
  ...
  `}function Pn(e,t){const a=Ys(e,t);if(!a)return q("CRM","Customer account",g("This customer is not visible in the current company view."));const i=a.latestJob,s=a.tasks.filter(o=>o.status!=="done");return q("CRM",a.name,`
  ...
  `,"crm-modal")}function Rn(e,t){const a=Ha(t),i=ue(t),s=Qa(t).slice().sort(Oe("received_at")).slice(0,5),o=Et(t).slice().sort(Oe("spent_at")).slice(0,5),c=Ot(t).slice().sort((l,m)=>l.name.localeCompare(m.name)).slice(0,5);return`
    <section class="tool-page finance-page">
      ...
      <section class="finance-secondary-grid">
        ...
        <article class="panel">
          ...
          <div class="finance-compact-list">
            ${o.map(l=>ye(_t(l.vendor_id),l.category,v(l.amount),l.spent_at,d("finance",{expense:l.id},t))).join("")||g("No expenses recorded.")}
          </div>
        </article>
        <article class="panel">
  ...
  `}function Nn(e,t){return e.params.get("invoice")?Ln(t,e.params.get("invoice")):e.params.get("expense")?Un(t,e.params.get("expense")):e.params.get("vendor")?Qn(t,e.params.get("vendor")):e.params.get("report")==="summary"?Vn(t):""}function Ln(e,t){const a=me(t);if(!a||a.company_id!==e)return q("Finance","Invoice",g("Invoice not found."));const i=Ja(a.id),s=D(a.job_id);return q("Finance",a.invoice_number,`
    <div class="finance-detail-modal">
      ${P([["Client",a.client_name||s?.client_name||"No client"],["Status",Ba(a)],["Job",s?.name||"Company level"],["Issued",T(a.issue_date)],["Due",T(a.due_date)],["Total",v(a.total)],["Collected",v(Rt(a.id))],["Balance",v(ae(a.id))]])}
  ...
  `,"finance-modal")}function Un(e,t){const a=Va(t);if(!a||a.company_id!==e)return q("Finance","Expense",g("Expense not found."));const i=D(a.job_id);return q("Finance",`${_t(a.vendor_id)} expense`,`
    <div class="finance-detail-modal">
      ${P([["Vendor",_t(a.vendor_id)],["Category",a.category],["Status",a.status],["Job",i?.name||"Company level"],["Spent",T(a.spent_at)],["Amount",v(a.amount)]])}
      <div class="finance-modal-actions">
  ...
  `,"finance-modal")}function Qn(e,t){const a=Pt(t);if(!a||a.company_id!==e)return q("Finance","Vendor",g("Vendor not found."));const i=Et(e).filter(s=>s.vendor_id===a.id);return q("Finance",a.name,`
    <div class="finance-detail-modal">
  ...
  `,"finance-modal")}function Vn(e){const t=Ha(e);return q("Finance","Summary report",`
  ...
  `,"finance-modal")}function ta(e,t=null){const a=t||lr(e);return q("Finance",t?"Edit invoice":"New invoice",`
    <form class="finance-form" data-finance-invoice-form>
      ...
      ${M("Status","status",a.status,qa.map(i=>[i,i]))}
  ...
  `,"finance-form-modal")}function Jn(e,t=""){const a=cr(e,t),i=ue(e).map(s=>[s.id,`${s.invoice_number} - ${s.client_name||D(s.job_id)?.client_name||"No client"}`]);return q("Finance","Record payment",`
    <form class="finance-form" data-finance-payment-form>
      ...
      ${M("Method","method",a.method,xa.map(s=>[s,s]))}
  ...
  `,"finance-form-modal")}function aa(e,t=null,a=""){const i=t||dr(e,a),s=Ot(e).map(o=>[o.id,o.name]);return q("Finance",t?"Edit expense":"Add expense",`
    <form class="finance-form" data-finance-expense-form>
      ...
      ${M("Status","status",i.status,Fa.map(o=>[o,o]))}
  ...
  `,"finance-form-modal")}function ia(e,t=null){const a=t||pr(e);return q("Finance",t?"Edit vendor":"Add vendor",`
    <form class="finance-form" data-finance-vendor-form>
      ...
      ${M("Status","status",a.status,Ia.map(i=>[i,i]))}
      ${ie("Notes","notes",a.notes,"span-2")}
      <div class="form-actions span-2">
  ...
  `,"finance-form-modal")}function Bn(e,t){return e.section==="clock"?zn(t):e.section==="approvals"?Wn(t):Hn(t)}function It(e,t){return`
    ${Ft("Operations sections",[[d("time",{},e),"My time",t==="time"],[d("approvals",{},e),"Approvals",t==="approvals"],[d("clock",{},e),"Clock dashboard",t==="clock"]])}
  `}function Hn(e){const t=Ra(e),a=nt(e);return`
  ...
  `}function zn(e){const t=La(e),a=nt(e),i=ft().getTime(),s=i-6*864e5,o=oa(e,i)+(a?Date.now()-Date.parse(a.started_at):0),c=oa(e,s)+(a?Date.now()-Date.parse(a.started_at):0);return`
  ...
  `}function Wn(e){const t=Na(e),a=t.filter(o=>o.type==="Form approval"),i=t.filter(o=>o.type==="Task review"),s=t.filter(o=>o.type==="Access request");return`
    <section class="tool-page operations-page">
  ...
  `}function Yn(){document.title="Sign in | Quest HQ";const e=At(n.route.params.get("return_url")||b(d("jobs",{},F())));tt.innerHTML=`
    <main class="login-shell">
      <section class="login-panel">
        <div class="login-brand">
          <span class="side-mark">Q</span>
  ...
  `}function Kn(e){return n.authMode==="register"?`
      <form data-auth-register-form>
        ...
        ${bt("Owner role, trial subscription, and workspace isolation are created automatically.")}
      </form>
    `:n.authMode==="request"?`
      <form data-auth-request-form>
        ...
        ${bt("Requests stay pending until a company Owner/Admin approves them.")}
      </form>
    `:`
    <form data-auth-sign-in-form>
      ...
      ${bt("Use the company workspace account your Owner/Admin invited.")}
    </form>
  `}function bt(e){return n.loginError?`<div class="form-message error">${r(n.loginError)}</div>`:`<div class="form-message">${r(n.authMessage||e)}</div>`}function Gn(e){return`
    <div class="modal-overlay">
  ...
  `}function Zn(e,t){if(n.modal==="profile")return Gn(t.profile);if(n.modal==="file-upload")return vn();if(n.modal==="folder-new")return gn();if(n.modal==="file-detail")return ts(p());if(n.modal==="forms-tools")return as(p());if(n.modal==="form-actions")return rs(p(),Me(p()));if(n.modal==="form-new")return is(p());if(n.modal==="form-preview")return ss(p(),Me(p()));if(n.modal==="job-new")return gt(p(),null);if(n.modal==="job-edit")return gt(p(),de());if(n.modal==="finance-invoice-new")return ta(p(),null);if(n.modal==="finance-invoice-edit")return ta(p(),me(n.selectedFinanceInvoiceId));if(n.modal==="finance-payment-new")return Jn(p(),n.selectedFinanceInvoiceId);if(n.modal==="finance-expense-new")return aa(p(),null,n.selectedFinanceVendorId);if(n.modal==="finance-expense-edit")return aa(p(),Va(n.selectedFinanceExpenseId));if(n.modal==="finance-vendor-new")return ia(p(),null);if(n.modal==="finance-vendor-edit")return ia(p(),Pt(n.selectedFinanceVendorId));if(n.modal==="role-new")return Sn(p());if(e.name==="company"&&e.section==="crm"&&e.params.get("account"))return Pn(e.companyId,e.params.get("account"));if(e.name==="company"&&e.section==="finance"){const a=Nn(e,e.companyId);if(a)return a}return e.name==="company"&&e.section==="jobs"&&e.params.get("tab")==="editor"?gt(e.companyId,e.jobId?D(e.jobId):de()):e.name==="company"&&e.section==="tasks"?es(e,e.companyId):""}function q(e,t,a,i=""){return`
    <div class="modal-overlay">
  ...
  `}function gt(e,t){return q("Jobs",t?"Edit job":"Create job",Zi(e,t),"wide-modal")}function es(e,t){const a=e.jobId?D(e.jobId):null,i=e.params.get("task_id")||"",s=i?Tt(i):null;return e.params.get("new")==="1"?q("Tasks","New task",ea(t,a,null),"task-modal"):e.params.get("edit")==="1"&&s?q("Tasks","Edit task",ea(t,a,s),"task-modal"):s?Xn("Task detail",s.title,nn(t,s)):""}function ts(e){const t=n.selectedFileId?n.files.find(a=>a.id===n.selectedFileId):null;return t?q("Open file",t.file_name,fn(t),"file-viewer-modal"):""}function as(e){return q("Forms","Tools",`
  ...
  `)}function is(e){const t=n.formStartTab==="templates"?"templates":"blank",a=qe(),i=t==="templates"&&(a.find(m=>m.id===n.formStartTemplateId)||a[0])||null,s=i?.title||"",o=i?.description||"",c=i?.type||"Internal",l=i?.questions||[{type:"short",label:"First question",required:!1,options:[]}];return q("Forms","New form builder",`
  ...
  `,"form-create-modal builder-modal")}function ns(e,t){const a=Ee(e)?`
  ...
  `}function ss(e,t){return t?q("Forms","Preview form",`
  ...
  `):q("Forms","Manage form",g("Choose a form first."))}function os(e){const t=e.target.closest("[data-action]");if(t){ls(e,t);return}const a=e.target.closest("[data-select-job]");if(a){e.preventDefault(),Bs(a.dataset.selectJob);return}const i=e.target.closest("[data-select-task]");if(i){e.preventDefault(),Hs(i.dataset.selectTask);return}const s=e.target.closest("a[href][data-router]");s&&(s.target||s.hasAttribute("download")||(e.preventDefault(),S(s.getAttribute("href"))))}function ls(e,t){const a=t.dataset.action;if(a==="refresh-data"){e.preventDefault(),n.dataLoaded=!1,n.sync={label:"Refreshing...",mode:"loading"},u();return}if(a==="sign-out"){e.preventDefault(),ps();return}if(a==="set-auth-mode"){e.preventDefault(),n.authMode=["signin","register","request"].includes(t.dataset.authMode)?t.dataset.authMode:"signin",n.loginError="",n.authMessage="",u();return}if(a==="open-profile"){e.preventDefault(),n.modal="profile",u();return}if(a==="open-role-form"){e.preventDefault(),n.modal="role-new",u();return}if(a==="start-checkout"){e.preventDefault(),gs();return}if(a==="open-file-upload"){e.preventDefault(),n.modal="file-upload",u();return}if(a==="open-folder-form"){e.preventDefault(),n.modal="folder-new",u();return}if(a==="open-job-form"){e.preventDefault();const i=t.dataset.jobId||"";i&&(n.selectedJobId=i),n.modal=t.dataset.mode==="edit"?"job-edit":"job-new",u();return}if(a==="open-forms-tools"){e.preventDefault(),n.modal="forms-tools",u();return}if(a==="open-form-actions"){e.preventDefault(),He(t.dataset.formId,!1),n.modal="form-actions",u();return}if(a==="open-form-preview"){e.preventDefault(),He(t.dataset.formId,!1),n.modal="form-preview",u();return}if(a==="set-form-start-tab"){e.preventDefault(),n.formStartTab=t.dataset.tab==="templates"?"templates":"blank",n.formStartTab==="blank"&&(n.formStartTemplateId=""),n.formStartTab==="templates"&&!n.formStartTemplateId&&(n.formStartTemplateId=qe()[0]?.id||""),u();return}if(a==="select-form-start-template"){e.preventDefault(),n.formStartTab="templates",n.formStartTemplateId=t.dataset.templateId||qe()[0]?.id||"",u();return}if(a==="close-modal"){e.preventDefault(),cs();return}if(a==="set-task-view"){e.preventDefault(),n.taskView=t.dataset.view==="board"?"board":"table",localStorage.setItem(ka,n.taskView),u();return}if(a==="set-drive-view"){e.preventDefault(),n.driveView=t.dataset.view==="list"?"list":"grid",localStorage.setItem(ja,n.driveView),u();return}if(a==="clock-in"){e.preventDefault(),Gs(p(),t.dataset.taskId||n.route?.params?.get("task_id")||"");return}if(a==="clock-out"){e.preventDefault(),Ua();return}if(a==="select-file"){e.preventDefault(),n.selectedFileId=t.dataset.fileId||"",n.modal="file-detail",u();return}if(a==="download-file"){e.preventDefault(),Is(t.dataset.fileId);return}if(a==="delete-file"){e.preventDefault(),xs(t.dataset.fileId);return}if(a==="set-forms-tab"){e.preventDefault(),n.formsTab=t.dataset.tab==="responses"?"responses":"library",u();return}if(a==="set-form-editor-tab"){e.preventDefault(),n.formEditorTab=t.dataset.tab||"questions",u();return}if(a==="new-form"){e.preventDefault(),n.formStartTemplateId=t.dataset.templateId||"",n.formStartTab=t.dataset.startTab==="templates"||n.formStartTemplateId?"templates":"blank",n.formStartTab==="templates"&&!n.formStartTemplateId&&(n.formStartTemplateId=qe()[0]?.id||""),n.modal="form-new",u();return}if(a==="select-form"){e.preventDefault(),He(t.dataset.formId);return}if(a==="toggle-form-card"){e.preventDefault();const i=t.dataset.formId||"";n.expandedFormIds.has(i)?n.expandedFormIds.delete(i):n.expandedFormIds.add(i),u();return}if(a==="edit-form"){e.preventDefault(),He(t.dataset.formId,!1),n.formsTab="builder",n.formEditorTab="questions",n.modal="",u();return}if(a==="save-form"){e.preventDefault(),Q("Form saved locally"),u();return}if(a==="publish-form"){e.preventDefault(),da(t.dataset.formId,"Published");return}if(a==="archive-form"){e.preventDefault(),da(t.dataset.formId,"Archived");return}if(a==="duplicate-form"){e.preventDefault(),xr(t.dataset.formId);return}if(a==="delete-form"){e.preventDefault(),Ar(t.dataset.formId);return}if(a==="copy-form-link"){e.preventDefault(),Tr(t.dataset.formId);return}if(a==="export-forms"){e.preventDefault(),Mr(p());return}if(a==="new-finance-invoice"){e.preventDefault(),n.selectedFinanceInvoiceId="",n.modal="finance-invoice-new",u();return}if(a==="edit-finance-invoice"){e.preventDefault(),n.selectedFinanceInvoiceId=t.dataset.invoiceId||"",n.modal="finance-invoice-edit",u();return}if(a==="new-finance-payment"){e.preventDefault(),n.selectedFinanceInvoiceId=t.dataset.invoiceId||n.route?.params?.get("invoice")||"",n.modal="finance-payment-new",u();return}if(a==="new-finance-expense"){e.preventDefault(),n.selectedFinanceExpenseId="",n.selectedFinanceVendorId=t.dataset.vendorId||"",n.modal="finance-expense-new",u();return}if(a==="edit-finance-expense"){e.preventDefault(),n.selectedFinanceExpenseId=t.dataset.expenseId||"",n.modal="finance-expense-edit",u();return}if(a==="new-finance-vendor"){e.preventDefault(),n.selectedFinanceVendorId="",n.modal="finance-vendor-new",u();return}if(a==="edit-finance-vendor"){e.preventDefault(),n.selectedFinanceVendorId=t.dataset.vendorId||"",n.modal="finance-vendor-edit",u();return}if(a==="add-question"){e.preventDefault(),Er(t.dataset.questionType||"multiple");return}if(a==="duplicate-question"){e.preventDefault(),Or(t.dataset.questionId);return}if(a==="delete-question"){e.preventDefault(),Pr(t.dataset.questionId);return}if(a==="move-question"){e.preventDefault(),Rr(t.dataset.questionId,Number(t.dataset.direction||0));return}if(a==="add-question-option"){e.preventDefault(),Nr(t.dataset.questionId);return}if(a==="remove-question-option"){e.preventDefault(),Lr(t.dataset.questionId,Number(t.dataset.optionIndex||-1));return}if(a==="delete-job"){e.preventDefault(),$s(t.dataset.jobId);return}a==="delete-task"&&(e.preventDefault(),Ss(t.dataset.taskId))}function cs(){const e=n.route||at();if(n.modal="",n.formStartTemplateId="",n.formStartTab="blank",n.selectedFinanceInvoiceId="",n.selectedFinanceExpenseId="",n.selectedFinanceVendorId="",e.name==="company"&&e.section==="tasks"&&(e.params.get("new")||e.params.get("edit")||e.params.get("task_id"))){S(d("tasks",e.jobId?{job_id:e.jobId}:{},e.companyId),{replace:!0});return}if(e.name==="company"&&e.section==="jobs"&&e.params.get("tab")==="editor"){const t=e.jobId?D(e.jobId):de();S(d("jobs",{tab:t?"profile":"pipeline",...t?{job_id:t.id}:{}},e.companyId),{replace:!0});return}if(e.name==="company"&&e.section==="crm"&&e.params.get("account")){S(d("crm",{},e.companyId),{replace:!0});return}if(e.name==="company"&&e.section==="finance"&&(e.params.get("invoice")||e.params.get("expense")||e.params.get("vendor")||e.params.get("report"))){S(d("finance",{},e.companyId),{replace:!0});return}u()}function ds(e){if(e.target.matches("[data-login-form]")){e.preventDefault();const t=Object.fromEntries(new FormData(e.target).entries());if(!(String(t.username||"").trim()===_e.localUsername&&String(t.password||"")===_e.localPassword)){n.loginError="Invalid temporary credentials.",u();return}n.loginError="",n.session=St(),I(he,n.session),S(At(t.return_url||b(d("jobs",{},F()))),{replace:!0});return}if(e.target.matches("[data-auth-sign-in-form]")){e.preventDefault(),us(e.target);return}if(e.target.matches("[data-auth-register-form]")){e.preventDefault(),ms(e.target);return}if(e.target.matches("[data-auth-request-form]")){e.preventDefault(),bs(e.target);return}if(e.target.matches("[data-company-create-form]")){e.preventDefault(),fs(e.target);return}if(e.target.matches("[data-profile-form]")){e.preventDefault();const t=Object.fromEntries(new FormData(e.target).entries()),a={...E().profile,full_name:String(t.full_name||"").trim()||"Quest Basic Mode",avatar_url:String(t.avatar_url||"").trim()};I(ma,a),n.profileDraft=a,n.session={...E(),profile:a},I(he,n.session),n.modal="",u();return}if(e.target.matches("[data-job-form]")){e.preventDefault(),hs(e.target);return}if(e.target.matches("[data-task-form]")){e.preventDefault(),ws(e.target);return}if(e.target.matches("[data-new-form-form]")){e.preventDefault(),Ir(e.target);return}if(e.target.matches("[data-file-form]")){e.preventDefault(),ks(e.target);return}if(e.target.matches("[data-folder-form]")){e.preventDefault(),js(e.target);return}if(e.target.matches("[data-finance-invoice-form]")){e.preventDefault(),Ds(e.target);return}if(e.target.matches("[data-finance-payment-form]")){e.preventDefault(),Cs(e.target);return}if(e.target.matches("[data-finance-expense-form]")){e.preventDefault(),qs(e.target);return}if(e.target.matches("[data-finance-vendor-form]")){e.preventDefault(),Fs(e.target);return}if(e.target.matches("[data-role-form]")){e.preventDefault(),vs(e.target);return}e.target.matches("[data-form-preview-response]")&&(e.preventDefault(),Ur(e.target))}async function ps(){const e=N();e?.auth&&await e.auth.signOut(),localStorage.removeItem(he),n.session=null,n.dataLoaded=!1,S("/login",{replace:!0})}async function us(e){const t=Object.fromEntries(new FormData(e).entries()),a=N();if(!a?.auth){n.loginError="Supabase auth is unavailable.",u();return}n.loginError="",n.authMessage="Signing in...",u();const i=await a.auth.signInWithPassword({email:String(t.email||"").trim(),password:String(t.password||"")});if(i.error){n.loginError=i.error.message||"Unable to sign in.",n.authMessage="",u();return}await Fe(i.data.session),n.authMessage="",n.dataLoaded=!1,S(At(t.return_url||b(d("jobs",{},F()))),{replace:!0})}async function ms(e){const t=Object.fromEntries(new FormData(e).entries()),a=N();if(!a?.auth){n.loginError="Supabase auth is unavailable.",u();return}const i=String(t.email||"").trim(),s=String(t.password||""),o=String(t.full_name||"").trim(),c=String(t.company_name||"").trim();if(!i||!s||!o||!c){n.loginError="Name, email, password, and company workspace are required.",u();return}n.loginError="",n.authMessage="Creating secure workspace...",u();const l=await a.auth.signUp({email:i,password:s,options:{data:{full_name:o}}});if(l.error){n.loginError=l.error.message||"Unable to create account.",n.authMessage="",u();return}let m=l.data.session;if(!m){const f=await a.auth.signInWithPassword({email:i,password:s});if(f.error){n.loginError="Account created. Please sign in to finish workspace setup.",n.authMode="signin",n.authMessage="",u();return}m=f.data.session}await Fe(m);const y=await a.rpc("create_company_workspace",{company_name:c});if(y.error){n.loginError=y.error.message||"Account created, but workspace setup failed.",n.authMessage="",u();return}n.activeCompanyId=_(y.data||F()),localStorage.setItem(Se,n.activeCompanyId),n.dataLoaded=!1,n.authMessage="",S(d("settings",{tab:"billing"},n.activeCompanyId),{replace:!0})}async function fs(e){const t=Object.fromEntries(new FormData(e).entries()),a=N(),i=String(t.company_name||"").trim();if(!a||!i){n.loginError="Company workspace name is required.",u();return}const s=await a.rpc("create_company_workspace",{company_name:i});if(s.error){n.loginError=s.error.message||"Workspace setup failed.",u();return}n.activeCompanyId=_(s.data||F()),localStorage.setItem(Se,n.activeCompanyId),n.dataLoaded=!1,S(d("settings",{tab:"billing"},n.activeCompanyId),{replace:!0})}async function bs(e){const t=Object.fromEntries(new FormData(e).entries()),a=N();if(!a?.auth){n.loginError="Supabase auth is unavailable.",u();return}const i=String(t.email||"").trim(),s=String(t.password||""),o=_(t.company_id||"");n.loginError="",n.authMessage="Submitting access request...",u();const c=await a.auth.signInWithPassword({email:i,password:s});if(c.error){n.loginError=c.error.message||"Sign in first to request access.",n.authMessage="",u();return}await Fe(c.data.session);const l=await a.rpc("request_company_access",{target_company_id:o,request_message:String(t.message||"").trim()||null});if(l.error){n.loginError=l.error.message||"Unable to request access.",n.authMessage="",u();return}n.authMessage="Access request sent. An Owner/Admin must approve it.",n.loginError="",n.authMode="signin",u()}async function gs(){const e=p();n.sync={label:"Opening billing...",mode:"loading"},u();try{const t=await fetch("/api/create-checkout-session",{method:"POST",headers:{"Content-Type":"application/json",...E().access_token?{Authorization:`Bearer ${E().access_token}`}:{}},body:JSON.stringify({company_id:e,return_url:`${window.location.origin}${b(d("settings",{tab:"billing"},e))}`})}),a=await t.json().catch(()=>({}));if(!t.ok||!a.url)throw new Error(a.error||"Billing is not configured yet.");window.location.href=a.url}catch(t){n.sync={label:t.message||"Billing unavailable",mode:"local"},u()}}async function vs(e){const t=p(),a=new FormData(e),i=ve({id:crypto.randomUUID(),company_id:t,name:a.get("name"),color:a.get("color")||"#f0b23b",priority:a.get("priority")||100,is_system:!1,created_by:E().profile.id}),s=a.getAll("permissions").map(c=>String(c||"")).filter(Boolean),o=N();if(n.session?.auth==="supabase"&&o){const c=await o.from("roles").insert(i).select().single();if(c.error){n.sync={label:c.error.message||"Role save failed",mode:"local"},u();return}const l=ve(c.data),m=s.map(y=>({role_id:l.id,permission_key:y,effect:"allow"}));m.length&&await o.from("role_permissions").insert(m),n.roles.unshift(l),n.rolePermissions=m.concat(n.rolePermissions).map(wt),n.sync={label:"Role saved",mode:"live"}}else n.roles.unshift(i),n.rolePermissions=s.map(c=>wt({role_id:i.id,permission_key:c,effect:"allow"})).concat(n.rolePermissions),n.sync={label:"Role saved locally",mode:"local"};n.modal="",u()}function ys(e){if(e.target.matches("[data-global-search]")){n.query=e.target.value,Ve();return}if(e.target.matches("[data-file-search]")){n.fileQuery=e.target.value,Ve();return}if(e.target.matches("[data-form-search]")){n.formQuery=e.target.value,Ve();return}if(e.target.matches("[data-crm-search]")){n.crmQuery=e.target.value,Ve();return}if(e.target.matches("[data-form-field]")){li(e.target);return}(e.target.matches("[data-question-field]")||e.target.matches("[data-question-option]"))&&ci(e.target)}function _s(e){if(e.target.matches("[data-company-switch]")){const t=e.target.value||F();Vs(t);return}if(e.target.matches("[data-stage-filter]")){n.stageFilter=e.target.value||"all",u();return}if(e.target.matches("[data-crm-stage-filter]")){n.crmStageFilter=e.target.value||"all",u();return}if(e.target.matches("[data-crm-owner-filter]")){n.crmOwnerFilter=e.target.value||"all",u();return}if(e.target.matches("[data-task-status-filter]")){n.taskStatusFilter=e.target.value||"all",u();return}if(e.target.matches("[data-task-priority-filter]")){n.taskPriorityFilter=e.target.value||"all",u();return}if(e.target.matches("[data-task-job-filter]")){const t=e.target.value;S(d("tasks",t?{job_id:t}:{},p()));return}if(e.target.matches("[data-analytics-job-filter]")){const t=e.target.value;S(d("analytics",t?{job_id:t}:{},p()));return}if(e.target.matches("[data-file-category-filter]")){n.fileCategoryFilter=e.target.value||"All categories",u();return}if(e.target.matches("[data-file-folder-filter]")){const t=e.target.value==="home"?"":e.target.value,a=n.route?.jobId||"";S(d("files",{...t?{folder:t}:{},...a?{job_id:a}:{}},p()));return}if(e.target.matches("[data-file-job-filter]")){const t=e.target.value;S(d("files",{...t?{folder:"jobs",job_id:t}:{}},p()));return}if(e.target.matches("[data-form-type-filter]")){n.formTypeFilter=e.target.value||"all",u();return}if(e.target.matches("[data-form-field]")){li(e.target);return}(e.target.matches("[data-question-field]")||e.target.matches("[data-question-option]"))&&ci(e.target)}async function hs(e){const t=Ae(Object.fromEntries(new FormData(e).entries()));t.id=t.id||crypto.randomUUID(),t.company_id=t.company_id||p(),t.estimate_total=Number(t.estimate_total||0),t.invoice_total=Number(t.invoice_total||0),t.updated_at=new Date().toISOString();const a=n.jobs.some(s=>s.id===t.id),i=N();if(i){const s=a?await i.from("jobs").update(t).eq("id",t.id).select().single():await i.from("jobs").insert(t).select().single();if(!s.error&&s.data){vt(Ae(s.data)),n.sync={label:"Quest Supabase live",mode:"live"},n.modal="",S(d("jobs",{tab:"profile",job_id:s.data.id},t.company_id),{replace:!0});return}n.sync={label:"Saved locally",mode:"local"}}vt(t),n.modal="",S(d("jobs",{tab:"profile",job_id:t.id},t.company_id),{replace:!0})}async function $s(e){if(!e)return;const t=p(),a=N();a&&await a.from("jobs").delete().eq("id",e),n.jobs=n.jobs.filter(i=>i.id!==e),n.selectedJobId=A(t)[0]?.id||"",n.modal="",B(),S(d("jobs",{tab:"list"},t),{replace:!0})}async function ws(e){const t=p(),a=Object.fromEntries(new FormData(e).entries()),i=Te({...a,id:String(a.id||"").trim()||`task-${crypto.randomUUID()}`,company_id:t,creator_id:E().profile.member_id||ne(t)[0]?.id||"abraham",urgency:a.priority||"medium",watchers:[],subtasks:[],activity:[],updated_at:new Date().toISOString()}),s=n.tasks.some(c=>c.id===i.id),o=N();if(o){const c=ur(i),l=s?await o.from("tasks").update(c).eq("id",i.id).select().single():await o.from("tasks").insert(c).select().single();if(!l.error&&l.data){sa(Te(l.data)),n.sync={label:"Quest Supabase live",mode:"live"},n.modal="",S(d("tasks",{...i.project_id?{job_id:i.project_id}:{},task_id:i.id},t),{replace:!0});return}n.sync={label:"Task saved locally",mode:"local"}}sa(i),n.modal="",S(d("tasks",{...i.project_id?{job_id:i.project_id}:{},task_id:i.id},t),{replace:!0})}async function Ss(e){if(!e)return;const t=p(),a=N();a&&await a.from("tasks").delete().eq("id",e),n.tasks=n.tasks.filter(i=>i.id!==e),n.selectedTaskId="",n.modal="",B(),S(d("tasks",{},t),{replace:!0})}async function ks(e){const t=p(),a=new FormData(e),i=Object.fromEntries(a.entries()),s=Array.from(e.elements.files?.files||[]),o=String(i.file_name||"").trim(),c=s.length?s:o?[null]:[];if(!c.length){n.sync={label:"Choose a file or enter a file name",mode:"local"},u();return}const l=N();let m=0;for(const y of c){const f=crypto.randomUUID(),j=y?.name||o,L=String(i.folder||"shared"),C=`${t}/${i.job_id?`jobs/${i.job_id}`:L}/${f}-${Gt(j)}`;let H=!1;l&&y&&(H=!(await l.storage.from("quest-job-files").upload(C,y,{cacheControl:"3600",upsert:!1,contentType:y.type||"application/octet-stream"})).error);const je=Ge({id:f,company_id:t,job_id:i.job_id||"",folder:L,file_name:j,mime_type:y?.type||"application/octet-stream",size_bytes:y?.size||Number(i.size_bytes||0),category:i.category||ee(L),notes:i.notes||"",uploaded_by_label:i.uploaded_by_label||E().profile.full_name,bucket_id:"quest-job-files",object_path:H||!y?C:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()});if(l){const le=await l.from("job_files").insert(mr(je)).select().single();if(!le.error&&le.data){ra(Ge(le.data)),m+=1;continue}H&&await l.storage.from("quest-job-files").remove([C])}ra(je)}n.sync=m===c.length?{label:"Quest Supabase live",mode:"live"}:{label:m?"Some files saved locally":"File record saved locally",mode:m?"loading":"local"},n.modal="",S(d("files",{folder:i.folder||"shared",...i.job_id?{job_id:i.job_id}:{}},t),{replace:!0})}function js(e){const t=Object.fromEntries(new FormData(e).entries()),a=String(t.name||"").trim();if(!a){n.sync={label:"Folder name is required",mode:"local"},u();return}const i=Ka({id:`folder-${crypto.randomUUID()}`,company_id:p(),name:a,parent_key:t.parent_key||"home",created_by_label:E().profile.full_name||"Quest HQ",created_at:new Date().toISOString(),updated_at:new Date().toISOString()});n.driveFolders.unshift(i),n.modal="",n.sync={label:"Folder created locally",mode:"local"},B(),u()}function Ds(e){const t=Object.fromEntries(new FormData(e).entries()),a=p(),i=D(t.job_id),s=String(t.id||"").trim()?me(String(t.id).trim()):null,o=Qt({...t,id:String(t.id||"").trim()||`invoice-${crypto.randomUUID()}`,company_id:a,client_name:String(t.client_name||i?.client_name||"").trim(),total:x(t.subtotal)+x(t.tax),updated_at:new Date().toISOString()});As(o),s?.job_id&&s.job_id!==o.job_id&&yt(s.job_id),yt(o.job_id),n.modal="",n.sync={label:"Finance saved locally",mode:"local"},S(d("finance",{invoice:o.id},a),{replace:!0})}function Cs(e){const t=Object.fromEntries(new FormData(e).entries()),a=p(),i=me(t.invoice_id);if(!i||i.company_id!==a){n.sync={label:"Create an invoice before recording a payment",mode:"local"},u();return}const s=Vt({...t,id:`payment-${crypto.randomUUID()}`,company_id:a,created_at:new Date().toISOString()});n.financePayments.unshift(s),i.status=ae(i.id)<=0?"Paid":"Partially paid",i.updated_at=new Date().toISOString(),yt(i.job_id),B(),n.modal="",n.sync={label:"Payment recorded locally",mode:"local"},S(d("finance",s.invoice_id?{invoice:s.invoice_id}:{},a),{replace:!0})}function qs(e){const t=Object.fromEntries(new FormData(e).entries()),a=p(),i=Jt({...t,id:String(t.id||"").trim()||`expense-${crypto.randomUUID()}`,company_id:a,updated_at:new Date().toISOString()});Ts(i),n.modal="",n.sync={label:"Expense saved locally",mode:"local"},S(d("finance",{expense:i.id},a),{replace:!0})}function Fs(e){const t=Object.fromEntries(new FormData(e).entries()),a=p(),i=Bt({...t,id:String(t.id||"").trim()||`vendor-${crypto.randomUUID()}`,company_id:a,updated_at:new Date().toISOString()});Ms(i),n.modal="",n.sync={label:"Vendor saved locally",mode:"local"},S(d("finance",{vendor:i.id},a),{replace:!0})}async function Is(e){const t=n.files.find(s=>s.id===e);if(!t?.object_path){n.sync={label:"No stored object for this file",mode:"local"},u();return}const a=N();if(!a)return;const i=await a.storage.from(t.bucket_id||"quest-job-files").createSignedUrl(t.object_path,3600,{download:t.file_name});if(i.error||!i.data?.signedUrl){n.sync={label:"Download failed",mode:"local"},u();return}window.open(i.data.signedUrl,"_blank","noopener,noreferrer")}async function xs(e){const t=n.files.find(i=>i.id===e);if(!t)return;const a=N();a&&(t.object_path&&await a.storage.from(t.bucket_id||"quest-job-files").remove([t.object_path]),await a.from("job_files").update({deleted_at:new Date().toISOString()}).eq("id",e)),n.files=n.files.filter(i=>i.id!==e),n.selectedFileId="",n.modal="",B(),u()}function vt(e){const t=n.jobs.findIndex(a=>a.id===e.id);t>=0?n.jobs[t]=e:n.jobs.unshift(e),n.selectedJobId=e.id,B()}function sa(e){const t=n.tasks.findIndex(a=>a.id===e.id);t>=0?n.tasks[t]=e:n.tasks.unshift(e),n.selectedTaskId=e.id,B()}function ra(e){const t=n.files.findIndex(a=>a.id===e.id);t>=0?n.files[t]=e:n.files.unshift(e),B()}function As(e){const t=n.financeInvoices.findIndex(a=>a.id===e.id);t>=0?n.financeInvoices[t]=e:n.financeInvoices.unshift(e),B()}function Ts(e){const t=n.financeExpenses.findIndex(a=>a.id===e.id);t>=0?n.financeExpenses[t]=e:n.financeExpenses.unshift(e),B()}function Ms(e){const t=n.financeVendors.findIndex(a=>a.id===e.id);t>=0?n.financeVendors[t]=e:n.financeVendors.unshift(e),B()}function yt(e){if(!e)return;const t=D(e);t&&(t.invoice_total=K(ue(t.company_id).filter(a=>a.job_id===e),"total"),t.updated_at=new Date().toISOString(),vt(t))}function Ve(){const e=document.getElementById("workspace");e&&(Oa(n.route),e.innerHTML=Ma(n.route))}function at(){const e=xt(),t=new URLSearchParams(window.location.search);if(e==="/login")return{name:"login",path:e,params:t,section:"",companyId:"",jobId:""};if(e==="/"||e==="/command")return{name:"command",path:e,params:t,section:"dashboard",companyId:p(),jobId:t.get("job_id")||""};const a=e.match(/^\/company\/([^/]+)(?:\/([^/]+))?\/?$/);if(a){const i=a[2]||"jobs";return{name:"company",path:e,params:t,companyId:decodeURIComponent(a[1]),section:i,jobId:t.get("job_id")||""}}return{name:e.replace(/^\//,"")||"command",path:e,params:t,section:"",companyId:p(),jobId:t.get("job_id")||""}}function Es(){const e=xt(),t=new URLSearchParams(window.location.search),a=t.get("company_id")||t.get("company")||We(t.get("job_id")||t.get("project_id"))||localStorage.getItem(Se)||F(),i=Object.fromEntries(Object.entries(bi).map(([c,l])=>[c,d(l,{},a)]));Object.assign(i,{"/index.html":d("jobs",{},a),"/command.html":d("jobs",{},a),"/login.html":"/login"});let s=i[e];if(e==="/jobs"){const c=t.get("tab");c==="tasks"?s=d("tasks",Y(t,["job_id","task_id","new","edit"]),a):c==="files"?s=d("files",Y(t,["job_id","folder"]),a):c==="forms"?s=d("forms",Y(t,["job_id"]),a):c==="analytics"?s=d("analytics",Y(t,["job_id"]),a):s=d("jobs",Y(t,["job_id","tab"]),a)}if(e==="/files"&&(s=d("files",Y(t,["job_id","folder"]),a)),e==="/forms"&&(s=d("forms",Y(t,["job_id"]),a)),e==="/analytics"&&(s=d("analytics",Y(t,["job_id"]),a)),e==="/crm"&&(s=d("crm",Y(t,["account"]),a)),e==="/finance"&&(s=d("finance",Y(t,["invoice","expense","vendor","report"]),a)),e==="/admin"&&(s=d("settings",{},a)),e==="/time"&&(s=d("time",{},a)),e==="/team"&&(s=d("team-chart",{},a)),e==="/team-chart"&&(s=d("team-chart",{},a)),e==="/approvals"&&(s=d("approvals",{},a)),e==="/clock"&&(s=d("clock",{},a)),e==="/task-management.html"){const c=t.get("project_id")||t.get("job_id")||"";s=d("tasks",c?{job_id:c}:{},We(c)||a)}const o=e.match(/^\/jobs\/([^/]+)\/tasks\/?$/);if(o){const c=decodeURIComponent(o[1]);s=d("tasks",{job_id:c},We(c)||a)}s&&window.history.replaceState({},"",b(s))}function Os(e){if(e.name!=="company")return"";const t=ke();if(n.session?.auth==="supabase"&&!t.length)return null;if(!t.includes(e.companyId))return d(e.section||"jobs",Object.fromEntries(e.params.entries()),t[0]||F());if(!Xe.map(s=>s.id).includes(e.section))return d("jobs",{},e.companyId);const i=e.jobId?We(e.jobId):"";return i&&i!==e.companyId&&t.includes(i)?d(e.section,Object.fromEntries(e.params.entries()),i):""}function xt(){let e=window.location.pathname||"/";return ge&&e.startsWith(ge)&&(e=e.slice(ge.length)||"/"),e.startsWith("/")||(e="/"+e),e.replace(/\/+$/,"")||"/"}function b(e){if(/^https?:\/\//i.test(e))return e;const[t,a=""]=String(e||"/").split("?"),i=t.startsWith("/")?t:"/"+t;return`${ge}${i}${a?`?${a}`:""}`||"/"}function S(e,t={}){const a=/^https?:\/\//i.test(e)||e.startsWith(ge+"/")||ge===""&&e.startsWith("/")?e:b(e);t.replace?window.history.replaceState({},"",a):window.history.pushState({},"",a),u()}function Ps(){return`${xt()}${window.location.search}`}function At(e){try{const t=new URL(e,window.location.origin);return t.origin!==window.location.origin?b(d("jobs",{},F())):`${t.pathname}${t.search}`}catch{return b(d("jobs",{},F()))}}function d(e="jobs",t={},a=p()){const i=new URLSearchParams(t);for(const[s,o]of[...i.entries()])(o==null||o==="")&&i.delete(s);return`/company/${encodeURIComponent(_(a||F()))}/${e}${i.toString()?`?${i.toString()}`:""}`}function Rs(e){return e.name==="company"?O(e.section):e.name==="command"?"Company Dashboard":e.name==="login"?"Sign in":O(e.name||"Workspace")}function Ns(e,t){const[a]=t.split("?"),i=a.match(/^\/company\/([^/]+)\/([^/]+)/);return!i||e.name!=="company"?!1:e.companyId===decodeURIComponent(i[1])&&e.section===i[2]}function Ls(e){return Da.includes(e)?e:"pipeline"}function Us(e){return{pipeline:"Pipeline",list:"List",profile:"Profile"}[e]||e}function Qs(e){const t=e.companyId||n.activeCompanyId||F(),a=ke();n.activeCompanyId=a.includes(t)?t:a[0]||F(),localStorage.setItem(Se,n.activeCompanyId)}function Oa(e){const t=p();e.jobId&&A(t).some(i=>i.id===e.jobId)&&(n.selectedJobId=e.jobId),(!n.selectedJobId||!A(t).some(i=>i.id===n.selectedJobId))&&(n.selectedJobId=A(t)[0]?.id||"");const a=e.params.get("task_id");a&&z(t).some(i=>i.id===a)&&(n.selectedTaskId=a),e.section!=="tasks"&&(n.selectedTaskId=""),n.driveFolder=e.params.get("folder")||"home"}function Vs(e){const t=ke(),a=_(e),i=t.includes(a)?a:t[0]||F();n.activeCompanyId=i,localStorage.setItem(Se,i),Js();const s=n.route||at(),o=s.name==="company"?s.section:"jobs";S(d(o,{},i))}function Js(){n.modal="",n.selectedJobId="",n.selectedTaskId="",n.selectedFileId="",n.selectedFormId="",n.selectedQuestionId="",n.selectedFinanceInvoiceId="",n.selectedFinanceExpenseId="",n.selectedFinanceVendorId="",n.query="",n.fileQuery="",n.formQuery="",n.crmQuery="",n.stageFilter="all",n.crmStageFilter="all",n.crmOwnerFilter="all",n.taskStatusFilter="all",n.taskPriorityFilter="all",n.fileCategoryFilter="All categories",n.formTypeFilter="all",n.formsTab="library",n.driveFolder="home"}function Bs(e){const t=D(e);t&&(n.selectedJobId=e,S(d("jobs",{tab:"profile",job_id:e},t.company_id)))}function Hs(e){const t=Tt(e);t&&(n.selectedTaskId=e,S(d("tasks",{...t.project_id?{job_id:t.project_id}:{},task_id:e},t.company_id)))}function de(){return D(n.selectedJobId)||A(p())[0]||null}function D(e){return n.jobs.find(t=>t.id===e)||null}function Tt(e){return n.tasks.find(t=>t.id===e)||null}function A(e=p()){return n.jobs.filter(t=>t.company_id===e)}function z(e=p()){return n.tasks.filter(t=>t.company_id===e)}function pe(e=p()){return n.files.filter(t=>t.company_id===e)}function Ie(e=p()){return n.driveFolders.filter(t=>t.company_id===e)}function ne(e=p()){return n.teamMembers.filter(t=>Array.isArray(t.company_ids)&&t.company_ids.includes(e))}function zs(e=p()){const t=n.roles.filter(a=>a.company_id===e);return t.length?t.sort((a,i)=>i.priority-a.priority||a.name.localeCompare(i.name)):[ve({id:`owner-${e}`,company_id:e,name:"Owner",color:"#f0b23b",priority:1e3,is_system:!0}),ve({id:`admin-${e}`,company_id:e,name:"Admin",color:"#60a5fa",priority:800,is_system:!0}),ve({id:`staff-${e}`,company_id:e,name:"Staff",color:"#15803d",priority:100,is_system:!0})]}function Pa(e=p()){const t=n.query.trim().toLowerCase();return A(e).filter(a=>n.stageFilter!=="all"&&a.stage!==n.stageFilter?!1:t?[a.name,a.client_name,a.contact_name,a.owner_name,a.site_address,a.job_type,k(a.company_id)].some(i=>String(i||"").toLowerCase().includes(t)):!0)}function it(e=p()){const t=new Map;return A(e).forEach(a=>{const i=String(a.client_name||"").trim()||"Unassigned customer",s=`account-${Gt(i.toLowerCase())}`;t.has(s)||t.set(s,{key:s,name:i,jobs:[]}),t.get(s).jobs.push(a)}),Array.from(t.values()).map(a=>{const i=a.jobs.slice().sort((C,H)=>Date.parse(H.updated_at||H.created_at||0)-Date.parse(C.updated_at||C.created_at||0)),s=i[0]||null,o=i.map(C=>C.id),c=z(e).filter(C=>o.includes(C.project_id)),l=re(e).filter(C=>o.includes(C.linked_job_id)),m=pe(e).filter(C=>o.includes(C.job_id)),y=Z(i.map(C=>C.contact_name)),f=Z(i.map(C=>C.owner_name)),j=Z(i.map(C=>C.site_address)),L=i.map(C=>C.priority||"Medium").sort((C,H)=>we(H)-we(C))[0]||"Medium";return{...a,jobs:i,tasks:c,latestJob:s,contacts:y,owners:f,addresses:j,forms:l,files:m,primaryContact:y[0]||"No contact",owner:f[0]||"Unassigned",stage:s?.stage||"Lead",priority:L,estimateTotal:K(i,"estimate_total"),fileCount:m.length,formCount:l.length,updatedAt:s?.updated_at||s?.created_at||new Date().toISOString(),subtitle:j[0]||`${i.length} linked job${i.length===1?"":"s"}`}}).sort((a,i)=>Date.parse(i.updatedAt||0)-Date.parse(a.updatedAt||0))}function Ws(e=p()){const t=n.crmQuery.trim().toLowerCase();return it(e).filter(a=>n.crmStageFilter!=="all"&&!a.jobs.some(i=>i.stage===n.crmStageFilter)||n.crmOwnerFilter!=="all"&&!a.owners.includes(n.crmOwnerFilter)?!1:t?[a.name,a.primaryContact,a.owner,a.stage,...a.addresses,...a.contacts,...a.jobs.map(i=>i.name)].some(i=>String(i||"").toLowerCase().includes(t)):!0)}function Ys(e,t){return it(e).find(a=>a.key===t)||null}function Ks(e=p()){return Z(A(e).map(t=>t.owner_name)).sort((t,a)=>t.localeCompare(a))}function Ra(e=p()){const t=E().profile.member_id||"",a=z(e).slice().sort(la),i=a.filter(Mt),s=i.filter(j=>j.due===h(0)),o=i.filter(j=>ua(j.due)<0),c=i.filter(j=>{const L=ua(j.due);return L>=0&&L<=7}),l=i.filter(j=>j.assignee_id===t),m=i.filter(j=>["review","pending"].includes(j.status)),y=a.filter(j=>j.status==="done"),f=Z(o.concat(s,l,m,c).map(j=>j.id)).map(j=>a.find(L=>L.id===j)).filter(Boolean).sort(la);return{tasks:a,open:i,dueToday:s,overdue:o,thisWeek:c,assignedToMe:l,review:m,done:y,focus:f}}function Na(e=p()){const t=re(e).filter(s=>(s.require_approval||s.type==="Client approval")&&!["Archived","Closed","Approved"].includes(s.status)).map(s=>({id:`form:${s.id}`,title:s.title,meta:D(s.linked_job_id)?.name||s.description||"Company form",type:"Form approval",owner:J(s.creator_id),status:s.status,updatedAt:s.updated_at||s.created_at,href:d("forms",{form_id:s.id},e)})),a=z(e).filter(s=>["review","pending"].includes(s.status)).map(s=>({id:`task:${s.id}`,title:s.title,meta:D(s.project_id)?.name||s.description||"Company task",type:"Task review",owner:J(s.assignee_id),status:oe(s.status),updatedAt:s.updated_at||s.due,href:d("tasks",{...s.project_id?{job_id:s.project_id}:{},task_id:s.id},e)})),i=n.memberships.filter(s=>s.company_id===e&&s.status!=="active").map(s=>({id:`access:${s.profile_id||s.member_id}`,title:J(s.member_id||s.profile_id),meta:`${O(s.role)} access request`,type:"Access request",owner:"Quest admin",status:O(s.status),updatedAt:new Date().toISOString(),href:d("settings",{tab:"access"},e)}));return t.concat(a,i).sort((s,o)=>Date.parse(o.updatedAt||0)-Date.parse(s.updatedAt||0))}function nt(e=p()){const t=n.activeTimer;return!t||t.company_id!==e?null:t}function La(e=p()){return n.timeEntries.filter(t=>t.company_id===e).sort((t,a)=>Date.parse(a.started_at||0)-Date.parse(t.started_at||0))}function oa(e=p(),t=0){return La(e).filter(a=>Date.parse(a.started_at||0)>=t).reduce((a,i)=>a+x(i.duration_ms),0)}function Gs(e=p(),t=""){n.activeTimer&&Ua(!1);const a=t?Tt(t):null;n.activeTimer={id:`timer-${crypto.randomUUID()}`,company_id:e,user_id:E().profile.member_id||E().profile.id,task_id:a?.company_id===e?a.id:"",task_title:a?.company_id===e?a.title:"",started_at:new Date().toISOString()},ti(),n.sync={label:"Clock started locally",mode:"local"},u()}function Ua(e=!0){const t=n.activeTimer;if(!t)return;const a=new Date().toISOString(),i=Math.max(0,Date.parse(a)-Date.parse(t.started_at||a));n.timeEntries.unshift({id:`time-${crypto.randomUUID()}`,company_id:t.company_id,user_id:t.user_id,task_id:t.task_id||"",task_title:t.task_title||"",started_at:t.started_at,ended_at:a,duration_ms:i,notes:t.task_title?"Task timer":"General shift"}),n.activeTimer=null,ti(),n.sync={label:"Clock stopped locally",mode:"local"},e&&u()}function Mt(e){return e.status!=="done"}function la(e,t){const a=Date.parse(e.due||0)-Date.parse(t.due||0);return a||we(t.priority)-we(e.priority)}function ue(e=p()){return n.financeInvoices.filter(t=>t.company_id===e).sort(Oe("updated_at"))}function Qa(e=p()){return n.financePayments.filter(t=>t.company_id===e)}function Et(e=p()){return n.financeExpenses.filter(t=>t.company_id===e).sort(Oe("updated_at"))}function Ot(e=p()){return n.financeVendors.filter(t=>t.company_id===e)}function me(e){return n.financeInvoices.find(t=>t.id===e)||null}function Va(e){return n.financeExpenses.find(t=>t.id===e)||null}function Pt(e){return n.financeVendors.find(t=>t.id===e)||null}function _t(e){return Pt(e)?.name||"No vendor"}function Ja(e){return n.financePayments.filter(t=>t.invoice_id===e).sort(Oe("received_at"))}function Rt(e){return K(Ja(e),"amount")}function ae(e){const t=me(e);return Math.max(0,x(t?.total)-Rt(e))}function Ba(e){const t=ae(e.id);return t<=0&&x(e.total)>0?"Paid":t<x(e.total)?"Partially paid":e.status==="Sent"&&pi(e.due_date)>0?"Overdue":e.status}function Ha(e=p()){const t=ue(e),a=Qa(e),i=Et(e).filter(l=>["Approved","Paid"].includes(l.status)),s={current:0,thirty:0,sixty:0,overSixty:0};t.forEach(l=>{const m=ae(l.id);if(!m)return;const y=pi(l.due_date);y<=0?s.current+=m:y<=30?s.thirty+=m:y<=60?s.sixty+=m:s.overSixty+=m});const o=K(a,"amount"),c=K(i,"amount");return{pipeline:K(A(e),"estimate_total"),invoiced:K(t,"total"),collected:o,outstanding:t.reduce((l,m)=>l+ae(m.id),0),expenses:c,net:o-c,aging:s}}function Zs(e=p(),t=""){const a=n.query.trim().toLowerCase();return z(e).filter(i=>t&&i.project_id!==t||n.taskStatusFilter!=="all"&&i.status!==n.taskStatusFilter||n.taskPriorityFilter!=="all"&&i.priority!==n.taskPriorityFilter?!1:a?[i.title,i.description,Qe(i.type),J(i.assignee_id),D(i.project_id)?.name].some(s=>String(s||"").toLowerCase().includes(a)):!0)}function za(){const e=ke();return n.companies.filter(t=>e.includes(t.id))}function Wa(e,t=p()){if(!e)return!0;const a=E().profile;if(n.session?.auth==="supabase"){const o=ht(t,a.id);if(!o||o.status!=="active")return!1;if(["owner","developer"].includes(String(o.role).toLowerCase()))return!0;const c=n.roleAssignments.filter(m=>m.company_id===t&&m.profile_id===a.id).map(m=>m.role_id),l=n.rolePermissions.filter(m=>c.includes(m.role_id));if(l.some(m=>(m.permission_key===e||m.permission_key==="*")&&m.effect==="deny"))return!1;if(l.some(m=>(m.permission_key===e||m.permission_key==="*")&&m.effect==="allow"))return!0}const i=String(ht(t,a.id)?.role||a.role||"member").toLowerCase(),s=Zt[i]||Zt.member;return s.includes("*")||s.includes(e)}function ke(){const e=E().profile,t=n.companies.map(s=>s.id);if(n.session?.auth==="supabase"){const s=n.memberships.filter(o=>o.profile_id===e.id&&o.status==="active").map(o=>_(o.company_id));return Z(s).filter(o=>t.includes(o))}if(["developer","admin"].includes(e.role))return Z(t.length?t:$e.map(s=>_(s.id)));const a=n.memberships.filter(s=>s.profile_id===e.id&&s.status!=="disabled").map(s=>_(s.company_id)),i=a.length?a:e.company_ids||[];return Z(i.map(_)).filter(s=>t.includes(s))}function p(){const e=ke();return e.includes(n.activeCompanyId)?n.activeCompanyId:e[0]||n.activeCompanyId||F()}function F(){return _($e[0].id)}function st(e){const t=_(e);return n.companies.find(a=>a.id===t)||$e.map(xe).find(a=>a.id===t)||null}function k(e){const t=st(e);return t?rt(t):e||"Company"}function rt(e){return e.short_name||e.label||e.name||e.id}function se(e){return st(e)?.color||"#f0b23b"}function We(e){return _(n.jobs.find(t=>t.id===e)?.company_id||"")}function ot(e){const t=E().profile;return n.session?.auth!=="supabase"&&["developer","admin"].includes(t.role)?O(t.role):O(ht(e,t.id)?.role||t.role||"member")}function Nt(e,t){const a=n.memberships.find(i=>i.company_id===e&&(i.member_id===t||i.profile_id===t));return O(a?.role||"member")}function ht(e,t){return n.memberships.find(a=>a.company_id===e&&a.profile_id===t)||null}function Lt(e=p()){return n.subscriptions.find(t=>t.company_id===e)||null}function Ut(e=p()){if(n.session?.auth!=="supabase")return!0;const t=Lt(e);return!!(!t||["trialing","active","past_due","grace"].includes(t.status)||t.grace_ends_at&&Date.parse(t.grace_ends_at)>Date.now())}function Ya(e=p()){const t=Lt(e);return t?t.status==="trialing"?`Trial - ${T(t.trial_ends_at)}`:t.status==="active"?"Active subscription":t.status==="past_due"?"Past due grace":t.status==="grace"?`Grace - ${T(t.grace_ends_at)}`:O(t.status):n.session?.auth==="supabase"?"Trial pending":"Demo mode"}function J(e){const t=n.teamMembers.find(a=>a.id===e);return t?.full_name||t?.name||e||"Unassigned"}function lt(e){return n.tasks.filter(t=>t.project_id===e).length}function Ke(e){return n.files.filter(t=>t.job_id===e).length}function _(e){return{"quest-roofing":"roofing","quest-drafting":"drafting"}[String(e||"").trim()]||String(e||"").trim()}function $t(e){const t=new Map;return e.map(xe).forEach(a=>{!a.id||t.has(a.id)||t.set(a.id,a)}),Array.from(t.values())}function xe(e){return{id:_(e.id||""),name:String(e.name||e.short_name||e.id||"").trim(),short_name:String(e.short_name||e.label||e.name||e.id||"").trim(),color:String(e.color||"#f0b23b"),label:String(e.label||e.short_name||e.name||e.id||"").trim()}}function Ae(e){return{id:String(e.id||""),company_id:_(e.company_id||F()),name:String(e.name||"").trim()||"Untitled Job",client_name:String(e.client_name||"").trim(),contact_name:String(e.contact_name||"").trim(),site_address:String(e.site_address||"").trim(),job_type:String(e.job_type||"Roofing").trim(),stage:Re.includes(e.stage)?e.stage:"Lead",priority:["Low","Medium","High","Urgent"].includes(e.priority)?e.priority:"Medium",owner_name:String(e.owner_name||"").trim(),scope:String(e.scope||"").trim(),notes:String(e.notes||"").trim(),estimate_total:x(e.estimate_total),invoice_total:x(e.invoice_total),task_count:x(e.task_count),file_count:x(e.file_count),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||new Date().toISOString()}}function Te(e){const t=Ye.includes(String(e.priority||"").toLowerCase())?String(e.priority).toLowerCase():"medium",a=Ne.includes(String(e.status||"").toLowerCase())?String(e.status).toLowerCase():"todo";return{id:String(e.id||""),title:String(e.title||"").trim()||"Untitled task",description:String(e.description||"").trim(),type:Ca.includes(e.type)?e.type:"admin",label:e.label||null,bid_status:e.bid_status||null,company_id:_(e.company_id||F()),creator_id:String(e.creator_id||"abraham"),assignee_id:String(e.assignee_id||e.creator_id||"abraham"),project_id:String(e.project_id||""),due:String(e.due||h(1)).slice(0,10),due_time:e.due_time||null,reminder_at:e.reminder_at||null,priority:t,urgency:Ye.includes(String(e.urgency||"").toLowerCase())?String(e.urgency).toLowerCase():t,status:a,watchers:Array.isArray(e.watchers)?e.watchers:[],subtasks:Array.isArray(e.subtasks)?e.subtasks:[],activity:Array.isArray(e.activity)?e.activity:[],cleared_at:e.cleared_at||null,created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||new Date().toISOString()}}function Ge(e){const t=String(e.category||e.folder||"Shared");return{id:String(e.id||crypto.randomUUID()),company_id:_(e.company_id||F()),job_id:String(e.job_id||""),folder:String(e.folder||Jr(t)),file_name:String(e.file_name||e.name||"Untitled file"),mime_type:String(e.mime_type||"application/octet-stream"),size_bytes:x(e.size_bytes),category:t,bucket_id:e.bucket_id||"quest-job-files",object_path:e.object_path||"",uploaded_by_label:String(e.uploaded_by_label||"Quest HQ"),notes:String(e.notes||""),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function Ka(e){return{id:String(e.id||`folder-${crypto.randomUUID()}`),company_id:_(e.company_id||F()),name:String(e.name||"New folder").trim()||"New folder",parent_key:String(e.parent_key||"home"),created_by_label:String(e.created_by_label||"Quest HQ"),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function ct(e){const t=Array.isArray(e.questions)?e.questions.map(dt):[],a=Le.includes(e.type)?e.type:"Internal",i=qt.includes(e.status)?e.status:"Draft";return{id:String(e.id||`form-${crypto.randomUUID()}`),company_id:_(e.company_id||F()),title:String(e.title||"Untitled form").trim()||"Untitled form",description:String(e.description||"").trim(),type:a,status:i,audience:String(e.audience||"Internal").trim(),creator_id:String(e.creator_id||e.created_by||e.created_by_id||""),linked_job_id:String(e.linked_job_id||e.job_id||""),theme_color:String(e.theme_color||"#f0b23b"),background:String(e.background||"clean"),submit_label:String(e.submit_label||"Submit").trim()||"Submit",collect_email:e.collect_email!==!1,require_approval:e.require_approval===!0,questions:t,created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function dt(e){const t=Ue.some(([i])=>i===e.type)?e.type:"short",a={id:String(e.id||`q-${crypto.randomUUID()}`),type:t,label:String(e.label||"Untitled question").trim()||"Untitled question",help:String(e.help||"").trim(),required:e.required===!0,options:Array.isArray(e.options)?e.options.map(i=>String(i||"").trim()).filter(Boolean):[]};return Ee(a)&&!a.options.length&&(a.options=["Option 1","Option 2"]),a}function Ga(e){return{id:String(e.id||`response-${crypto.randomUUID()}`),company_id:_(e.company_id||F()),form_id:String(e.form_id||e.formId||""),submitted_by:String(e.submitted_by||e.submitter_email||"Anonymous"),submitter_email:String(e.submitter_email||""),answers:e.answers&&typeof e.answers=="object"?e.answers:{},created_at:e.created_at||new Date().toISOString()}}function Qt(e){const t=x(e.subtotal),a=x(e.tax),i=x(e.total)||t+a;return{id:String(e.id||`invoice-${crypto.randomUUID()}`),company_id:_(e.company_id||F()),job_id:String(e.job_id||""),client_name:String(e.client_name||"").trim(),invoice_number:String(e.invoice_number||`INV-${Date.now()}`).trim(),status:qa.includes(e.status)?e.status:"Draft",issue_date:String(e.issue_date||h(0)).slice(0,10),due_date:String(e.due_date||h(30)).slice(0,10),subtotal:t,tax:a,total:i,notes:String(e.notes||"").trim(),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function Vt(e){return{id:String(e.id||`payment-${crypto.randomUUID()}`),company_id:_(e.company_id||F()),invoice_id:String(e.invoice_id||""),amount:x(e.amount),method:xa.includes(e.method)?e.method:"ACH",received_at:String(e.received_at||h(0)).slice(0,10),reference:String(e.reference||"").trim(),notes:String(e.notes||"").trim(),created_at:e.created_at||new Date().toISOString()}}function Jt(e){return{id:String(e.id||`expense-${crypto.randomUUID()}`),company_id:_(e.company_id||F()),job_id:String(e.job_id||""),vendor_id:String(e.vendor_id||""),category:et.includes(e.category)?e.category:"Other",amount:x(e.amount),status:Fa.includes(e.status)?e.status:"Pending",spent_at:String(e.spent_at||h(0)).slice(0,10),notes:String(e.notes||"").trim(),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function Bt(e){return{id:String(e.id||`vendor-${crypto.randomUUID()}`),company_id:_(e.company_id||F()),name:String(e.name||"New vendor").trim()||"New vendor",contact_name:String(e.contact_name||"").trim(),email:String(e.email||"").trim(),phone:String(e.phone||"").trim(),category:et.includes(e.category)?e.category:"Other",status:Ia.includes(e.status)?e.status:"Active",notes:String(e.notes||"").trim(),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function Za(e){return{id:String(e.id||""),name:String(e.name||e.full_name||"").trim(),full_name:String(e.full_name||e.name||"").trim(),email:String(e.email||"").trim(),color:String(e.color||"#f0b23b"),avatar_url:String(e.avatar_url||""),active:e.active!==!1,supervisor_id:String(e.supervisor_id||e.manager_id||""),company_ids:Array.isArray(e.company_ids)?Z(e.company_ids.map(_)):[]}}function Xs(e){return{company_id:_(e.company_id||""),profile_id:String(e.profile_id||e.member_id||""),member_id:e.member_id?String(e.member_id):"",role:String(e.role||"member"),status:String(e.status||"active")}}function er(e){return{company_id:_(e.company_id||""),status:String(e.status||"trialing"),plan_code:String(e.plan_code||"quest_company_300"),amount_cents:x(e.amount_cents||3e4),currency:String(e.currency||"usd"),stripe_customer_id:String(e.stripe_customer_id||""),stripe_subscription_id:String(e.stripe_subscription_id||""),current_period_end:e.current_period_end||"",trial_ends_at:e.trial_ends_at||"",grace_ends_at:e.grace_ends_at||""}}function ve(e){return{id:String(e.id||""),company_id:_(e.company_id||""),name:String(e.name||"Role").trim()||"Role",color:String(e.color||"#f0b23b"),priority:x(e.priority),is_system:e.is_system===!0,created_by:String(e.created_by||"")}}function wt(e){return{role_id:String(e.role_id||""),permission_key:String(e.permission_key||""),effect:String(e.effect||"allow")==="deny"?"deny":"allow"}}function tr(e){return{company_id:_(e.company_id||""),profile_id:String(e.profile_id||""),role_id:String(e.role_id||""),assigned_by:String(e.assigned_by||"")}}function ar(e){return{id:String(e.id||""),company_id:_(e.company_id||""),resource_type:String(e.resource_type||""),resource_id:String(e.resource_id||""),principal_type:String(e.principal_type||""),principal_id:String(e.principal_id||""),permission_key:String(e.permission_key||""),effect:String(e.effect||"allow")==="deny"?"deny":"allow"}}function ir(e){return{id:String(e.id||""),company_id:_(e.company_id||""),resource_type:String(e.resource_type||""),field_key:String(e.field_key||""),role_id:String(e.role_id||""),visibility:["visible","masked","hidden"].includes(e.visibility)?e.visibility:"visible",editable:e.editable!==!1}}function nr(e){return{id:String(e.id||""),company_id:_(e.company_id||""),email:String(e.email||""),role_id:String(e.role_id||""),status:String(e.status||"pending"),expires_at:e.expires_at||"",invited_by:String(e.invited_by||"")}}function sr(e){return{id:String(e.id||""),company_id:_(e.company_id||""),profile_id:String(e.profile_id||""),requested_email:String(e.requested_email||""),status:String(e.status||"pending"),message:String(e.message||""),reviewed_by:String(e.reviewed_by||""),created_at:e.created_at||""}}function rr(e=p()){return Ae({id:"",company_id:e,name:"",stage:"Lead",priority:"Medium",job_type:"Roofing"})}function or(e=p(),t=""){return Te({id:"",title:"",company_id:e,project_id:t,assignee_id:ne(e)[0]?.id||"abraham",creator_id:E().profile.member_id||"abraham",due:h(1),priority:"medium",status:"todo",type:"admin"})}function lr(e=p()){const t=de();return Qt({id:"",company_id:e,job_id:t?.company_id===e?t.id:"",client_name:t?.company_id===e?t.client_name:"",invoice_number:Br(e),status:"Draft",issue_date:h(0),due_date:h(30),subtotal:t?.company_id===e?t.estimate_total:0,tax:0,notes:""})}function cr(e=p(),t=""){const a=t?me(t):ue(e).find(s=>ae(s.id)>0),i=a?.company_id===e?a:null;return Vt({id:"",company_id:e,invoice_id:i?.id||"",amount:i?ae(i.id):0,method:"ACH",received_at:h(0),reference:"",notes:""})}function dr(e=p(),t=""){return Jt({id:"",company_id:e,job_id:de()?.company_id===e?de().id:"",vendor_id:t||Ot(e)[0]?.id||"",category:"Materials",status:"Pending",amount:0,spent_at:h(0),notes:""})}function pr(e=p()){return Bt({id:"",company_id:e,name:"",category:"Materials",status:"Active"})}function ur(e){return{id:e.id,title:e.title,description:e.description,type:e.type,label:e.label,bid_status:e.bid_status,company_id:e.company_id,creator_id:e.creator_id,assignee_id:e.assignee_id,project_id:e.project_id||null,due:e.due,due_time:e.due_time,reminder_at:e.reminder_at,priority:e.priority,urgency:e.urgency,status:e.status,watchers:e.watchers,subtasks:e.subtasks,activity:e.activity,cleared_at:e.cleared_at}}function mr(e){return{company_id:e.company_id,job_id:e.job_id||null,bucket_id:e.bucket_id,object_path:e.object_path,file_name:e.file_name,mime_type:e.mime_type,size_bytes:e.size_bytes,category:e.category,folder:e.folder,uploaded_by_label:e.uploaded_by_label,notes:e.notes}}function E(){return n.session?n.session.auth==="supabase"?n.session:{...n.session,profile:{...St().profile,...n.session.profile||{},...n.profileDraft||{}}}:St()}function fr(e,t){return{auth:"supabase",access_token:e.access_token,refresh_token:e.refresh_token,user:{id:e.user.id,email:e.user.email||""},profile:Ht(t||{},{id:e.user.id,email:e.user.email||"",full_name:e.user.user_metadata?.full_name||e.user.email||"Quest user",role:"member",member_id:"",company_ids:[],avatar_url:""})}}function St(){const e={id:"basic-quest-user",email:"lumen123@quest-hq.local",full_name:"Quest Basic Mode",role:"developer",role_label:"Developer",member_id:"abraham",company_ids:["roofing","drafting","lumen"],avatar_url:"",...n.profileDraft||{}};return{auth:"local-basic",user:{id:e.id,username:_e.localUsername,email:e.email},profile:e}}function Ht(e,t={}){const a=String(e.role||t.role||"member").toLowerCase();return{id:String(e.id||t.id||""),email:String(e.email||t.email||""),full_name:String(e.full_name||t.full_name||e.email||t.email||"Quest user"),role:a,role_label:O(a),member_id:String(e.member_id||t.member_id||""),company_ids:Array.isArray(e.company_ids)?Z(e.company_ids.map(_)):t.company_ids||[],avatar_url:String(e.avatar_url||t.avatar_url||""),approved:e.approved!==!1,supervisor_id:String(e.supervisor_id||t.supervisor_id||"")}}function U(e,t,a=""){const i=Aa();return`
  ...
  `}function br(e){return`<section class="metric-grid">${e.map(([t,a])=>`<article class="metric">${G(Ta(t),"metric-symbol")}<span>${r(t)}</span><strong>${r(a)}</strong></article>`).join("")}</section>`}function gr(e){return`
  ...
  `}function zt(e){return`<span class="priority ${r(String(e).toLowerCase())}">${r(e)}</span>`}function Xa(e){return`<span class="priority ${r(e)}">${r(O(e))}</span>`}function ei(e){return`<span class="status-pill ${r(e)}">${r(oe(e))}</span>`}function yr(e){return`<span class="finance-status ${r(Gt(e))}">${r(e)}</span>`}function ut(e,t){if(e.avatar_url)return`<span class="${r(t)}"><img src="${r(e.avatar_url)}" alt="" /></span>`;const a=String(e.full_name||e.email||"QB").trim().split(/\s+/).map(i=>i[0]).join("").slice(0,2).toUpperCase()||"QB";return`<span class="${r(t)}">${r(a)}</span>`}function g(e){return`<div class="empty-state">${G("q-empty","empty-symbol")}<span>${r(e)}</span></div>`}function Y(e,t){const a={};return t.forEach(i=>{const s=e.get(i);s&&(a[i]=s)}),a}function B(){I(fa,n.jobs),I(ba,n.tasks),I(ga,n.files),I(va,n.driveFolders),I(Pe,n.forms),I(kt,n.formResponses),I(ha,n.financeInvoices),I($a,n.financePayments),I(wa,n.financeExpenses),I(Sa,n.financeVendors),I(jt,n.timeEntries),I(Dt,n.activeTimer),I(ya,n.teamMembers),I(_a,n.memberships)}function ti(){I(jt,n.timeEntries),I(Dt,n.activeTimer)}function w(e,t,a=""){return`<article class="metric">${G(Ta(e),"metric-symbol")}<span>${r(e)}</span><strong>${r(t)}</strong>${a?`<small>${r(a)}</small>`:""}</article>`}function ce(e,t){return`<div><strong>${r(e)}</strong><span>${r(t)}</span></div>`}function ye(e,t,a,i,s=""){const o=`
    <span><strong>${r(e)}</strong><small>${r(t||"Finance record")}</small></span>
    <b>${r(a)}</b>
    <em>${T(i)}</em>
  `;return s?`<a class="finance-compact-row" href="${b(s)}" data-router>${o}</a>`:`<div class="finance-compact-row">${o}</div>`}function ca(e,t){const a=pe(e);return t==="jobs"?a.filter(i=>i.job_id).length:a.filter(i=>i.folder===t).length}function ai(e="home",t=null){return t?.id?`job:${t.id}`:e||"home"}function _r(e,t="home",a=null){const i=ai(t,a),s=Ie(e).filter(o=>o.parent_key===i).map(o=>hr(e,o));return a?s:t==="home"?Ct.map(([c,l,m,y])=>({id:c,name:l,caption:m,icon:y,href:b(d("files",{folder:c},e)),countLabel:`${ca(e,c)} file${ca(e,c)===1?"":"s"}`,updatedLabel:""})).concat(s):t==="jobs"?A(e).map(c=>({id:`job:${c.id}`,name:c.name,caption:c.client_name||k(e),icon:"ti-folder",href:b(d("files",{folder:"jobs",job_id:c.id},e)),countLabel:`${Ke(c.id)} file${Ke(c.id)===1?"":"s"}`,updatedLabel:T(c.updated_at)})).concat(s):s}function hr(e,t){const a=Ie(e).filter(o=>o.parent_key===t.id).length,i=pe(e).filter(o=>o.folder===t.id).length,s=a+i;return{id:t.id,name:t.name,caption:"Custom folder",icon:"ti-folder",href:b(d("files",{folder:t.id},e)),countLabel:`${s} item${s===1?"":"s"}`,updatedLabel:T(t.updated_at)}}function $r(e,t,a=null){if(a)return`<span>/</span><a href="${b(d("files",{folder:"jobs"},e))}" data-router>Jobs</a>`;const i=Ie(e).find(m=>m.id===t);if(!i)return`<span>/</span><strong>${r(ee(t))}</strong>`;const s=[];let o=i;const c=new Set;for(;o&&!c.has(o.id);)c.add(o.id),s.unshift(o),o=Ie(e).find(m=>m.id===o.parent_key);return`${i.parent_key&&!i.parent_key.startsWith("folder-")&&i.parent_key!=="home"?`<span>/</span><a href="${b(d("files",{folder:i.parent_key},e))}" data-router>${r(ee(i.parent_key))}</a>`:""}${s.map((m,y)=>`<span>/</span>${y===s.length-1?`<strong>${r(m.name)}</strong>`:`<a href="${b(d("files",{folder:m.id},e))}" data-router>${r(m.name)}</a>`}`).join("")}`}function wr(e=p(),t="home",a=""){const i=(n.fileQuery||n.query||"").trim().toLowerCase(),s=n.fileCategoryFilter;let o=pe(e);return a?o=o.filter(c=>c.job_id===a):t&&t!=="home"&&(t==="jobs"?o=o.filter(c=>c.job_id):o=o.filter(c=>c.folder===t)),s&&s!=="All categories"&&(o=o.filter(c=>String(c.category||ee(c.folder)).toLowerCase()===s.toLowerCase())),i&&(o=o.filter(c=>[c.file_name,c.category,c.uploaded_by_label,c.notes,c.object_path,D(c.job_id)?.name].some(l=>String(l||"").toLowerCase().includes(i)))),o.sort((c,l)=>new Date(l.created_at||0)-new Date(c.created_at||0))}function fe(e){const t=String(e.mime_type||"").toLowerCase(),a=ii(e);return t.includes("pdf")||a==="pdf"?"PDF":t.includes("image")||["png","jpg","jpeg","gif","webp","svg"].includes(a)?"Image":t.includes("zip")||["zip","rar","7z"].includes(a)?"Archive":t.includes("spreadsheet")||t.includes("excel")||["xls","xlsx","csv"].includes(a)?"Excel":t.includes("word")||["doc","docx"].includes(a)?"Word":t.includes("text")||["txt","md","json","csv","log"].includes(a)?"Text":t.includes("presentation")||["ppt","pptx"].includes(a)?"PowerPoint":a?a.toUpperCase():ee(e.folder)}function Wt(e){const t=fe(e).toLowerCase();return t==="pdf"?"pdf":t==="image"?"image":t==="excel"?"sheet":t==="text"?"text":["word","powerpoint"].includes(t)?"doc":t==="archive"?"zip":"doc"}function ii(e){return String(e.file_name||"").split(".").pop()?.toLowerCase()||""}function Yt(e,t=!1){const a=di(e);return e.signed_url?`<img src="${r(e.signed_url)}" alt="" />`:`<span class="file-doc-icon ${r(Wt(e))} ${t?"large":""}"><i class="ti ${r(a)}"></i></span>`}function Sr(e){const t=fe(e),a=ii(e);return t==="Image"?a&&a.length<=4?a.toUpperCase():"IMG":t==="Archive"?a&&a.length<=3?a.toUpperCase():"ZIP":t==="Excel"?a==="csv"?"CSV":"XLS":t==="Word"?"DOC":t==="PowerPoint"?"PPT":t==="Text"?a&&a.length<=4?a.toUpperCase():"TXT":t.length<=4?t.toUpperCase():(a||"FILE").slice(0,4).toUpperCase()}function re(e=p()){return n.forms.filter(t=>t.company_id===e)}function kr(e=p()){const t=n.formQuery.trim().toLowerCase(),a=n.route?.jobId||"";return re(e).filter(i=>a&&i.linked_job_id!==a||n.formTypeFilter!=="all"&&i.type!==n.formTypeFilter?!1:t?[i.title,i.description,i.type,i.status,i.audience,D(i.linked_job_id)?.name].some(s=>String(s||"").toLowerCase().includes(t)):!0)}function Me(e=p()){const t=n.route?.jobId||"",a=re(e).filter(o=>!t||o.linked_job_id===t),i=n.route?.params?.get("form_id")||"";if(i&&a.some(o=>o.id===i)&&(n.selectedFormId=i),!a.length)return n.selectedFormId="",n.selectedQuestionId="",null;let s=a.find(o=>o.id===n.selectedFormId)||a[0];return n.selectedFormId=s.id,(!n.selectedQuestionId||!s.questions.some(o=>o.id===n.selectedQuestionId))&&(n.selectedQuestionId=s.questions[0]?.id||""),s}function be(e){return n.forms.find(t=>t.id===e)||null}function te(){return be(n.selectedFormId)||Me(p())}function ni(e=p()){return n.formResponses.filter(t=>t.company_id===e)}function mt(e){return n.formResponses.filter(t=>t.form_id===e)}function si(e){return Array.isArray(e?.questions)?e.questions.length:0}function jr(e){const t=String(e?.creator_id||""),a=E().profile;return t?t&&(t===a.member_id||t===a.id)?a.full_name||"Quest Basic Mode":J(t):e?.created_by_label||a.full_name||"Quest HQ"}function De(e,t,a="",i=!1,s="text"){return`<label><span>${r(e)}</span><input data-form-field="${r(t)}" type="${r(s)}" value="${r(a)}" ${i?"required":""} /></label>`}function ri(e,t,a=""){return`<label><span>${r(e)}</span><textarea data-form-field="${r(t)}" rows="3">${r(a)}</textarea></label>`}function Be(e,t,a,i){return`
    <label><span>${r(e)}</span><select data-form-field="${r(t)}">
      ${i.map(([s,o])=>`<option value="${r(s)}" ${String(s)===String(a)?"selected":""}>${r(o)}</option>`).join("")}
    </select></label>
  `}function Ee(e){return["multiple","checkbox","dropdown"].includes(e.type)}function Dr(e){return{short:"ti-letter-t",paragraph:"ti-align-left",multiple:"ti-circle-dot",checkbox:"ti-checkbox",dropdown:"ti-select",date:"ti-calendar",rating:"ti-star",yesno:"ti-circle-check",file:"ti-paperclip"}[e]||"ti-plus"}function Cr(e){return Ue.find(([t])=>t===e)?.[1]||O(e||"Question")}function X(e,t){return`
  ...
  `}function oi(e){const t=be(e.form_id),a=Object.entries(e.answers||{}).map(([i,s])=>{const o=t?.questions.find(l=>l.id===i),c=Array.isArray(s)?s.join(", "):s;return ce(o?.label||i,c||"No answer")}).join("");return`
  ...
  `}function qe(){return[{id:"roof-inspection",title:"Roof Inspection",description:"Leak source, condition, photo handoff, and recommended repair scope.",type:"Inspection",questions:[R("short","Inspection address"),R("multiple","Primary finding",["Active leak","Damaged flashing","Storm damage","Maintenance"]),R("paragraph","Recommended scope"),R("file","Photos")]},{id:"client-approval",title:"Client Approval",description:"Approval, client notes, signature follow-up, and change request capture.",type:"Client approval",questions:[R("short","Client name"),R("yesno","Approved to proceed?"),R("paragraph","Requested changes")]},{id:"service-intake",title:"Service Intake",description:"New request triage for company-level or job-linked work.",type:"Intake",questions:[R("short","Request title"),R("dropdown","Priority",["Low","Medium","High","Urgent"]),R("paragraph","Details")]},{id:"safety-check",title:"Safety Checklist",description:"Crew safety confirmation before field work starts.",type:"Safety",questions:[R("checkbox","PPE confirmed",["Harness","Ladder","Gloves","Eye protection"]),R("yesno","Weather safe?"),R("paragraph","Safety notes")]}]}function qr(e=p()){return ct({id:`form-${crypto.randomUUID()}`,company_id:e,title:"Untitled form",description:"",type:"Internal",status:"Draft",audience:"Internal",linked_job_id:n.route?.jobId||"",theme_color:se(e),background:"clean",submit_label:"Submit",collect_email:!0,require_approval:!1,questions:[R("short","First question")]})}function R(e="short",t="Untitled question",a=[]){return dt({id:`q-${crypto.randomUUID()}`,type:e,label:t,required:!1,options:a})}function Fr(e,t={}){const a=qr(e),i=ct({...a,...t,id:t.id||`form-${crypto.randomUUID()}`,company_id:e,questions:(t.questions||a.questions).map(s=>dt(s)),created_at:t.created_at||new Date().toISOString(),updated_at:new Date().toISOString()});return n.forms.unshift(i),n.selectedFormId=i.id,n.selectedQuestionId=i.questions[0]?.id||"",n.formsTab="builder",n.formEditorTab="questions",n.modal="",n.formStartTemplateId="",n.formStartTab="blank",Q("New form created"),u(),i}function Ir(e){const t=Object.fromEntries(new FormData(e).entries()),a=t.template_id?qe().find(c=>c.id===t.template_id):null,i=String(t.title||a?.title||"Untitled form").trim()||"Untitled form",s=String(t.description||a?.description||"").trim(),o=a?a.questions.map(c=>({...Ze(c),id:`q-${crypto.randomUUID()}`})):[R("short","First question")];Fr(p(),{title:i,description:s,type:Le.includes(t.type)?t.type:a?.type||"Internal",audience:String(t.audience||"Internal").trim()||"Internal",creator_id:E().profile.member_id||E().profile.id||"basic-quest-user",linked_job_id:String(t.linked_job_id||""),theme_color:se(p()),background:"clean",submit_label:String(t.submit_label||"Submit").trim()||"Submit",collect_email:t.collect_email==="on",require_approval:t.require_approval==="on",questions:o})}function He(e,t=!0){const a=be(e);a&&(n.selectedFormId=a.id,n.selectedQuestionId=a.questions[0]?.id||"",t&&u())}function Q(e="Forms saved locally"){const t=te();t&&(t.updated_at=new Date().toISOString()),I(Pe,n.forms),I(kt,n.formResponses),n.sync={label:e,mode:"live"}}function da(e,t){const a=be(e||n.selectedFormId);a&&(a.status=qt.includes(t)?t:"Draft",n.selectedFormId=a.id,Q(`${a.status} locally`),u())}function xr(e){const t=be(e||n.selectedFormId);if(!t)return;const a=ct({...Ze(t),id:`form-${crypto.randomUUID()}`,title:`${t.title} Copy`,status:"Draft",questions:t.questions.map(i=>({...Ze(i),id:`q-${crypto.randomUUID()}`})),created_at:new Date().toISOString(),updated_at:new Date().toISOString()});n.forms.unshift(a),n.selectedFormId=a.id,n.selectedQuestionId=a.questions[0]?.id||"",Q("Form duplicated"),u()}function Ar(e){const t=e||n.selectedFormId;t&&(n.forms=n.forms.filter(a=>a.id!==t),n.formResponses=n.formResponses.filter(a=>a.form_id!==t),n.selectedFormId=re(p())[0]?.id||"",n.selectedQuestionId=Me(p())?.questions[0]?.id||"",n.modal="",Q("Form deleted locally"),u())}async function Tr(e){const t=e||n.selectedFormId,a=`${window.location.origin}${b(d("forms",{form_id:t},p()))}`;try{await navigator.clipboard.writeText(a),n.sync={label:"Form link copied",mode:"live"}}catch{n.sync={label:"Copy failed",mode:"local"}}u()}function Mr(e){const t=JSON.stringify({company_id:e,forms:re(e),responses:ni(e)},null,2);Qr(`${e}-forms-export.json`,t,"application/json")}function li(e){const t=te();if(!t)return;const a=e.dataset.formField;a&&(t[a]=e.type==="checkbox"?e.checked:e.value,t.updated_at=new Date().toISOString(),I(Pe,n.forms))}function ci(e){const t=te(),a=e.closest("[data-question-id]"),i=t?.questions.find(s=>s.id===a?.dataset.questionId);if(!(!t||!i)){if(n.selectedQuestionId=i.id,e.matches("[data-question-option]")){const s=Number(e.dataset.questionOption);i.options[s]=e.value}else{const s=e.dataset.questionField;if(s==="required")i.required=e.checked;else if(s==="type"){i.type=e.value,Ee(i)&&!i.options.length&&(i.options=["Option 1","Option 2"]),Ee(i)||(i.options=[]),Q("Question updated"),u();return}else s&&(i[s]=e.value)}t.updated_at=new Date().toISOString(),I(Pe,n.forms)}}function Er(e="multiple"){const t=te();if(!t)return;const a=R(e,Ue.find(([i])=>i===e)?.[1]||"New question");t.questions.push(a),n.selectedQuestionId=a.id,Q("Question added"),u()}function Or(e){const t=te(),a=t?.questions.find(o=>o.id===e);if(!t||!a)return;const i=t.questions.findIndex(o=>o.id===e),s=dt({...Ze(a),id:`q-${crypto.randomUUID()}`,label:`${a.label} Copy`});t.questions.splice(i+1,0,s),n.selectedQuestionId=s.id,Q("Question duplicated"),u()}function Pr(e){const t=te();t&&(t.questions=t.questions.filter(a=>a.id!==e),n.selectedQuestionId=t.questions[0]?.id||"",Q("Question deleted"),u())}function Rr(e,t){const a=te();if(!a||!t)return;const i=a.questions.findIndex(c=>c.id===e),s=i+t;if(i<0||s<0||s>=a.questions.length)return;const[o]=a.questions.splice(i,1);a.questions.splice(s,0,o),n.selectedQuestionId=e,Q("Question moved"),u()}function Nr(e){const a=te()?.questions.find(i=>i.id===e);a&&(a.options=a.options||[],a.options.push(`Option ${a.options.length+1}`),Q("Option added"),u())}function Lr(e,t){const i=te()?.questions.find(s=>s.id===e);!i||t<0||(i.options.splice(t,1),i.options.length||i.options.push("Option 1"),Q("Option removed"),u())}function Ur(e){const t=be(e.dataset.formId);if(!t)return;const a=new FormData(e),i={};t.questions.forEach(s=>{const o=`answer:${s.id}`,c=a.getAll(o).filter(l=>l instanceof File?l.name:String(l||"").trim());i[s.id]=c.length>1?c.map(l=>l instanceof File?l.name:l):c[0]instanceof File?c[0].name:c[0]||""}),n.formResponses.unshift(Ga({company_id:t.company_id,form_id:t.id,submitter_email:String(a.get("submitter_email")||""),submitted_by:String(a.get("submitter_email")||E().profile.full_name||"Preview submitter"),answers:i,created_at:new Date().toISOString()})),n.formsTab="responses",n.modal="",Q("Preview response saved"),u()}function Qr(e,t,a="text/plain"){const i=new Blob([t],{type:a}),s=URL.createObjectURL(i),o=document.createElement("a");o.href=s,o.download=e,o.click(),URL.revokeObjectURL(s)}function Ze(e){return JSON.parse(JSON.stringify(e))}function Z(e){return Array.from(new Set(e.map(t=>String(t||"").trim()).filter(Boolean)))}function oe(e){return{todo:"To do",pending:"Pending",hold:"On hold",review:"Review",done:"Done"}[e]||O(e)}function Qe(e){return{lead:"Lead",bid:"Bid",admin:"Admin",invoicing:"Invoicing",ar:"AR",meeting:"Meeting",web_dev:"Web dev"}[e]||O(e)}function ee(e){return Ct.find(([t])=>t===e)?.[1]||n.driveFolders.find(t=>t.id===e)?.name||O(e||"Shared")}function Vr(e=p()){return Ct.map(([t,a])=>[t,a]).concat(Ie(e).map(t=>[t.id,t.name]))}function Jr(e){const t=String(e||"").toLowerCase();return t.includes("photo")?"photos":t.includes("permit")?"permits":t.includes("contract")?"contracts":t.includes("form")?"forms":t.includes("archive")?"archive":"shared"}function di(e){const t=fe(e);return t==="Image"?"ti-photo":t==="PDF"?"ti-file-type-pdf":t==="Archive"?"ti-file-zip":t==="Excel"?"ti-file-spreadsheet":t==="Word"?"ti-file-type-doc":t==="PowerPoint"?"ti-file-type-ppt":t==="Text"?"ti-file-text":"ti-file-description"}function O(e){return String(e||"").replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function h(e=0){return new Date(Date.now()+e*864e5).toISOString().slice(0,10)}function T(e){if(!e)return"No date";const t=new Date(e);return Number.isNaN(t.getTime())?String(e):new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric"}).format(t)}function pa(e){if(!e)return"No time";const t=new Date(e);return Number.isNaN(t.getTime())?String(e):new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(t)}function ze(e){const t=Math.max(0,Math.floor(x(e)/1e3)),a=Math.floor(t/3600),i=Math.floor(t%3600/60);return a?`${a}h ${String(i).padStart(2,"0")}m`:`${i}m`}function Kt(e){const t=x(e);if(!t)return"0 B";const a=["B","KB","MB","GB"],i=Math.min(Math.floor(Math.log(t)/Math.log(1024)),a.length-1);return`${(t/1024**i).toFixed(i?1:0)} ${a[i]}`}function Oe(e){return(t,a)=>Date.parse(a[e]||a.updated_at||a.created_at||0)-Date.parse(t[e]||t.updated_at||t.created_at||0)}function pi(e){if(!e)return 0;const t=new Date(`${String(e).slice(0,10)}T00:00:00`);return Number.isNaN(t.getTime())?0:Math.floor((ft().getTime()-t.getTime())/864e5)}function ua(e){if(!e)return 999;const t=new Date(`${String(e).slice(0,10)}T00:00:00`);return Number.isNaN(t.getTime())?999:Math.floor((t.getTime()-ft().getTime())/864e5)}function Br(e=p()){const t=(rt(st(e)||{short_name:e})||e||"QH").replace(/[^a-z]/gi,"").slice(0,2).toUpperCase()||"QH",a=ue(e).length+1;return`${t}-${String(1e3+a)}`}function ft(){const e=new Date;return e.setHours(0,0,0,0),e}function Hr(e,t){return`${ui(e,t)}%`}function ui(e,t){const a=x(t);return a?Math.max(0,Math.min(100,Math.round(x(e)/a*100))):0}function we(e){return{critical:5,urgent:4,high:3,medium:2,low:1}[String(e||"").toLowerCase()]||0}function Gt(e){return String(e||"file").toLowerCase().replace(/[^a-z0-9.]+/g,"-").replace(/^-+|-+$/g,"")||"file"}function K(e,t){return e.reduce((a,i)=>a+x(i[t]),0)}function x(e){const t=Number(e);return Number.isFinite(t)?t:0}function v(e){return new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:0}).format(x(e))}function Ce(e,t){try{const a=localStorage.getItem(e);return a?JSON.parse(a):t}catch{return t}}function V(e,t){const a=Ce(e,t);return Array.isArray(a)&&a.length?a:t}function I(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}}function r(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}
