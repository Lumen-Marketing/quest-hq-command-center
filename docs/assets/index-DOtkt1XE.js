(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const we={buildId:"Quest HQ Company Workspace v1",localUsername:"lumen123",localPassword:"lumen123",supabaseUrl:"https://lpzotcznihwyyudxycmd.supabase.co",supabaseKey:"sb_publishable_Gd1aHMtItu-7daoq2YofeA_9wl1pQ07"},_e=new URL("/quest-hq-command-center/",window.location.origin).pathname.replace(/\/$/,""),Se="quest-hq-local-session",Pa="quest-hq-local-profile",Lt="quest-hq-job-cache-v2",Nt="quest-hq-task-cache-v1",Ut="quest-hq-file-cache-v1",Qt="quest-hq-drive-folder-cache-v1",Vt="quest-hq-team-cache-v1",Jt="quest-hq-company-membership-cache-v1",Ce="quest-hq-company-form-cache-v1",lt="quest-hq-company-form-response-cache-v1",Bt="quest-hq-finance-invoice-cache-v1",Ht="quest-hq-finance-payment-cache-v1",zt="quest-hq-finance-expense-cache-v1",Wt="quest-hq-finance-vendor-cache-v1",ct="quest-hq-time-entry-cache-v1",dt="quest-hq-active-timer-v1",ne="quest-hq-active-company",La="quest-hq-task-view",Na="quest-hq-drive-view",$a={developer:["*"],admin:["*"],owner:["*"],manager:["jobs.view","jobs.manage","tasks.view","tasks.manage","files.view","files.manage","forms.view","forms.manage","finance.view","team.view","clock.manage","approvals.manage","approvals.view","users.view","settings.view","billing.view","roles.view"],member:["jobs.view","tasks.view","tasks.manage","files.view","forms.view","time.track","approvals.view","users.view"]},Bi=[["jobs.view","View jobs"],["jobs.manage","Create/edit jobs"],["tasks.view","View tasks"],["tasks.manage","Create/edit tasks"],["files.view","View files"],["files.manage","Upload/delete files"],["forms.view","View forms"],["forms.manage","Create/edit forms"],["crm.view","View CRM"],["finance.view","View finance"],["finance.manage","Create/edit finance"],["users.view","View users"],["users.manage","Invite/manage users"],["roles.view","View roles"],["roles.manage","Create/edit roles"],["billing.view","View billing"],["billing.manage","Manage subscription"],["settings.view","View settings"],["settings.manage","Manage settings"],["time.track","Track own time"],["clock.manage","Manage clock dashboard"],["approvals.view","View approvals"],["approvals.manage","Manage approvals"]],ut=[{id:"jobs",group:"Workspace",label:"Jobs",icon:"ti-briefcase",symbol:"q-symbol-jobs",status:"live",permission:"jobs.view"},{id:"tasks",group:"Workspace",label:"Tasks",icon:"ti-list-check",symbol:"q-symbol-tasks",status:"live",permission:"tasks.view"},{id:"files",group:"Workspace",label:"Files",icon:"ti-folder",symbol:"q-symbol-files",status:"live",permission:"files.view"},{id:"forms",group:"Workspace",label:"Forms",icon:"ti-clipboard-list",symbol:"q-symbol-forms",status:"live",permission:"forms.view"},{id:"analytics",group:"Workspace",label:"Analytics",icon:"ti-chart-bar",symbol:"q-symbol-analytics",status:"live",permission:"jobs.view"},{id:"crm",group:"Workspace",label:"CRM",icon:"ti-users-group",symbol:"q-symbol-crm",status:"live",permission:"crm.view"},{id:"tickets",group:"Workspace",label:"Tickets",icon:"ti-ticket",symbol:"q-symbol-tickets",status:"planned"},{id:"finance",group:"Workspace",label:"Finance",icon:"ti-receipt-dollar",symbol:"q-symbol-finance",status:"live",permission:"finance.view"},{id:"knowledge",group:"Workspace",label:"Knowledge Base",icon:"ti-books",symbol:"q-symbol-knowledge",status:"planned"},{id:"automations",group:"Workspace",label:"Automations",icon:"ti-automation",symbol:"q-symbol-automations",status:"planned"},{id:"templates",group:"Workspace",label:"Templates",icon:"ti-template",symbol:"q-symbol-templates",status:"planned"},{id:"users",group:"Company",label:"Users",icon:"ti-users",symbol:"q-symbol-users",status:"live",permission:"users.view"},{id:"settings",group:"Company",label:"Settings",icon:"ti-settings",symbol:"q-symbol-settings",status:"live",permission:"settings.view"},{id:"team-chart",group:"Company",label:"Team chart",icon:"ti-hierarchy-3",symbol:"q-symbol-team-chart",status:"live",permission:"team.view"},{id:"time",group:"Operations",label:"My time",icon:"ti-clock",symbol:"q-symbol-time",status:"live",permission:"time.track"},{id:"approvals",group:"Operations",label:"Approvals",icon:"ti-user-check",symbol:"q-symbol-approvals",status:"live",permission:"approvals.view"},{id:"team-workload",group:"Operations",label:"Team workload",icon:"ti-users",symbol:"q-symbol-team-workload",status:"planned"},{id:"clock",group:"Operations",label:"Clock dashboard",icon:"ti-clock-hour-4",symbol:"q-symbol-clock",status:"live",permission:"clock.manage"}],Hi={"/admin.html":"settings","/automations.html":"automations","/crm.html":"crm","/dashboards.html":"analytics","/files.html":"files","/finance.html":"finance","/forms.html":"forms","/jobs.html":"jobs","/knowledge.html":"knowledge","/templates.html":"templates","/tickets.html":"tickets"},Pe=["Lead","Site Review","Estimate","Approved","Active","Closed"],Ua=["pipeline","list","profile"],Le=["todo","pending","hold","review","done"],Xe=["critical","urgent","high","medium","low"],Qa=["lead","bid","admin","invoicing","ar","meeting","web_dev"],zi=["All categories","Shared","Jobs","Forms","Photos","Permits","Contracts","Archive"],Yt=[["jobs","Jobs","Job-linked folders and deliverables","ti-folders"],["shared","Shared","Company-wide files","ti-folder-share"],["forms","Forms","Completed forms and templates","ti-clipboard-list"],["photos","Photos","Site photos and field media","ti-photo"],["permits","Permits","Permit packets and approvals","ti-file-certificate"],["contracts","Contracts","Signed agreements and estimates","ti-file-dollar"],["archive","Archive","Closed or historical files","ti-archive"]],Ne=["Inspection","Client approval","Intake","Survey","Safety","Internal"],Kt=["Draft","Published","Archived"],Va=["Draft","Sent","Partially paid","Paid","Overdue","Void"],Ja=["Pending","Approved","Paid","Rejected"],Ba=["Active","On hold","Inactive"],Ha=["ACH","Check","Card","Cash","Wire","Other"],pt=["Materials","Labor","Subcontractor","Permit","Equipment","Marketing","Software","Travel","Other"],Ue=[["short","Short answer"],["paragraph","Paragraph"],["multiple","Multiple choice"],["checkbox","Checkboxes"],["dropdown","Dropdown"],["date","Date"],["rating","Rating"],["yesno","Yes / No"],["file","File upload"]],Qe=[{id:"roofing",name:"Quest Roofing",short_name:"Roofing",color:"#f0b23b"},{id:"drafting",name:"Quest Drafting",short_name:"Drafting",color:"#60a5fa"},{id:"lumen",name:"Lumen Marketing",short_name:"Lumen",color:"#a78bfa"}],za=[{id:"11111111-1111-4111-8111-111111111111",company_id:"roofing",name:"Queen Creek Leak Follow-up",client_name:"Rosales Residence",contact_name:"Maya Rosales",site_address:"Queen Creek, AZ",job_type:"Roofing repair",stage:"Active",priority:"Urgent",owner_name:"Andre Lee",scope:"Emergency leak inspection, dry-in, and repair proposal.",notes:"Client reported active leak after monsoon storm.",estimate_total:6800,invoice_total:0,task_count:4,file_count:5,updated_at:new Date().toISOString()},{id:"22222222-2222-4222-8222-222222222222",company_id:"roofing",name:"Mesa Storage Roof Repair",client_name:"Mesa Storage Partners",contact_name:"D. Harris",site_address:"Mesa, AZ",job_type:"Commercial repair",stage:"Estimate",priority:"High",owner_name:"Maya Rosales",scope:"Inspect roof membrane, prepare repair estimate, and attach permit packet.",notes:"Board wants estimate and permit notes before approval.",estimate_total:18400,invoice_total:0,task_count:3,file_count:4,updated_at:new Date(Date.now()-864e5).toISOString()},{id:"33333333-3333-4333-8333-333333333333",company_id:"drafting",name:"Drafting Permit Package",client_name:"Horizon HVAC",contact_name:"Noah Park",site_address:"Chandler, AZ",job_type:"Drafting",stage:"Site Review",priority:"Medium",owner_name:"Noah Park",scope:"Prepare drawing package and client approval form.",notes:"Waiting on latest measurements.",estimate_total:4200,invoice_total:0,task_count:2,file_count:3,updated_at:new Date(Date.now()-1728e5).toISOString()}],Wa=[{id:"abraham",name:"Abraham",full_name:"Abraham Flores",email:"abraham@quest-hq.local",color:"#f0b23b",active:!0,company_ids:["roofing","drafting"],supervisor_id:""},{id:"maya",name:"Maya",full_name:"Maya Rosales",email:"maya@quest-hq.local",color:"#60a5fa",active:!0,company_ids:["roofing"],supervisor_id:"abraham"},{id:"andre",name:"Andre",full_name:"Andre Lee",email:"andre@quest-hq.local",color:"#f97316",active:!0,company_ids:["roofing"],supervisor_id:"maya"},{id:"noah",name:"Noah",full_name:"Noah Park",email:"noah@quest-hq.local",color:"#a78bfa",active:!0,company_ids:["drafting"],supervisor_id:"abraham"},{id:"lumen-ops",name:"Lumen Ops",full_name:"Lumen Operations",email:"ops@lumen.local",color:"#7c3aed",active:!0,company_ids:["lumen"],supervisor_id:""}],Ya=[{company_id:"roofing",profile_id:"basic-quest-user",role:"developer",status:"active"},{company_id:"drafting",profile_id:"basic-quest-user",role:"developer",status:"active"},{company_id:"lumen",profile_id:"basic-quest-user",role:"developer",status:"active"}],Ka=[{id:"task-roofing-leak-1",title:"Call client and confirm active leak area",description:"Confirm access window, roof area, and whether temporary dry-in is still holding.",type:"lead",company_id:"roofing",project_id:"11111111-1111-4111-8111-111111111111",creator_id:"abraham",assignee_id:"maya",due:S(0),priority:"urgent",urgency:"urgent",status:"todo"},{id:"task-roofing-leak-2",title:"Upload inspection photos",description:"Attach site photos to the company drive and tag the Queen Creek job folder.",type:"admin",company_id:"roofing",project_id:"11111111-1111-4111-8111-111111111111",creator_id:"maya",assignee_id:"andre",due:S(1),priority:"high",urgency:"high",status:"pending"},{id:"task-roofing-mesa-1",title:"Prepare repair estimate packet",description:"Draft scope, estimate total, and permit notes for board review.",type:"bid",company_id:"roofing",project_id:"22222222-2222-4222-8222-222222222222",creator_id:"abraham",assignee_id:"maya",due:S(3),priority:"high",urgency:"high",status:"review"},{id:"task-drafting-package-1",title:"Request final measurements",description:"Get latest field measurements before starting permit drawings.",type:"admin",company_id:"drafting",project_id:"33333333-3333-4333-8333-333333333333",creator_id:"abraham",assignee_id:"noah",due:S(2),priority:"medium",urgency:"medium",status:"hold"},{id:"task-lumen-ops-1",title:"Create client onboarding checklist",description:"Internal Lumen setup task to prove company workspace isolation.",type:"meeting",company_id:"lumen",project_id:"",creator_id:"abraham",assignee_id:"lumen-ops",due:S(5),priority:"medium",urgency:"medium",status:"todo"}],Ga=[{id:"file-roofing-1",company_id:"roofing",job_id:"11111111-1111-4111-8111-111111111111",folder:"photos",file_name:"queen-creek-leak-photos.zip",mime_type:"application/zip",size_bytes:184e5,category:"Photos",uploaded_by_label:"Maya Rosales",created_at:new Date(Date.now()-36e5).toISOString()},{id:"file-roofing-2",company_id:"roofing",job_id:"22222222-2222-4222-8222-222222222222",folder:"permits",file_name:"mesa-storage-permit-notes.pdf",mime_type:"application/pdf",size_bytes:86e4,category:"Permits",uploaded_by_label:"Andre Lee",created_at:new Date(Date.now()-864e5).toISOString()},{id:"file-drafting-1",company_id:"drafting",job_id:"33333333-3333-4333-8333-333333333333",folder:"contracts",file_name:"horizon-hvac-drawing-agreement.pdf",mime_type:"application/pdf",size_bytes:42e4,category:"Contracts",uploaded_by_label:"Noah Park",created_at:new Date(Date.now()-1728e5).toISOString()},{id:"file-lumen-1",company_id:"lumen",job_id:"",folder:"shared",file_name:"lumen-shared-brand-assets.zip",mime_type:"application/zip",size_bytes:32e5,category:"Shared",uploaded_by_label:"Lumen Operations",created_at:new Date(Date.now()-2592e5).toISOString()}],Za=[{id:"form-roofing-inspection",company_id:"roofing",title:"Roof Inspection Checklist",description:"Field checklist for leak calls, roof condition notes, photos, and repair recommendations.",type:"Inspection",status:"Published",audience:"Field team",creator_id:"abraham",linked_job_id:"11111111-1111-4111-8111-111111111111",theme_color:"#f0b23b",background:"paper",submit_label:"Submit inspection",collect_email:!0,require_approval:!1,created_at:new Date(Date.now()-6048e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString(),questions:[{id:"q-roof-1",type:"short",label:"Inspection address",help:"Confirm the address before submitting.",required:!0},{id:"q-roof-2",type:"multiple",label:"Primary roof condition",help:"",required:!0,options:["Active leak","Storm damage","Aged underlayment","Maintenance issue"]},{id:"q-roof-3",type:"paragraph",label:"Recommended scope",help:"Write the repair or estimate recommendation.",required:!0},{id:"q-roof-4",type:"file",label:"Attach inspection photos",help:"Upload photos into the company drive after submit.",required:!1}]},{id:"form-roofing-estimate-approval",company_id:"roofing",title:"Estimate Approval",description:"Client-facing approval form for estimate review and signature follow-up.",type:"Client approval",status:"Draft",audience:"Client",creator_id:"maya",linked_job_id:"22222222-2222-4222-8222-222222222222",theme_color:"#f45d22",background:"clean",submit_label:"Approve estimate",collect_email:!0,require_approval:!0,created_at:new Date(Date.now()-432e6).toISOString(),updated_at:new Date(Date.now()-72e5).toISOString(),questions:[{id:"q-est-1",type:"short",label:"Client name",required:!0},{id:"q-est-2",type:"yesno",label:"Do you approve the attached estimate?",required:!0},{id:"q-est-3",type:"paragraph",label:"Questions or requested changes",required:!1}]},{id:"form-drafting-intake",company_id:"drafting",title:"Drafting Permit Intake",description:"Collect measurements, equipment details, and permit packet requirements.",type:"Intake",status:"Published",audience:"Client",creator_id:"noah",linked_job_id:"33333333-3333-4333-8333-333333333333",theme_color:"#60a5fa",background:"grid",submit_label:"Send intake",collect_email:!0,require_approval:!1,created_at:new Date(Date.now()-5184e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString(),questions:[{id:"q-draft-1",type:"short",label:"Project address",required:!0},{id:"q-draft-2",type:"paragraph",label:"Permit notes",required:!1},{id:"q-draft-3",type:"date",label:"Needed by",required:!0}]},{id:"form-lumen-onboarding",company_id:"lumen",title:"Client Onboarding Intake",description:"Initial Lumen setup form for client goals, assets, users, and launch timing.",type:"Intake",status:"Draft",audience:"Client",creator_id:"lumen-ops",linked_job_id:"",theme_color:"#a78bfa",background:"clean",submit_label:"Submit onboarding",collect_email:!0,require_approval:!1,created_at:new Date(Date.now()-3456e5).toISOString(),updated_at:new Date(Date.now()-2592e5).toISOString(),questions:[{id:"q-lumen-1",type:"short",label:"Company name",required:!0},{id:"q-lumen-2",type:"checkbox",label:"Needed services",required:!0,options:["Website","SEO","Paid ads","CRM setup"]},{id:"q-lumen-3",type:"paragraph",label:"Launch goals",required:!1}]}],Xa=[{id:"response-roofing-1",company_id:"roofing",form_id:"form-roofing-inspection",submitted_by:"Maya Rosales",created_at:new Date(Date.now()-36e5).toISOString(),answers:{"q-roof-1":"Queen Creek, AZ","q-roof-2":"Active leak","q-roof-3":"Dry-in held. Prepare repair estimate and photo packet."}}],ei=[{id:"vendor-roofing-materials",company_id:"roofing",name:"Valley Roofing Supply",contact_name:"Elena Ortiz",email:"orders@valleyroofingsupply.local",phone:"(480) 555-0190",category:"Materials",status:"Active",notes:"Primary tile, flashing, and underlayment vendor.",created_at:new Date(Date.now()-12096e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"vendor-roofing-dryin",company_id:"roofing",name:"Monsoon Dry-In Crew",contact_name:"R. Alvarez",email:"dispatch@monsoondryin.local",phone:"(602) 555-0144",category:"Subcontractor",status:"Active",notes:"Emergency dry-in support during storm calls.",created_at:new Date(Date.now()-10368e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()},{id:"vendor-drafting-permits",company_id:"drafting",name:"Permit Runner AZ",contact_name:"Sofia Chen",email:"permits@runneraz.local",phone:"(602) 555-0171",category:"Permit",status:"Active",notes:"Permit filing support for drafting packets.",created_at:new Date(Date.now()-864e6).toISOString(),updated_at:new Date(Date.now()-2592e5).toISOString()},{id:"vendor-lumen-software",company_id:"lumen",name:"Lumen SaaS Stack",contact_name:"Ops Billing",email:"billing@lumenstack.local",phone:"",category:"Software",status:"Active",notes:"Internal software subscriptions for client onboarding.",created_at:new Date(Date.now()-7776e5).toISOString(),updated_at:new Date(Date.now()-3456e5).toISOString()}],ti=[{id:"invoice-roofing-queen-creek",company_id:"roofing",job_id:"11111111-1111-4111-8111-111111111111",client_name:"Rosales Residence",invoice_number:"QR-1007",status:"Partially paid",issue_date:S(-10),due_date:S(5),subtotal:6800,tax:0,total:6800,notes:"Emergency leak repair billing with deposit received.",created_at:new Date(Date.now()-864e6).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"invoice-roofing-mesa-storage",company_id:"roofing",job_id:"22222222-2222-4222-8222-222222222222",client_name:"Mesa Storage Partners",invoice_number:"QR-1008",status:"Sent",issue_date:S(-18),due_date:S(-2),subtotal:18400,tax:0,total:18400,notes:"Estimate packet sent to board for approval.",created_at:new Date(Date.now()-15552e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()},{id:"invoice-drafting-horizon",company_id:"drafting",job_id:"33333333-3333-4333-8333-333333333333",client_name:"Horizon HVAC",invoice_number:"QD-2031",status:"Sent",issue_date:S(-7),due_date:S(14),subtotal:4200,tax:0,total:4200,notes:"Drafting permit package milestone invoice.",created_at:new Date(Date.now()-6048e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()},{id:"invoice-lumen-onboarding",company_id:"lumen",job_id:"",client_name:"Lumen Internal Launch",invoice_number:"LM-3004",status:"Draft",issue_date:S(-3),due_date:S(27),subtotal:3200,tax:0,total:3200,notes:"Demo onboarding package used for finance workspace.",created_at:new Date(Date.now()-2592e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()}],ai=[{id:"payment-roofing-queen-creek-deposit",company_id:"roofing",invoice_id:"invoice-roofing-queen-creek",amount:2500,method:"ACH",received_at:S(-4),reference:"ACH-4421",notes:"Deposit received after dry-in visit.",created_at:new Date(Date.now()-3456e5).toISOString()},{id:"payment-drafting-horizon-retainer",company_id:"drafting",invoice_id:"invoice-drafting-horizon",amount:1e3,method:"Check",received_at:S(-1),reference:"CHK-117",notes:"Retainer collected before permit packet completion.",created_at:new Date(Date.now()-864e5).toISOString()}],ii=[{id:"expense-roofing-queen-creek-materials",company_id:"roofing",job_id:"11111111-1111-4111-8111-111111111111",vendor_id:"vendor-roofing-materials",category:"Materials",amount:1850,status:"Approved",spent_at:S(-6),notes:"Underlayment, flashing, and tile replacement materials.",created_at:new Date(Date.now()-5184e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"expense-roofing-mesa-permit",company_id:"roofing",job_id:"22222222-2222-4222-8222-222222222222",vendor_id:"vendor-roofing-materials",category:"Permit",amount:620,status:"Pending",spent_at:S(-2),notes:"Permit and document prep allowance.",created_at:new Date(Date.now()-1728e5).toISOString(),updated_at:new Date(Date.now()-72e5).toISOString()},{id:"expense-drafting-horizon-runner",company_id:"drafting",job_id:"33333333-3333-4333-8333-333333333333",vendor_id:"vendor-drafting-permits",category:"Permit",amount:480,status:"Approved",spent_at:S(-3),notes:"Permit runner package review.",created_at:new Date(Date.now()-2592e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"expense-lumen-software-stack",company_id:"lumen",job_id:"",vendor_id:"vendor-lumen-software",category:"Software",amount:540,status:"Paid",spent_at:S(-5),notes:"Client onboarding software stack.",created_at:new Date(Date.now()-432e6).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()}],i={route:null,session:ue(Se,null),profileDraft:ue(Pa,null),authReady:!1,authMode:"signin",jobs:E(Lt,za).map(ke),tasks:E(Nt,Ka).map(je),files:E(Ut,Ga).map(Ee),driveFolders:E(Qt,[]).map(ua),forms:E(Ce,Za).map(Je),formResponses:E(lt,Xa).map(pa),financeInvoices:E(Bt,ti).map(wt),financePayments:E(Ht,ai).map(St),financeExpenses:E(zt,ii).map(kt),financeVendors:E(Wt,ei).map(jt),timeEntries:ue(ct,[]),activeTimer:ue(dt,null),teamMembers:E(Vt,Wa).map(ma),memberships:E(Jt,Ya),profiles:[],subscriptions:[],roles:[],rolePermissions:[],roleAssignments:[],resourceAcl:[],fieldPermissions:[],companyInvites:[],joinRequests:[],auditEvents:[],companies:Ci(Qe.map(Ve)),activeCompanyId:localStorage.getItem(ne)||"",selectedJobId:"",selectedTaskId:"",selectedFileId:"",selectedFormId:"",selectedQuestionId:"",selectedFinanceInvoiceId:"",selectedFinanceExpenseId:"",selectedFinanceVendorId:"",expandedFormIds:new Set,formStartTemplateId:"",formStartTab:"blank",query:"",fileQuery:"",formQuery:"",crmQuery:"",stageFilter:"all",crmStageFilter:"all",crmOwnerFilter:"all",taskStatusFilter:"all",taskPriorityFilter:"all",fileCategoryFilter:"All categories",formTypeFilter:"all",formsTab:"library",formEditorTab:"questions",taskView:localStorage.getItem(La)||"table",driveFolder:"home",driveView:localStorage.getItem(Na)||"list",sync:{label:"Loading workspace...",mode:"loading"},dataLoaded:!1,dataLoading:!1,loginError:"",authMessage:"",modal:"",accountMenuOpen:!1},mt=document.getElementById("app");let It=null;Wi();function Wi(){ur(),window.addEventListener("popstate",u),document.addEventListener("click",xs),document.addEventListener("submit",Os),document.addEventListener("input",Ws),document.addEventListener("change",Ys),Yi(),u()}async function Yi(){if(i.session?.auth==="local-basic"){ni(),i.authReady=!0;return}const e=P();if(!e?.auth){i.authReady=!0,i.loginError="Supabase auth is unavailable in this browser session.";return}try{const{data:t}=await e.auth.getSession();await Me(t?.session||null),e.auth.onAuthStateChange((a,n)=>{Me(n||null).finally(()=>{i.dataLoaded=!1,u()})})}catch(t){i.loginError=t.message||"Unable to initialize Supabase auth."}finally{i.authReady=!0,u()}}async function Me(e){if(!e?.user){i.session=null,localStorage.removeItem(Se);return}const t=await Ki(e.user);i.session=Jr(e,t),an(),x(Se,i.session)}async function Ki(e){const t={id:e.id,email:e.email||"",full_name:e.user_metadata?.full_name||e.email||"Quest user",role:"member",role_label:"Member",member_id:"",company_ids:[],avatar_url:"",approved:!1},a=P();if(!a)return t;const n=await a.from("profiles").select("*").eq("id",e.id).maybeSingle();return n.error||!n.data?t:fa(n.data,t)}function u(){if(i.route=ft(),!i.authReady){Xi();return}if(Zi(i.route)){k("/login?return_url="+encodeURIComponent(mr()),{replace:!0});return}if(i.route.name==="login"){hs();return}if(en(),i.session?.auth==="supabase"&&i.dataLoaded&&!qe().length){Gi();return}const e=pr(i.route);if(e){k(e,{replace:!0});return}yr(i.route),mi(i.route),i.route.params.get("account")==="profile"&&(i.modal="profile"),document.title=`${fr(i.route)} | ${j(p())} | Quest HQ`,mt.innerHTML=sn(i.route,oi(i.route))}function Gi(){document.title="Company access pending | Quest HQ",mt.innerHTML=`
  ...
  `}function en(){i.dataLoaded||i.dataLoading||(i.dataLoading=!0,tn().catch(()=>{i.sync={label:"Local fallback",mode:"local"}}).finally(()=>{i.dataLoaded=!0,i.dataLoading=!1,Q(),u()}))}async function tn(){if(i.session?.auth==="local-basic"){i.sync={label:"Demo mode",mode:"local"};return}const e=P();if(!e){i.sync={label:"Supabase unavailable",mode:"local"};return}const[t,a,n,s,o,l,c,m,v,f,y,L,q,H,Ie,ce]=await Promise.all([e.from("companies").select("*").order("name",{ascending:!0}),e.from("jobs").select("*").order("updated_at",{ascending:!1}),e.from("tasks").select("*").order("updated_at",{ascending:!1}),e.from("job_files").select("*").is("deleted_at",null).order("created_at",{ascending:!1}),e.from("team_members").select("*").order("name",{ascending:!0}),e.from("company_memberships").select("*"),e.from("profiles").select("*"),e.from("company_subscriptions").select("*"),e.from("roles").select("*").order("priority",{ascending:!1}),e.from("role_permissions").select("*"),e.from("user_role_assignments").select("*"),e.from("resource_acl").select("*"),e.from("field_permissions").select("*"),e.from("company_invites").select("*").order("created_at",{ascending:!1}),e.from("company_join_requests").select("*").order("created_at",{ascending:!1}),e.from("audit_events").select("*").order("created_at",{ascending:!1}).limit(100)]);let W=0;t.error||(i.companies=(t.data||[]).map(Ve),W+=1),a.error||(i.jobs=(a.data||[]).map(ke),W+=1),n.error||(i.tasks=(n.data||[]).map(je),W+=1),s.error||(i.files=(s.data||[]).map(Ee),W+=1),o.error||(i.teamMembers=(o.data||[]).map(ma),W+=1),l.error||(i.memberships=(l.data||[]).map(st),W+=1),c.error||(i.profiles=(c.data||[]).map(Ji=>fa(Ji)),W+=1),m.error||(i.subscriptions=(m.data||[]).map(xr),W+=1),v.error||(i.roles=(v.data||[]).map(he),W+=1),f.error||(i.rolePermissions=(f.data||[]).map(Ot)),y.error||(i.roleAssignments=(y.data||[]).map(qi)),L.error||(i.resourceAcl=(L.data||[]).map(Er)),q.error||(i.fieldPermissions=(q.data||[]).map(Tr)),H.error||(i.companyInvites=(H.data||[]).map(rt)),Ie.error||(i.joinRequests=(Ie.data||[]).map(Ii)),ce.error||(i.auditEvents=ce.data||[]),i.sync=W?{label:"Quest Supabase live",mode:"live"}:{label:"Local fallback",mode:"local"}}function P(){return!window.supabase||typeof window.supabase.createClient!="function"?null:(It||(It=window.supabase.createClient(we.supabaseUrl,we.supabaseKey)),It)}function an(){i.jobs=[],i.tasks=[],i.files=[],i.driveFolders=[],i.forms=[],i.formResponses=[],i.financeInvoices=[],i.financePayments=[],i.financeExpenses=[],i.financeVendors=[],i.timeEntries=[],i.activeTimer=null,i.teamMembers=[],i.memberships=[],i.profiles=[],i.subscriptions=[],i.roles=[],i.rolePermissions=[],i.roleAssignments=[],i.resourceAcl=[],i.fieldPermissions=[],i.companyInvites=[],i.joinRequests=[],i.auditEvents=[],i.companies=[],i.sync={label:"Loading secure workspace...",mode:"loading"}}function ni(){i.jobs=E(Lt,za).map(ke),i.tasks=E(Nt,Ka).map(je),i.files=E(Ut,Ga).map(Ee),i.driveFolders=E(Qt,[]).map(ua),i.forms=E(Ce,Za).map(Je),i.formResponses=E(lt,Xa).map(pa),i.financeInvoices=E(Bt,ti).map(wt),i.financePayments=E(Ht,ai).map(St),i.financeExpenses=E(zt,ii).map(kt),i.financeVendors=E(Wt,ei).map(jt),i.timeEntries=ue(ct,[]),i.activeTimer=ue(dt,null),i.teamMembers=E(Vt,Wa).map(ma),i.memberships=E(Jt,Ya),i.profiles=[],i.subscriptions=[],i.roles=[],i.rolePermissions=[],i.roleAssignments=[],i.resourceAcl=[],i.fieldPermissions=[],i.companyInvites=[],i.joinRequests=[],i.auditEvents=[],i.companies=Ci(Qe.map(Ve)),i.sync={label:"Demo mode",mode:"local"}}function nn(){return`
        ...
        <div class="topbar-right">
          <label class="company-switch">
            ...
            <select data-company-switch aria-label="Active company">
              ${ji().map(s=>`<option value="${r(s.id)}" ${s.id===n?"selected":""}>${r(yt(s))}</option>`).join("")}
            </select>
          </label>
  ...
  `}function ln(e,t,a,n,s=""){return`
    <a class="side-item ${br(e,t)?"active":""}" href="${b(t)}" data-router>
      ${G(a)}
      <span>${r(n)}</span>
      ${s!==""?`<b>${r(String(s))}</b>`:""}
    </a>
  ...
  `}function fn(e){const t=O(e),a=z(e),n=a.filter(o=>["critical","urgent"].includes(o.priority)),s=me(e);return`
    ...
    `)}
    ${Br([["Jobs",t.length],["Open tasks",a.filter(o=>o.status!=="done").length],["Urgent tasks",n.length],["Drive files",s.length]])}
    <section class="dashboard-grid">
      ...
      <article class="panel span-3">
        ...
        <div class="queue-list">
          ${t.slice(0,8).map(o=>Hr(o)).join("")||g("No jobs in this company yet.")}
        </div>
      </article>
    </section>
  `}function bn(e,t){const a=e.jobId?D(e.jobId):null,n=a?[a]:O(t),s=z(t).filter(f=>!a||f.project_id===a.id),o=me(t).filter(f=>!a||f.job_id===a.id),l=oe(t).filter(f=>!a||f.linked_job_id===a.id),c=s.filter(f=>f.status!=="done"),m=s.filter(f=>f.status!=="done"&&f.due&&new Date(f.due)<qt()),v=K(n,"estimate_total");return`
    <section class="analytics-workspace">
      ...
      <section class="analytics-grid">
        ...
        <article class="panel analytics-score">
          ...
          <strong>${r(So(s.filter(f=>f.status==="done").length,s.length))}</strong>
        ...
        <article class="panel analytics-side">
          ...
          <div class="stage-bars">
            ${Le.map(f=>{const y=s.filter(L=>L.status===f).length;return`<div><span>${r(le(f))}</span><b><i style="width:${r(Vi(y,s.length))}%"></i></b><strong>${r(y)}</strong></div>`}).join("")}
          </div>
        </article>
        <article class="panel span-3">
          <div class="section-head"><div><h2>Priority queue</h2><p>Highest risk tasks first.</p></div></div>
          <div class="queue-list">
            ${s.filter(f=>f.status!=="done").sort((f,y)=>De(y.priority)-De(f.priority)).slice(0,8).map(f=>Dt(f)).join("")||g("No open tasks in this scope.")}
          </div>
        </article>
      </section>
    </section>
  `}function gn(e,t){const a=gr(e.params.get("tab")),n=pe();return`
    ...
    <nav class="tabbar" aria-label="Job sections">
      ${Ua.map(s=>`<a class="${s===a?"active":""}" href="${b(d("jobs",{tab:s,...n?{job_id:n.id}:{}},t))}" data-router>${r(vr(s))}</a>`).join("")}
    </nav>
    ${vn(a,t,n)}
    ...
    <section class="job-board">
      ${Pe.map(a=>{const n=t.filter(s=>s.stage===a);return`
          <article class="job-lane">
            ...
            ${n.map(s=>zr(s)).join("")||'<div class="lane-empty">No jobs</div>'}
          </article>
        `}).join("")}
    </section>
  ...
  `:g("Create a job to see the profile workspace.")}function hn(e,t){const a=t||Or(e);return`
  ...
  `}function $n(e,t){const a=e.jobId?D(e.jobId):null,n=Mr(t,a?.id);return`
    ...
    <section class="workspace-toolbar">
      ...
      <label>
        ...
        <select data-task-priority-filter>
          ${["all"].concat(Xe).map(n=>`<option value="${r(n)}" ${i.taskPriorityFilter===n?"selected":""}>${r(n==="all"?"All priorities":A(n))}</option>`).join("")}
        </select>
      </label>
  ...
  `:`
      ...
      ${g("No task selected.")}
    `}function Sa(e,t,a){const n=a||Rr(e,t?.id||"");return`
    <form class="task-form" data-task-form>
      ...
      ${R("Job","project_id",n.project_id||"",[["","Company-level task"]].concat(O(e).map(s=>[s.id,s.name])))}
      ${R("Status","status",n.status,Le.map(s=>[s,le(s)]))}
      ${R("Priority","priority",n.priority,Xe.map(s=>[s,A(s)]))}
      ${R("Type","type",n.type,Qa.map(s=>[s,He(s)]))}
      ${R("Assignee","assignee_id",n.assignee_id,se(e).map(s=>[s.id,B(s.id)]))}
  ...
  `}function Dn(e,t){const a=e.params.get("folder")||i.driveFolder||"home";i.driveFolder=a;const n=e.jobId?D(e.jobId):null,s=Zr(t,a,n?.id||"");return`
  ...
  `}function Cn(e,t,a,n){const s=Yr(e,t,a),o=s.map(c=>({kind:"folder",...c})).concat(n.map(c=>({kind:"file",file:c}))),l=a?a.name:t==="home"?"This folder":ee(t);return`
  ...
  `}function In(e){return`
    <section class="drive-folder-grid explorer-grid">
      ${e.map(t=>t.kind==="folder"?Fn(t):En(t.file)).join("")||g("This folder is empty.")}
    </section>
  ...
  `}function Mn(e){return`
    <button type="button" class="explorer-row ${e.id===i.selectedFileId?"active":""}" data-action="select-file" data-file-id="${r(e.id)}" role="row">
      <span class="explorer-name">${xn(e)}<strong>${r(e.file_name)}</strong></span>
      <span>${M(e.updated_at||e.created_at)}</span>
      <span>${r(ve(e))}</span>
      <span>${ya(e.size_bytes)}</span>
    </button>
  `}function xn(e){return`
    <span class="file-type ${r(ga(e))}">
      <i class="ti ${r(Ui(e))}"></i>
      <small>${r(Xr(e))}</small>
    </span>
  `}function En(e){return`
    <button type="button" class="file-card-live ${e.id===i.selectedFileId?"active":""}" data-action="select-file" data-file-id="${r(e.id)}">
      ...
      <span>${r(ve(e))} / ${ya(e.size_bytes)}</span>
    </button>
    ...
    <section class="file-viewer-layout">
      ...
      <aside class="file-viewer-meta">
        ...
        <div class="file-detail-list">
          ...
          ${de("Job",D(e.job_id)?.name||"Company shared")}
  ...
  `}function On(e){const t=ga(e);return e.signed_url&&t==="image"?`<img class="file-preview-media" src="${r(e.signed_url)}" alt="" />`:e.signed_url&&t==="pdf"?`<iframe class="file-preview-frame" src="${r(e.signed_url)}" title="${r(e.file_name)}"></iframe>`:e.signed_url&&t==="text"?`<iframe class="file-preview-frame text" src="${r(e.signed_url)}" title="${r(e.file_name)}"></iframe>`:["doc","sheet"].includes(t)&&e.signed_url?`<iframe class="file-preview-frame" src="https://view.officeapps.live.com/op/embed.aspx?src=${encodeURIComponent(e.signed_url)}" title="${r(e.file_name)}"></iframe>`:`
  ...
  `}function Rn(){const e=p(),t=i.route||ft(),a=t.params.get("folder")||i.driveFolder||"home",n=t.jobId?D(t.jobId):null;return I("Drive","New folder",`
    <form class="compact-tool-form" data-folder-form>
      ...
      <input type="hidden" name="parent_key" value="${r(xi(a,n))}" />
    ...
    <div class="modal-overlay">
      <div class="modal-panel file-modal-panel" role="dialog" aria-modal="true" aria-labelledby="upload-title">
        ...
        <form class="file-upload-panel" data-file-form>
          ...
          ${w("Uploaded by","uploaded_by_label",C().profile.full_name||"Quest HQ")}
  ...
  `}function Ln(e,t){const a=Sr(t),n=["members","access"].includes(e.params.get("tab"))?e.params.get("tab"):"members",s=i.joinRequests.filter(l=>l.company_id===t&&l.status==="pending"),o=la("users.manage",t);return`
        ...
        ${a.map(l=>`
          <article class="user-card ${l.status!=="active"?"muted":""}">
            ...
            <div>
              ...
              <span>${r(li(l))}</span>
              <small>${r(l.role_label)} / ${r(A(l.status))}</small>
            </div>
          </article>
    ...
    <section class="dashboard-grid compact-settings-grid">
      ...
      <article class="panel">
        ...
        <div class="access-invite-list">
          ${kr(t).map(l=>Qn(l,o)).join("")||g("No pending invites.")}
        </div>
      </article>
      <article class="panel">
        ...
        <div class="access-request-list">
          ${s.map(l=>Un(l,o)).join("")||g("No pending join requests.")}
        </div>
      </article>
      <article class="panel span-3">
    ...
    `}
  `}function Nn(e,t,a){const n=fe(e),s=t.role_id||Et(e,t.role)||n[0]?.id||"";return`
    <article class="access-user-row">
      ...
      <form class="access-role-form" data-user-role-form>
        ...
        <select name="membership_status" ${a&&t.profile_id?"":"disabled"}>
          ${["active","pending","disabled"].map(o=>`<option value="${r(o)}" ${o===t.status?"selected":""}>${r(A(o))}</option>`).join("")}
        </select>
  ...
  `}function Qn(e,t){const a=aa(e.company_id,e.role_id),n=e.expires_at&&Date.parse(e.expires_at)<Date.now();return`
    <article class="access-invite-row ${n?"muted":""}">
      <div>
        ...
        <span>${r(a?.name||"Member")} / ${n?"Expired":`Expires ${M(e.expires_at)}`}</span>
      </div>
      <div>
  ...
  `}function et(e){const t=String(e.name||"").trim(),a=String(e.email||"").trim();if(t&&!Pt(t))return t;if(a&&!Pt(a))return a.split("@")[0].replace(/[._-]+/g," ").replace(/\b\w/g,s=>s.toUpperCase());const n=String(e.role||"").toLowerCase();return n==="owner"?"Workspace owner":n==="admin"?"Workspace admin":n==="developer"?"Developer":`${e.role_label||"Workspace"} user`}function li(e){const t=String(e.email||"").trim();if(t&&!Pt(t))return t;const a=String(e.profile_id||e.member_id||"").trim();return a?`ID ${ko(a)}`:"No email on profile"}function Vn(e){const t=se(e),a=t.filter(n=>!n.supervisor_id||!t.some(s=>s.id===n.supervisor_id));return`
  ...
  `}function ci(e,t,a,n=0){const s=a.filter(o=>o.supervisor_id===t.id);return`
    <article class="team-node" style="--depth:${n}">
      ...
      ${s.length?`<div class="team-node-children">${s.map(o=>ci(e,o,a,n+1)).join("")}</div>`:""}
    </article>
    ...
    <section class="dashboard-grid compact-settings-grid">
      ...
      <article class="panel">
        ...
        <div class="finance-compact-list">
          ${i.joinRequests.filter(s=>s.company_id===t).map(s=>$e(s.requested_email||s.profile_id,s.message||"Access request",A(s.status),s.created_at)).join("")||g("No pending company approvals.")}
        </div>
      </article>
      `:""}
      ${n==="team"?`
      <article class="panel span-3">
        ...
        <div class="team-chart">
          ${se(t).map(s=>`<div><strong>${r(s.full_name)}</strong><span>${r(at(t,s.id))}</span></div>`).join("")||g("No workers assigned.")}
        </div>
      </article>
      `:""}
    </section>
  ...
  `}function Hn(e){return`
    <article class="panel span-2">
      ...
      <div class="roles-list">
        ${fe(e).map(a=>{const n=i.rolePermissions.filter(o=>o.role_id===a.id&&o.effect==="allow").length,s=i.roleAssignments.filter(o=>o.company_id===e&&o.role_id===a.id).length;return`
  ...
  `,"finance-modal")}function Yn(e){const t=eo(e),a=Te(e),n=i.formsTab==="builder"&&a?"builder":i.formsTab==="responses"?"responses":"library";return`
  ...
  `}function Zn(e,t){const a=Ct(e.id);return`
    <div class="gform-editor-tabs panel" role="tablist" aria-label="Form editor sections">
      <div>
        ...
        <span>${r(e.status)} / ${Oi(e)} questions / ${a.length} responses</span>
      </div>
    ...
    <article class="question-workbench">
      <div class="question-canvas">
        <div class="gform-floating-toolbar" aria-label="Builder tools">
          ${Ue.map(([t,a])=>`<button type="button" data-action="add-question" data-question-type="${r(t)}" title="${r(a)}" aria-label="Add ${r(a)} question"><i class="ti ${r(ao(t))}"></i></button>`).join("")}
        </div>
  ...
  `}function is(e,t){const a=Ue.map(([n,s])=>`<option value="${r(n)}" ${e.type===n?"selected":""}>${r(s)}</option>`).join("");return`
  ...
  `}function os(e,t){const a=qr(t),n=bt(t),s=z(t).filter(c=>c.status!=="done").length,o=K(O(t),"estimate_total"),l=Fr(t);return`
  ...
  `}function ls(e,t){const a=Ir(e,t);if(!a)return I("CRM","Customer account",g("This customer is not visible in the current company view."));const n=a.latestJob,s=a.tasks.filter(o=>o.status!=="done");return I("CRM",a.name,`
    <div class="crm-account-modal">
      <section class="crm-modal-summary">
        ...
        ${N([["Primary contact",a.primaryContact],["Owner",a.owner],["Current stage",a.stage],["Pipeline value",_(a.estimateTotal)],["Open tasks",String(s.length)],["Last updated",M(a.updatedAt)]])}
      </section>
      ...
      <section class="crm-modal-section">
        ...
        <div class="queue-list">
          ${s.slice(0,6).map(o=>Dt(o)).join("")||g("No open follow-ups for this customer.")}
        </div>
      </section>
    </div>
  `,"crm-modal")}function cs(e,t){const a=ki(t),n=be(t),s=hi(t).slice().sort(Re("received_at")).slice(0,5),o=na(t).slice().sort(Re("spent_at")).slice(0,5),l=sa(t).slice().sort((c,m)=>c.name.localeCompare(m.name)).slice(0,5);return`
    <section class="tool-page finance-page">
      ...
      <section class="finance-secondary-grid">
        <article class="panel">
          ...
          <div class="finance-compact-list">
            ${s.map(c=>$e(ge(c.invoice_id)?.invoice_number||"Payment",c.method,_(c.amount),c.received_at)).join("")||g("No payments recorded.")}
          </div>
        </article>
        <article class="panel">
          <div class="section-head"><div><h2>Expenses</h2><p>Job and company costs.</p></div></div>
          <div class="finance-compact-list">
            ${o.map(c=>$e(Tt(c.vendor_id),c.category,_(c.amount),c.spent_at,d("finance",{expense:c.id},t))).join("")||g("No expenses recorded.")}
          </div>
        </article>
        <article class="panel">
  ...
  `}function ds(e,t){return e.params.get("invoice")?us(t,e.params.get("invoice")):e.params.get("expense")?ps(t,e.params.get("expense")):e.params.get("vendor")?ms(t,e.params.get("vendor")):e.params.get("report")==="summary"?fs(t):""}function us(e,t){const a=ge(t);if(!a||a.company_id!==e)return I("Finance","Invoice",g("Invoice not found."));const n=wi(a.id),s=D(a.job_id);return I("Finance",a.invoice_number,`
    <div class="finance-detail-modal">
      ${N([["Client",a.client_name||s?.client_name||"No client"],["Status",Si(a)],["Job",s?.name||"Company level"],["Issued",M(a.issue_date)],["Due",M(a.due_date)],["Total",_(a.total)],["Collected",_(oa(a.id))],["Balance",_(ae(a.id))]])}
  ...
  `,"finance-modal")}function ps(e,t){const a=$i(t);if(!a||a.company_id!==e)return I("Finance","Expense",g("Expense not found."));const n=D(a.job_id);return I("Finance",`${Tt(a.vendor_id)} expense`,`
    <div class="finance-detail-modal">
      ${N([["Vendor",Tt(a.vendor_id)],["Category",a.category],["Status",a.status],["Job",n?.name||"Company level"],["Spent",M(a.spent_at)],["Amount",_(a.amount)]])}
      <div class="finance-modal-actions">
  ...
  `,"finance-modal")}function ms(e,t){const a=ra(t);if(!a||a.company_id!==e)return I("Finance","Vendor",g("Vendor not found."));const n=na(e).filter(s=>s.vendor_id===a.id);return I("Finance",a.name,`
    <div class="finance-detail-modal">
  ...
  `,"finance-modal")}function ka(e,t=null){const a=t||Pr(e);return I("Finance",t?"Edit invoice":"New invoice",`
  ...
  `,"finance-form-modal")}function bs(e,t=""){const a=Lr(e,t),n=be(e).map(s=>[s.id,`${s.invoice_number} - ${s.client_name||D(s.job_id)?.client_name||"No client"}`]);return I("Finance","Record payment",`
    <form class="finance-form" data-finance-payment-form>
      ...
      ${R("Method","method",a.method,Ha.map(s=>[s,s]))}
  ...
  `,"finance-form-modal")}function ja(e,t=null,a=""){const n=t||Nr(e,a),s=sa(e).map(o=>[o.id,o.name]);return I("Finance",t?"Edit expense":"Add expense",`
  ...
  `,"finance-form-modal")}function Da(e,t=null){const a=t||Ur(e);return I("Finance",t?"Edit vendor":"Add vendor",`
  ...
  `}function ys(e){const t=yi(e),a=gt(e),n=qt().getTime(),s=n-6*864e5,o=Ma(e,n)+(a?Date.now()-Date.parse(a.started_at):0),l=Ma(e,s)+(a?Date.now()-Date.parse(a.started_at):0);return`
  ...
  `}function _s(e){const t=vi(e),a=t.filter(o=>o.type==="Form approval"),n=t.filter(o=>o.type==="Task review"),s=t.filter(o=>o.type==="Access request");return`
    <section class="tool-page operations-page">
  ...
  `}function Ft(e){return i.loginError?`<div class="form-message error">${r(i.loginError)}</div>`:`<div class="form-message">${r(i.authMessage||e)}</div>`}function Ss(e){return`
    <div class="modal-overlay">
  ...
  `}function At(e,t){return I("Jobs",t?"Edit job":"Create job",hn(e,t),"wide-modal")}function Ds(e,t){const a=e.jobId?D(e.jobId):null,n=e.params.get("task_id")||"",s=n?ta(n):null;return e.params.get("new")==="1"?I("Tasks","New task",Sa(t,a,null),"task-modal"):e.params.get("edit")==="1"&&s?I("Tasks","Edit task",Sa(t,a,s),"task-modal"):s?js("Task detail",s.title,jn(t,s)):""}function Cs(e){const t=i.selectedFileId?i.files.find(a=>a.id===i.selectedFileId):null;return t?I("Open file",t.file_name,Tn(t),"file-viewer-modal"):""}function qs(e){return I("Forms","Tools",`
  ...
  `)}function Is(e){const t=i.formStartTab==="templates"?"templates":"blank",a=Ae(),n=t==="templates"&&(a.find(m=>m.id===i.formStartTemplateId)||a[0])||null,s=n?.title||"",o=n?.description||"",l=n?.type||"Internal",c=n?.questions||[{type:"short",label:"First question",required:!1,options:[]}];return I("Forms","New form builder",`
  ...
  `,"form-create-modal builder-modal")}function Fs(e,t){const a=Oe(e)?`
  ...
  `}function As(e,t){return t?I("Forms","Preview form",`
    <div class="form-preview-modal-body">
      ${ns(e,t)}
    </div>
  `,"form-preview-modal"):I("Forms","Preview form",g("Choose a form first."))}function Ms(e,t){return t?I("Forms","Manage form",`
  ...
  `):I("Forms","Manage form",g("Choose a form first."))}function xs(e){const t=i.accountMenuOpen&&!e.target.closest(".account-menu");t&&(i.accountMenuOpen=!1);const a=e.target.closest("[data-action]");if(a){Es(e,a);return}const n=e.target.closest("[data-select-job]");if(n){e.preventDefault(),$r(n.dataset.selectJob);return}const s=e.target.closest("[data-select-task]");if(s){e.preventDefault(),wr(s.dataset.selectTask);return}const o=e.target.closest("a[href][data-router]");if(!o){t&&u();return}o.target||o.hasAttribute("download")||(e.preventDefault(),k(o.getAttribute("href")))}function Es(e,t){const a=t.dataset.action;if(a==="refresh-data"){e.preventDefault(),i.dataLoaded=!1,i.sync={label:"Refreshing...",mode:"loading"},u();return}if(a==="sign-out"){e.preventDefault(),i.accountMenuOpen=!1,Rs();return}if(a==="toggle-account-menu"){e.preventDefault(),i.accountMenuOpen=!i.accountMenuOpen,u();return}if(a==="start-demo-mode"){e.preventDefault(),di(t.dataset.returnUrl||"");return}if(a==="set-auth-mode"){e.preventDefault(),i.authMode=["signin","register","request"].includes(t.dataset.authMode)?t.dataset.authMode:"signin",i.loginError="",i.authMessage="",u();return}if(a==="open-profile"){e.preventDefault(),i.accountMenuOpen=!1,i.modal="profile",u();return}if(a==="open-role-form"){e.preventDefault(),i.modal="role-new",u();return}if(a==="open-invite-form"){e.preventDefault(),i.modal="invite-new",u();return}if(a==="copy-invite-link"){e.preventDefault(),Bs(t.dataset.inviteId);return}if(a==="revoke-invite"){e.preventDefault(),Hs(t.dataset.inviteId);return}if(a==="approve-join-request"){e.preventDefault(),qa(t.dataset.requestId,"approved");return}if(a==="reject-join-request"){e.preventDefault(),qa(t.dataset.requestId,"rejected");return}if(a==="start-checkout"){e.preventDefault(),Qs();return}if(a==="open-file-upload"){e.preventDefault(),i.modal="file-upload",u();return}if(a==="open-folder-form"){e.preventDefault(),i.modal="folder-new",u();return}if(a==="open-job-form"){e.preventDefault();const n=t.dataset.jobId||"";n&&(i.selectedJobId=n),i.modal=t.dataset.mode==="edit"?"job-edit":"job-new",u();return}if(a==="open-forms-tools"){e.preventDefault(),i.modal="forms-tools",u();return}if(a==="open-form-actions"){e.preventDefault(),Ke(t.dataset.formId,!1),i.modal="form-actions",u();return}if(a==="open-form-preview"){e.preventDefault(),Ke(t.dataset.formId,!1),i.modal="form-preview",u();return}if(a==="set-form-start-tab"){e.preventDefault(),i.formStartTab=t.dataset.tab==="templates"?"templates":"blank",i.formStartTab==="blank"&&(i.formStartTemplateId=""),i.formStartTab==="templates"&&!i.formStartTemplateId&&(i.formStartTemplateId=Ae()[0]?.id||""),u();return}if(a==="select-form-start-template"){e.preventDefault(),i.formStartTab="templates",i.formStartTemplateId=t.dataset.templateId||Ae()[0]?.id||"",u();return}if(a==="close-modal"){e.preventDefault(),Ts();return}if(a==="set-task-view"){e.preventDefault(),i.taskView=t.dataset.view==="board"?"board":"table",localStorage.setItem(La,i.taskView),u();return}if(a==="set-drive-view"){e.preventDefault(),i.driveView=t.dataset.view==="list"?"list":"grid",localStorage.setItem(Na,i.driveView),u();return}if(a==="clock-in"){e.preventDefault(),Ar(p(),t.dataset.taskId||i.route?.params?.get("task_id")||"");return}if(a==="clock-out"){e.preventDefault(),_i();return}if(a==="select-file"){e.preventDefault(),i.selectedFileId=t.dataset.fileId||"",i.modal="file-detail",u();return}if(a==="download-file"){e.preventDefault(),rr(t.dataset.fileId);return}if(a==="delete-file"){e.preventDefault(),or(t.dataset.fileId);return}if(a==="set-forms-tab"){e.preventDefault(),i.formsTab=t.dataset.tab==="responses"?"responses":"library",u();return}if(a==="set-form-editor-tab"){e.preventDefault(),i.formEditorTab=t.dataset.tab||"questions",u();return}if(a==="new-form"){e.preventDefault(),i.formStartTemplateId=t.dataset.templateId||"",i.formStartTab=t.dataset.startTab==="templates"||i.formStartTemplateId?"templates":"blank",i.formStartTab==="templates"&&!i.formStartTemplateId&&(i.formStartTemplateId=Ae()[0]?.id||""),i.modal="form-new",u();return}if(a==="select-form"){e.preventDefault(),Ke(t.dataset.formId);return}if(a==="toggle-form-card"){e.preventDefault();const n=t.dataset.formId||"";i.expandedFormIds.has(n)?i.expandedFormIds.delete(n):i.expandedFormIds.add(n),u();return}if(a==="edit-form"){e.preventDefault(),Ke(t.dataset.formId,!1),i.formsTab="builder",i.formEditorTab="questions",i.modal="",u();return}if(a==="save-form"){e.preventDefault(),J("Form saved locally"),u();return}if(a==="publish-form"){e.preventDefault(),Ta(t.dataset.formId,"Published");return}if(a==="archive-form"){e.preventDefault(),Ta(t.dataset.formId,"Archived");return}if(a==="duplicate-form"){e.preventDefault(),oo(t.dataset.formId);return}if(a==="delete-form"){e.preventDefault(),lo(t.dataset.formId);return}if(a==="copy-form-link"){e.preventDefault(),co(t.dataset.formId);return}if(a==="export-forms"){e.preventDefault(),uo(p());return}if(a==="new-finance-invoice"){e.preventDefault(),i.selectedFinanceInvoiceId="",i.modal="finance-invoice-new",u();return}if(a==="edit-finance-invoice"){e.preventDefault(),i.selectedFinanceInvoiceId=t.dataset.invoiceId||"",i.modal="finance-invoice-edit",u();return}if(a==="new-finance-payment"){e.preventDefault(),i.selectedFinanceInvoiceId=t.dataset.invoiceId||i.route?.params?.get("invoice")||"",i.modal="finance-payment-new",u();return}if(a==="new-finance-expense"){e.preventDefault(),i.selectedFinanceExpenseId="",i.selectedFinanceVendorId=t.dataset.vendorId||"",i.modal="finance-expense-new",u();return}if(a==="edit-finance-expense"){e.preventDefault(),i.selectedFinanceExpenseId=t.dataset.expenseId||"",i.modal="finance-expense-edit",u();return}if(a==="new-finance-vendor"){e.preventDefault(),i.selectedFinanceVendorId="",i.modal="finance-vendor-new",u();return}if(a==="edit-finance-vendor"){e.preventDefault(),i.selectedFinanceVendorId=t.dataset.vendorId||"",i.modal="finance-vendor-edit",u();return}if(a==="add-question"){e.preventDefault(),po(t.dataset.questionType||"multiple");return}if(a==="duplicate-question"){e.preventDefault(),mo(t.dataset.questionId);return}if(a==="delete-question"){e.preventDefault(),fo(t.dataset.questionId);return}if(a==="move-question"){e.preventDefault(),bo(t.dataset.questionId,Number(t.dataset.direction||0));return}if(a==="add-question-option"){e.preventDefault(),go(t.dataset.questionId);return}if(a==="remove-question-option"){e.preventDefault(),vo(t.dataset.questionId,Number(t.dataset.optionIndex||-1));return}if(a==="delete-job"){e.preventDefault(),Gs(t.dataset.jobId);return}a==="delete-task"&&(e.preventDefault(),Xs(t.dataset.taskId))}function Ts(){const e=i.route||ft();if(i.modal="",i.formStartTemplateId="",i.formStartTab="blank",i.selectedFinanceInvoiceId="",i.selectedFinanceExpenseId="",i.selectedFinanceVendorId="",e.name==="company"&&e.section==="tasks"&&(e.params.get("new")||e.params.get("edit")||e.params.get("task_id"))){k(d("tasks",e.jobId?{job_id:e.jobId}:{},e.companyId),{replace:!0});return}if(e.name==="company"&&e.section==="jobs"&&e.params.get("tab")==="editor"){const t=e.jobId?D(e.jobId):pe();k(d("jobs",{tab:t?"profile":"pipeline",...t?{job_id:t.id}:{}},e.companyId),{replace:!0});return}if(e.name==="company"&&e.section==="crm"&&e.params.get("account")){k(d("crm",{},e.companyId),{replace:!0});return}if(e.name==="company"&&e.section==="finance"&&(e.params.get("invoice")||e.params.get("expense")||e.params.get("vendor")||e.params.get("report"))){k(d("finance",{},e.companyId),{replace:!0});return}u()}function Os(e){if(e.target.matches("[data-login-form]")){e.preventDefault();const t=Object.fromEntries(new FormData(e.target).entries());if(!(String(t.username||"").trim()===we.localUsername&&String(t.password||"")===we.localPassword)){i.loginError="Invalid temporary credentials.",u();return}i.loginError="",di(t.return_url||b(d("jobs",{},F())));return}if(e.target.matches("[data-auth-sign-in-form]")){e.preventDefault(),Ps(e.target);return}if(e.target.matches("[data-auth-register-form]")){e.preventDefault(),Ls(e.target);return}if(e.target.matches("[data-auth-request-form]")){e.preventDefault(),Us(e.target);return}if(e.target.matches("[data-company-create-form]")){e.preventDefault(),Ns(e.target);return}if(e.target.matches("[data-profile-form]")){e.preventDefault();const t=Object.fromEntries(new FormData(e.target).entries()),a={...C().profile,full_name:String(t.full_name||"").trim()||"Quest Basic Mode",avatar_url:String(t.avatar_url||"").trim()};x(Pa,a),i.profileDraft=a,i.session={...C(),profile:a},x(Se,i.session),i.modal="",u();return}if(e.target.matches("[data-job-form]")){e.preventDefault(),Ks(e.target);return}if(e.target.matches("[data-task-form]")){e.preventDefault(),Zs(e.target);return}if(e.target.matches("[data-new-form-form]")){e.preventDefault(),ro(e.target);return}if(e.target.matches("[data-file-form]")){e.preventDefault(),er(e.target);return}if(e.target.matches("[data-folder-form]")){e.preventDefault(),tr(e.target);return}if(e.target.matches("[data-finance-invoice-form]")){e.preventDefault(),ar(e.target);return}if(e.target.matches("[data-finance-payment-form]")){e.preventDefault(),ir(e.target);return}if(e.target.matches("[data-finance-expense-form]")){e.preventDefault(),nr(e.target);return}if(e.target.matches("[data-finance-vendor-form]")){e.preventDefault(),sr(e.target);return}if(e.target.matches("[data-role-form]")){e.preventDefault(),Vs(e.target);return}if(e.target.matches("[data-invite-form]")){e.preventDefault(),Js(e.target);return}if(e.target.matches("[data-user-role-form]")){e.preventDefault(),zs(e.target);return}e.target.matches("[data-form-preview-response]")&&(e.preventDefault(),yo(e.target))}async function Rs(){if(i.session?.auth==="supabase"){const e=P();e?.auth&&await e.auth.signOut()}localStorage.removeItem(Se),i.session=null,i.dataLoaded=!1,k("/login",{replace:!0})}function di(e=""){i.loginError="",i.authMessage="",i.session=Rt(),ni(),i.activeCompanyId=p(),localStorage.setItem(ne,i.activeCompanyId),x(Se,i.session),i.dataLoaded=!1,i.dataLoading=!1,k(ea(e||b(d("jobs",{},p()))),{replace:!0})}async function Ps(e){const t=Object.fromEntries(new FormData(e).entries()),a=P();if(!a?.auth){i.loginError="Supabase auth is unavailable.",u();return}i.loginError="",i.authMessage="Signing in...",u();const n=await a.auth.signInWithPassword({email:String(t.email||"").trim(),password:String(t.password||"")});if(n.error){i.loginError=n.error.message||"Unable to sign in.",i.authMessage="",u();return}if(await Me(n.data.session),t.invite_token){await ui(t.invite_token,t.return_url);return}i.authMessage="",i.dataLoaded=!1,k(ea(t.return_url||b(d("jobs",{},F()))),{replace:!0})}async function Ls(e){const t=Object.fromEntries(new FormData(e).entries()),a=P();if(!a?.auth){i.loginError="Supabase auth is unavailable.",u();return}const n=String(t.email||"").trim(),s=String(t.password||""),o=String(t.full_name||"").trim(),l=String(t.invite_token||"").trim(),c=String(t.company_name||"").trim();if(!n||!s||!o||!l&&!c){i.loginError=l?"Name, email, and password are required.":"Name, email, password, and company workspace are required.",u();return}i.loginError="",i.authMessage=l?"Creating account and accepting invite...":"Creating secure workspace...",u();const m=await a.auth.signUp({email:n,password:s,options:{data:{full_name:o}}});if(m.error){i.loginError=m.error.message||"Unable to create account.",i.authMessage="",u();return}let v=m.data.session;if(!v){const y=await a.auth.signInWithPassword({email:n,password:s});if(y.error){i.loginError="Account created. Please sign in to finish workspace setup.",i.authMode="signin",i.authMessage="",u();return}v=y.data.session}if(await Me(v),l){await ui(l,t.return_url);return}const f=await a.rpc("create_company_workspace",{company_name:c});if(f.error){i.loginError=f.error.message||"Account created, but workspace setup failed.",i.authMessage="",u();return}i.activeCompanyId=h(f.data||F()),localStorage.setItem(ne,i.activeCompanyId),i.dataLoaded=!1,i.authMessage="",k(d("settings",{tab:"billing"},i.activeCompanyId),{replace:!0})}async function Ns(e){const t=Object.fromEntries(new FormData(e).entries()),a=P(),n=String(t.company_name||"").trim();if(!a||!n){i.loginError="Company workspace name is required.",u();return}const s=await a.rpc("create_company_workspace",{company_name:n});if(s.error){i.loginError=s.error.message||"Workspace setup failed.",u();return}i.activeCompanyId=h(s.data||F()),localStorage.setItem(ne,i.activeCompanyId),i.dataLoaded=!1,k(d("settings",{tab:"billing"},i.activeCompanyId),{replace:!0})}async function Us(e){const t=Object.fromEntries(new FormData(e).entries()),a=P();if(!a?.auth){i.loginError="Supabase auth is unavailable.",u();return}const n=String(t.email||"").trim(),s=String(t.password||""),o=h(t.company_id||"");i.loginError="",i.authMessage="Submitting access request...",u();const l=await a.auth.signInWithPassword({email:n,password:s});if(l.error){i.loginError=l.error.message||"Sign in first to request access.",i.authMessage="",u();return}await Me(l.data.session);const c=await a.rpc("request_company_access",{target_company_id:o,request_message:String(t.message||"").trim()||null});if(c.error){i.loginError=c.error.message||"Unable to request access.",i.authMessage="",u();return}i.authMessage="Access request sent. An Owner/Admin must approve it.",i.loginError="",i.authMode="signin",u()}async function Qs(){const e=p();i.sync={label:"Opening billing...",mode:"loading"},u();try{const t=await fetch("/api/create-checkout-session",{method:"POST",headers:{"Content-Type":"application/json",...C().access_token?{Authorization:`Bearer ${C().access_token}`}:{}},body:JSON.stringify({company_id:e,return_url:`${window.location.origin}${b(d("settings",{tab:"billing"},e))}`})}),a=await t.json().catch(()=>({}));if(!t.ok||!a.url)throw new Error(a.error||"Billing is not configured yet.");window.location.href=a.url}catch(t){i.sync={label:t.message||"Billing unavailable",mode:"local"},u()}}async function Vs(e){const t=p(),a=new FormData(e),n=he({id:crypto.randomUUID(),company_id:t,name:a.get("name"),color:a.get("color")||"#f0b23b",priority:a.get("priority")||100,is_system:!1,created_by:C().profile.id}),s=a.getAll("permissions").map(l=>String(l||"")).filter(Boolean),o=P();if(i.session?.auth==="supabase"&&o){const l=await o.from("roles").insert(n).select().single();if(l.error){i.sync={label:l.error.message||"Role save failed",mode:"local"},u();return}const c=he(l.data),m=s.map(v=>({role_id:c.id,permission_key:v,effect:"allow"}));m.length&&await o.from("role_permissions").insert(m),i.roles.unshift(c),i.rolePermissions=m.concat(i.rolePermissions).map(Ot),i.sync={label:"Role saved",mode:"live"}}else i.roles.unshift(n),i.rolePermissions=s.map(l=>Ot({role_id:n.id,permission_key:l,effect:"allow"})).concat(i.rolePermissions),i.sync={label:"Role saved locally",mode:"local"};i.modal="",u()}async function Js(e){const t=new FormData(e),a=h(t.get("company_id")||p()),n=String(t.get("email")||"").trim().toLowerCase(),s=String(t.get("role_id")||"").trim();if(!n){i.sync={label:"Invite email is required",mode:"local"},u();return}const o=rt({id:crypto.randomUUID(),company_id:a,email:n,role_id:ha(s)?s:"",token:crypto.randomUUID().replaceAll("-","")+crypto.randomUUID().replaceAll("-","").slice(0,16),status:"pending",invited_by:C().profile.id,expires_at:new Date(Date.now()+336*60*60*1e3).toISOString(),created_at:new Date().toISOString()}),l=P();if(i.session?.auth==="supabase"&&l){const c={company_id:o.company_id,email:o.email,role_id:o.role_id||null,status:"pending",invited_by:C().profile.id},m=await l.from("company_invites").insert(c).select().single();if(m.error){i.sync={label:m.error.message||"Invite save failed",mode:"local"},u();return}i.companyInvites.unshift(rt(m.data)),i.sync={label:"Invite created. Copy the link to send it.",mode:"live"}}else i.companyInvites.unshift(o),i.sync={label:"Invite created locally",mode:"local"};i.modal="",u()}async function ui(e,t=""){const a=P();if(!a){i.loginError="Supabase auth is unavailable.",i.authMessage="",u();return}i.authMessage="Accepting workspace invite...",u();const n=await a.rpc("accept_company_invite",{invite_token:String(e||"").trim()});if(n.error){i.loginError=n.error.message||"Unable to accept invite.",i.authMessage="",u();return}const s=h(n.data||F());i.activeCompanyId=s,localStorage.setItem(ne,s),i.authMessage="",i.loginError="",i.dataLoaded=!1,k(d("jobs",{},s),{replace:!0})}async function Bs(e){const t=i.companyInvites.find(a=>a.id===e);if(!t?.token){i.sync={label:"Invite link is unavailable",mode:"local"},u();return}try{await navigator.clipboard.writeText(Dr(t)),i.sync={label:"Invite link copied",mode:"live"}}catch{i.sync={label:"Copy failed",mode:"local"}}u()}async function Hs(e){const t=i.companyInvites.find(n=>n.id===e);if(!t)return;const a=P();if(i.session?.auth==="supabase"&&a){const n=await a.from("company_invites").update({status:"revoked",updated_at:new Date().toISOString()}).eq("id",t.id);if(n.error){i.sync={label:n.error.message||"Invite revoke failed",mode:"local"},u();return}i.sync={label:"Invite revoked",mode:"live"}}else i.sync={label:"Invite revoked locally",mode:"local"};i.companyInvites=i.companyInvites.map(n=>n.id===t.id?rt({...n,status:"revoked"}):n),Q(),u()}async function zs(e){const t=new FormData(e),a=h(t.get("company_id")||p()),n=String(t.get("profile_id")||"").trim(),s=String(t.get("role_id")||"").trim(),o=["active","pending","disabled"].includes(String(t.get("membership_status")))?String(t.get("membership_status")):"active",l=aa(a,s);if(!n||!l){i.sync={label:"Select a user and role",mode:"local"},u();return}const c=st({company_id:a,profile_id:n,role:Cr(l),status:o}),m=qi({company_id:a,profile_id:n,role_id:l.id,assigned_by:C().profile.id}),v=P();if(i.session?.auth==="supabase"&&v){const f=ha(l.id),y=await v.from("company_memberships").upsert(pi(c),{onConflict:"company_id,profile_id"}).select().single();if(y.error){i.sync={label:y.error.message||"Access update failed",mode:"local"},u();return}if(f){await v.from("user_role_assignments").delete().eq("company_id",a).eq("profile_id",n);const L=await v.from("user_role_assignments").insert(m);if(L.error){i.sync={label:L.error.message||"Role assignment failed",mode:"local"},u();return}}tt(st(y.data||c)),f&&Aa(m),i.sync={label:f?"User access saved":"Membership saved; create a role to assign permissions",mode:"live"}}else tt(c),Aa(m),i.sync={label:"User access saved locally",mode:"local"};u()}async function qa(e,t){const a=i.joinRequests.find(l=>l.id===e);if(!a||!["approved","rejected"].includes(t))return;const n=P(),s=Ii({...a,status:t}),o=st({company_id:a.company_id,profile_id:a.profile_id,role:"member",status:t==="approved"?"active":"disabled"});if(i.session?.auth==="supabase"&&n){if(t==="approved"){const c=await n.from("company_memberships").upsert(pi(o),{onConflict:"company_id,profile_id"});if(c.error){i.sync={label:c.error.message||"Approval failed",mode:"local"},u();return}}const l=await n.from("company_join_requests").update({status:t,reviewed_by:C().profile.id,updated_at:new Date().toISOString()}).eq("id",a.id);if(l.error){i.sync={label:l.error.message||"Request update failed",mode:"local"},u();return}t==="approved"&&tt(o),i.sync={label:t==="approved"?"Access approved":"Request rejected",mode:"live"}}else t==="approved"&&tt(o),i.sync={label:t==="approved"?"Access approved locally":"Request rejected locally",mode:"local"};i.joinRequests=i.joinRequests.map(l=>l.id===a.id?s:l),Q(),u()}function Ws(e){if(e.target.matches("[data-global-search]")){i.query=e.target.value,ze();return}if(e.target.matches("[data-file-search]")){i.fileQuery=e.target.value,ze();return}if(e.target.matches("[data-form-search]")){i.formQuery=e.target.value,ze();return}if(e.target.matches("[data-crm-search]")){i.crmQuery=e.target.value,ze();return}if(e.target.matches("[data-form-field]")){Li(e.target);return}(e.target.matches("[data-question-field]")||e.target.matches("[data-question-option]"))&&Ni(e.target)}function Ys(e){if(e.target.matches("[data-company-switch]")){const t=e.target.value||F();_r(t);return}if(e.target.matches("[data-stage-filter]")){i.stageFilter=e.target.value||"all",u();return}if(e.target.matches("[data-crm-stage-filter]")){i.crmStageFilter=e.target.value||"all",u();return}if(e.target.matches("[data-crm-owner-filter]")){i.crmOwnerFilter=e.target.value||"all",u();return}if(e.target.matches("[data-task-status-filter]")){i.taskStatusFilter=e.target.value||"all",u();return}if(e.target.matches("[data-task-priority-filter]")){i.taskPriorityFilter=e.target.value||"all",u();return}if(e.target.matches("[data-task-job-filter]")){const t=e.target.value;k(d("tasks",t?{job_id:t}:{},p()));return}if(e.target.matches("[data-analytics-job-filter]")){const t=e.target.value;k(d("analytics",t?{job_id:t}:{},p()));return}if(e.target.matches("[data-file-category-filter]")){i.fileCategoryFilter=e.target.value||"All categories",u();return}if(e.target.matches("[data-file-folder-filter]")){const t=e.target.value==="home"?"":e.target.value,a=i.route?.jobId||"";k(d("files",{...t?{folder:t}:{},...a?{job_id:a}:{}},p()));return}if(e.target.matches("[data-file-job-filter]")){const t=e.target.value;k(d("files",{...t?{folder:"jobs",job_id:t}:{}},p()));return}if(e.target.matches("[data-form-type-filter]")){i.formTypeFilter=e.target.value||"all",u();return}if(e.target.matches("[data-form-field]")){Li(e.target);return}(e.target.matches("[data-question-field]")||e.target.matches("[data-question-option]"))&&Ni(e.target)}async function Ks(e){const t=ke(Object.fromEntries(new FormData(e).entries()));t.id=t.id||crypto.randomUUID(),t.company_id=t.company_id||p(),t.estimate_total=Number(t.estimate_total||0),t.invoice_total=Number(t.invoice_total||0),t.updated_at=new Date().toISOString();const a=i.jobs.some(s=>s.id===t.id),n=P();if(n){const s=a?await n.from("jobs").update(t).eq("id",t.id).select().single():await n.from("jobs").insert(t).select().single();if(!s.error&&s.data){Mt(ke(s.data)),i.sync={label:"Quest Supabase live",mode:"live"},i.modal="",k(d("jobs",{tab:"profile",job_id:s.data.id},t.company_id),{replace:!0});return}i.sync={label:"Saved locally",mode:"local"}}Mt(t),i.modal="",k(d("jobs",{tab:"profile",job_id:t.id},t.company_id),{replace:!0})}async function Gs(e){if(!e)return;const t=p(),a=P();a&&await a.from("jobs").delete().eq("id",e),i.jobs=i.jobs.filter(n=>n.id!==e),i.selectedJobId=O(t)[0]?.id||"",i.modal="",Q(),k(d("jobs",{tab:"list"},t),{replace:!0})}async function Zs(e){const t=p(),a=Object.fromEntries(new FormData(e).entries()),n=je({...a,id:String(a.id||"").trim()||`task-${crypto.randomUUID()}`,company_id:t,creator_id:C().profile.member_id||se(t)[0]?.id||"abraham",urgency:a.priority||"medium",watchers:[],subtasks:[],activity:[],updated_at:new Date().toISOString()}),s=i.tasks.some(l=>l.id===n.id),o=P();if(o){const l=Qr(n),c=s?await o.from("tasks").update(l).eq("id",n.id).select().single():await o.from("tasks").insert(l).select().single();if(!c.error&&c.data){Ia(je(c.data)),i.sync={label:"Quest Supabase live",mode:"live"},i.modal="",k(d("tasks",{...n.project_id?{job_id:n.project_id}:{},task_id:n.id},t),{replace:!0});return}i.sync={label:"Task saved locally",mode:"local"}}Ia(n),i.modal="",k(d("tasks",{...n.project_id?{job_id:n.project_id}:{},task_id:n.id},t),{replace:!0})}async function Xs(e){if(!e)return;const t=p(),a=P();a&&await a.from("tasks").delete().eq("id",e),i.tasks=i.tasks.filter(n=>n.id!==e),i.selectedTaskId="",i.modal="",Q(),k(d("tasks",{},t),{replace:!0})}async function er(e){const t=p(),a=new FormData(e),n=Object.fromEntries(a.entries()),s=Array.from(e.elements.files?.files||[]),o=String(n.file_name||"").trim(),l=s.length?s:o?[null]:[];if(!l.length){i.sync={label:"Choose a file or enter a file name",mode:"local"},u();return}const c=P();let m=0;for(const v of l){const f=crypto.randomUUID(),y=v?.name||o,L=String(n.folder||"shared"),q=`${t}/${n.job_id?`jobs/${n.job_id}`:L}/${f}-${_a(y)}`;let H=!1;c&&v&&(H=!(await c.storage.from("quest-job-files").upload(q,v,{cacheControl:"3600",upsert:!1,contentType:v.type||"application/octet-stream"})).error);const Ie=Ee({id:f,company_id:t,job_id:n.job_id||"",folder:L,file_name:y,mime_type:v?.type||"application/octet-stream",size_bytes:v?.size||Number(n.size_bytes||0),category:n.category||ee(L),notes:n.notes||"",uploaded_by_label:n.uploaded_by_label||C().profile.full_name,bucket_id:"quest-job-files",object_path:H||!v?q:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()});if(c){const ce=await c.from("job_files").insert(Vr(Ie)).select().single();if(!ce.error&&ce.data){Fa(Ee(ce.data)),m+=1;continue}H&&await c.storage.from("quest-job-files").remove([q])}Fa(Ie)}i.sync=m===l.length?{label:"Quest Supabase live",mode:"live"}:{label:m?"Some files saved locally":"File record saved locally",mode:m?"loading":"local"},i.modal="",k(d("files",{folder:n.folder||"shared",...n.job_id?{job_id:n.job_id}:{}},t),{replace:!0})}function tr(e){const t=Object.fromEntries(new FormData(e).entries()),a=String(t.name||"").trim();if(!a){i.sync={label:"Folder name is required",mode:"local"},u();return}const n=ua({id:`folder-${crypto.randomUUID()}`,company_id:p(),name:a,parent_key:t.parent_key||"home",created_by_label:C().profile.full_name||"Quest HQ",created_at:new Date().toISOString(),updated_at:new Date().toISOString()});i.driveFolders.unshift(n),i.modal="",i.sync={label:"Folder created locally",mode:"local"},Q(),u()}function ar(e){const t=Object.fromEntries(new FormData(e).entries()),a=p(),n=D(t.job_id),s=String(t.id||"").trim()?ge(String(t.id).trim()):null,o=wt({...t,id:String(t.id||"").trim()||`invoice-${crypto.randomUUID()}`,company_id:a,client_name:String(t.client_name||n?.client_name||"").trim(),total:T(t.subtotal)+T(t.tax),updated_at:new Date().toISOString()});lr(o),s?.job_id&&s.job_id!==o.job_id&&xt(s.job_id),xt(o.job_id),i.modal="",i.sync={label:"Finance saved locally",mode:"local"},k(d("finance",{invoice:o.id},a),{replace:!0})}function ir(e){const t=Object.fromEntries(new FormData(e).entries()),a=p(),n=ge(t.invoice_id);if(!n||n.company_id!==a){i.sync={label:"Create an invoice before recording a payment",mode:"local"},u();return}const s=St({...t,id:`payment-${crypto.randomUUID()}`,company_id:a,created_at:new Date().toISOString()});i.financePayments.unshift(s),n.status=ae(n.id)<=0?"Paid":"Partially paid",n.updated_at=new Date().toISOString(),xt(n.job_id),Q(),i.modal="",i.sync={label:"Payment recorded locally",mode:"local"},k(d("finance",s.invoice_id?{invoice:s.invoice_id}:{},a),{replace:!0})}function nr(e){const t=Object.fromEntries(new FormData(e).entries()),a=p(),n=kt({...t,id:String(t.id||"").trim()||`expense-${crypto.randomUUID()}`,company_id:a,updated_at:new Date().toISOString()});cr(n),i.modal="",i.sync={label:"Expense saved locally",mode:"local"},k(d("finance",{expense:n.id},a),{replace:!0})}function sr(e){const t=Object.fromEntries(new FormData(e).entries()),a=p(),n=jt({...t,id:String(t.id||"").trim()||`vendor-${crypto.randomUUID()}`,company_id:a,updated_at:new Date().toISOString()});dr(n),i.modal="",i.sync={label:"Vendor saved locally",mode:"local"},k(d("finance",{vendor:n.id},a),{replace:!0})}async function rr(e){const t=i.files.find(s=>s.id===e);if(!t?.object_path){i.sync={label:"No stored object for this file",mode:"local"},u();return}const a=P();if(!a)return;const n=await a.storage.from(t.bucket_id||"quest-job-files").createSignedUrl(t.object_path,3600,{download:t.file_name});if(n.error||!n.data?.signedUrl){i.sync={label:"Download failed",mode:"local"},u();return}window.open(n.data.signedUrl,"_blank","noopener,noreferrer")}async function or(e){const t=i.files.find(n=>n.id===e);if(!t)return;const a=P();a&&(t.object_path&&await a.storage.from(t.bucket_id||"quest-job-files").remove([t.object_path]),await a.from("job_files").update({deleted_at:new Date().toISOString()}).eq("id",e)),i.files=i.files.filter(n=>n.id!==e),i.selectedFileId="",i.modal="",Q(),u()}function Mt(e){const t=i.jobs.findIndex(a=>a.id===e.id);t>=0?i.jobs[t]=e:i.jobs.unshift(e),i.selectedJobId=e.id,Q()}function Ia(e){const t=i.tasks.findIndex(a=>a.id===e.id);t>=0?i.tasks[t]=e:i.tasks.unshift(e),i.selectedTaskId=e.id,Q()}function Fa(e){const t=i.files.findIndex(a=>a.id===e.id);t>=0?i.files[t]=e:i.files.unshift(e),Q()}function lr(e){const t=i.financeInvoices.findIndex(a=>a.id===e.id);t>=0?i.financeInvoices[t]=e:i.financeInvoices.unshift(e),Q()}function cr(e){const t=i.financeExpenses.findIndex(a=>a.id===e.id);t>=0?i.financeExpenses[t]=e:i.financeExpenses.unshift(e),Q()}function dr(e){const t=i.financeVendors.findIndex(a=>a.id===e.id);t>=0?i.financeVendors[t]=e:i.financeVendors.unshift(e),Q()}function tt(e){const t=i.memberships.findIndex(a=>a.company_id===e.company_id&&a.profile_id===e.profile_id);t>=0?i.memberships[t]=e:i.memberships.unshift(e),Q()}function Aa(e){i.roleAssignments=i.roleAssignments.filter(t=>t.company_id!==e.company_id||t.profile_id!==e.profile_id),e.role_id&&i.roleAssignments.unshift(e)}function pi(e){return{company_id:e.company_id,profile_id:e.profile_id,role:e.role,status:e.status}}function xt(e){if(!e)return;const t=D(e);t&&(t.invoice_total=K(be(t.company_id).filter(a=>a.job_id===e),"total"),t.updated_at=new Date().toISOString(),Mt(t))}function ze(){const e=document.getElementById("workspace");e&&(mi(i.route),e.innerHTML=oi(i.route))}function ft(){const e=Xt(),t=new URLSearchParams(window.location.search);if(e==="/login")return{name:"login",path:e,params:t,section:"",companyId:"",jobId:""};if(e==="/"||e==="/command")return{name:"command",path:e,params:t,section:"dashboard",companyId:p(),jobId:t.get("job_id")||""};const a=e.match(/^\/company\/([^/]+)(?:\/([^/]+))?\/?$/);if(a){const n=a[2]||"jobs";return{name:"company",path:e,params:t,companyId:decodeURIComponent(a[1]),section:n,jobId:t.get("job_id")||""}}return{name:e.replace(/^\//,"")||"command",path:e,params:t,section:"",companyId:p(),jobId:t.get("job_id")||""}}function ur(){const e=Xt(),t=new URLSearchParams(window.location.search),a=t.get("company_id")||t.get("company")||Ze(t.get("job_id")||t.get("project_id"))||localStorage.getItem(ne)||F(),n=Object.fromEntries(Object.entries(Hi).map(([l,c])=>[l,d(c,{},a)]));Object.assign(n,{"/index.html":d("jobs",{},a),"/command.html":d("jobs",{},a),"/login.html":"/login"});let s=n[e];if(e==="/jobs"){const l=t.get("tab");l==="tasks"?s=d("tasks",Y(t,["job_id","task_id","new","edit"]),a):l==="files"?s=d("files",Y(t,["job_id","folder"]),a):l==="forms"?s=d("forms",Y(t,["job_id"]),a):l==="analytics"?s=d("analytics",Y(t,["job_id"]),a):s=d("jobs",Y(t,["job_id","tab"]),a)}if(e==="/files"&&(s=d("files",Y(t,["job_id","folder"]),a)),e==="/forms"&&(s=d("forms",Y(t,["job_id"]),a)),e==="/analytics"&&(s=d("analytics",Y(t,["job_id"]),a)),e==="/crm"&&(s=d("crm",Y(t,["account"]),a)),e==="/finance"&&(s=d("finance",Y(t,["invoice","expense","vendor","report"]),a)),e==="/admin"&&(s=d("settings",{},a)),e==="/time"&&(s=d("time",{},a)),e==="/team"&&(s=d("team-chart",{},a)),e==="/team-chart"&&(s=d("team-chart",{},a)),e==="/approvals"&&(s=d("approvals",{},a)),e==="/clock"&&(s=d("clock",{},a)),e==="/task-management.html"){const l=t.get("project_id")||t.get("job_id")||"";s=d("tasks",l?{job_id:l}:{},Ze(l)||a)}const o=e.match(/^\/jobs\/([^/]+)\/tasks\/?$/);if(o){const l=decodeURIComponent(o[1]);s=d("tasks",{job_id:l},Ze(l)||a)}s&&window.history.replaceState({},"",b(s))}function pr(e){if(e.name!=="company")return"";const t=qe();if(i.session?.auth==="supabase"&&!t.length)return null;if(!t.includes(e.companyId))return d(e.section||"jobs",Object.fromEntries(e.params.entries()),t[0]||F());if(!ut.map(s=>s.id).includes(e.section))return d("jobs",{},e.companyId);const n=e.jobId?Ze(e.jobId):"";return n&&n!==e.companyId&&t.includes(n)?d(e.section,Object.fromEntries(e.params.entries()),n):""}function Xt(){let e=window.location.pathname||"/";return _e&&e.startsWith(_e)&&(e=e.slice(_e.length)||"/"),e.startsWith("/")||(e="/"+e),e.replace(/\/+$/,"")||"/"}function b(e){if(/^https?:\/\//i.test(e))return e;const[t,a=""]=String(e||"/").split("?"),n=t.startsWith("/")?t:"/"+t;return`${_e}${n}${a?`?${a}`:""}`||"/"}function k(e,t={}){const a=/^https?:\/\//i.test(e)||e.startsWith(_e+"/")||_e===""&&e.startsWith("/")?e:b(e);t.replace?window.history.replaceState({},"",a):window.history.pushState({},"",a),u()}function mr(){return`${Xt()}${window.location.search}`}function ea(e){try{const t=new URL(e,window.location.origin);return t.origin!==window.location.origin?b(d("jobs",{},F())):`${t.pathname}${t.search}`}catch{return b(d("jobs",{},F()))}}function d(e="jobs",t={},a=p()){const n=new URLSearchParams(t);for(const[s,o]of[...n.entries()])(o==null||o==="")&&n.delete(s);return`/company/${encodeURIComponent(h(a||F()))}/${e}${n.toString()?`?${n.toString()}`:""}`}function fr(e){return e.name==="company"?A(e.section):e.name==="command"?"Company Dashboard":e.name==="login"?"Sign in":A(e.name||"Workspace")}function br(e,t){const[a]=t.split("?"),n=a.match(/^\/company\/([^/]+)\/([^/]+)/);return!n||e.name!=="company"?!1:e.companyId===decodeURIComponent(n[1])&&e.section===n[2]}function gr(e){return Ua.includes(e)?e:"pipeline"}function vr(e){return{pipeline:"Pipeline",list:"List",profile:"Profile"}[e]||e}function yr(e){const t=e.companyId||i.activeCompanyId||F(),a=qe();i.activeCompanyId=a.includes(t)?t:a[0]||F(),localStorage.setItem(ne,i.activeCompanyId)}function mi(e){const t=p();e.jobId&&O(t).some(n=>n.id===e.jobId)&&(i.selectedJobId=e.jobId),(!i.selectedJobId||!O(t).some(n=>n.id===i.selectedJobId))&&(i.selectedJobId=O(t)[0]?.id||"");const a=e.params.get("task_id");a&&z(t).some(n=>n.id===a)&&(i.selectedTaskId=a),e.section!=="tasks"&&(i.selectedTaskId=""),i.driveFolder=e.params.get("folder")||"home"}function _r(e){const t=qe(),a=h(e),n=t.includes(a)?a:t[0]||F();i.activeCompanyId=n,localStorage.setItem(ne,n),hr();const s=i.route||ft(),o=s.name==="company"?s.section:"jobs";k(d(o,{},n))}function hr(){i.modal="",i.selectedJobId="",i.selectedTaskId="",i.selectedFileId="",i.selectedFormId="",i.selectedQuestionId="",i.selectedFinanceInvoiceId="",i.selectedFinanceExpenseId="",i.selectedFinanceVendorId="",i.query="",i.fileQuery="",i.formQuery="",i.crmQuery="",i.stageFilter="all",i.crmStageFilter="all",i.crmOwnerFilter="all",i.taskStatusFilter="all",i.taskPriorityFilter="all",i.fileCategoryFilter="All categories",i.formTypeFilter="all",i.formsTab="library",i.driveFolder="home"}function $r(e){const t=D(e);t&&(i.selectedJobId=e,k(d("jobs",{tab:"profile",job_id:e},t.company_id)))}function wr(e){const t=ta(e);t&&(i.selectedTaskId=e,k(d("tasks",{...t.project_id?{job_id:t.project_id}:{},task_id:e},t.company_id)))}function pe(){return D(i.selectedJobId)||O(p())[0]||null}function D(e){return i.jobs.find(t=>t.id===e)||null}function ta(e){return i.tasks.find(t=>t.id===e)||null}function O(e=p()){return i.jobs.filter(t=>t.company_id===e)}function z(e=p()){return i.tasks.filter(t=>t.company_id===e)}function me(e=p()){return i.files.filter(t=>t.company_id===e)}function xe(e=p()){return i.driveFolders.filter(t=>t.company_id===e)}function se(e=p()){return i.teamMembers.filter(t=>Array.isArray(t.company_ids)&&t.company_ids.includes(e))}function Sr(e=p()){const t=new Map;se(e).forEach(n=>{t.set(n.id,{profile_id:"",member_id:n.id,name:n.full_name||n.name,email:n.email,avatar_url:n.avatar_url,role:at(e,n.id).toLowerCase(),role_label:at(e,n.id),role_id:"",status:n.active?"active":"disabled"})}),i.memberships.filter(n=>n.company_id===e).forEach(n=>{const s=fi(n.profile_id),o=n.member_id?i.teamMembers.find(v=>v.id===n.member_id):null,l=i.roleAssignments.find(v=>v.company_id===e&&v.profile_id===n.profile_id),c=l?aa(e,l.role_id):null,m=n.profile_id||n.member_id;t.set(m,{profile_id:n.profile_id,member_id:n.member_id,name:s?.full_name||o?.full_name||s?.email||o?.name||m||"User",email:s?.email||o?.email||"",avatar_url:s?.avatar_url||o?.avatar_url||"",role:n.role,role_label:c?.name||A(n.role),role_id:l?.role_id||Et(e,n.role),status:n.status||"active"})});const a=C().profile;if(i.session?.auth==="supabase"&&a?.id&&!t.has(a.id)){const n=it(e,a.id);n&&t.set(a.id,{profile_id:a.id,member_id:a.member_id||"",name:a.full_name||a.email,email:a.email,avatar_url:a.avatar_url,role:n.role,role_label:A(n.role),role_id:Et(e,n.role),status:n.status||"active"})}return[...t.values()].sort((n,s)=>(n.status==="active"?0:1)-(s.status==="active"?0:1)||n.name.localeCompare(s.name))}function kr(e=p()){return i.companyInvites.filter(t=>t.company_id===e&&t.status==="pending").sort((t,a)=>Date.parse(a.created_at||0)-Date.parse(t.created_at||0))}function fe(e=p()){const t=i.roles.filter(a=>a.company_id===e);return t.length?t.sort((a,n)=>n.priority-a.priority||a.name.localeCompare(n.name)):[he({id:`owner-${e}`,company_id:e,name:"Owner",color:"#f0b23b",priority:1e3,is_system:!0}),he({id:`admin-${e}`,company_id:e,name:"Admin",color:"#60a5fa",priority:800,is_system:!0}),he({id:`staff-${e}`,company_id:e,name:"Staff",color:"#15803d",priority:100,is_system:!0})]}function aa(e,t){return fe(e).find(a=>a.id===t)||null}function Et(e,t){const a=String(t||"").toLowerCase();return fe(e).find(n=>n.name.toLowerCase()===a||n.id.toLowerCase()===a)?.id||""}function jr(e=p()){const t=fe(e).filter(a=>a.name.toLowerCase()!=="owner");return t.find(a=>a.name.toLowerCase()==="staff")?.id||t.find(a=>a.name.toLowerCase()==="member")?.id||t[0]?.id||""}function Dr(e){const t=new URL(b("/login"),window.location.origin);return t.searchParams.set("invite",e.token),t.toString()}function Cr(e){const t=String(e?.name||"").toLowerCase().replace(/\s+/g,"_");return["owner","member","worker","sales","supervisor","admin","developer","construction_supervisor"].includes(t)?t:"member"}function fi(e){return i.profiles.find(t=>t.id===e)||(C().profile.id===e?C().profile:null)}function bi(e=p()){const t=i.query.trim().toLowerCase();return O(e).filter(a=>i.stageFilter!=="all"&&a.stage!==i.stageFilter?!1:t?[a.name,a.client_name,a.contact_name,a.owner_name,a.site_address,a.job_type,j(a.company_id)].some(n=>String(n||"").toLowerCase().includes(t)):!0)}function bt(e=p()){const t=new Map;return O(e).forEach(a=>{const n=String(a.client_name||"").trim()||"Unassigned customer",s=`account-${_a(n.toLowerCase())}`;t.has(s)||t.set(s,{key:s,name:n,jobs:[]}),t.get(s).jobs.push(a)}),Array.from(t.values()).map(a=>{const n=a.jobs.slice().sort((q,H)=>Date.parse(H.updated_at||H.created_at||0)-Date.parse(q.updated_at||q.created_at||0)),s=n[0]||null,o=n.map(q=>q.id),l=z(e).filter(q=>o.includes(q.project_id)),c=oe(e).filter(q=>o.includes(q.linked_job_id)),m=me(e).filter(q=>o.includes(q.job_id)),v=Z(n.map(q=>q.contact_name)),f=Z(n.map(q=>q.owner_name)),y=Z(n.map(q=>q.site_address)),L=n.map(q=>q.priority||"Medium").sort((q,H)=>De(H)-De(q))[0]||"Medium";return{...a,jobs:n,tasks:l,latestJob:s,contacts:v,owners:f,addresses:y,forms:c,files:m,primaryContact:v[0]||"No contact",owner:f[0]||"Unassigned",stage:s?.stage||"Lead",priority:L,estimateTotal:K(n,"estimate_total"),fileCount:m.length,formCount:c.length,updatedAt:s?.updated_at||s?.created_at||new Date().toISOString(),subtitle:y[0]||`${n.length} linked job${n.length===1?"":"s"}`}}).sort((a,n)=>Date.parse(n.updatedAt||0)-Date.parse(a.updatedAt||0))}function qr(e=p()){const t=i.crmQuery.trim().toLowerCase();return bt(e).filter(a=>i.crmStageFilter!=="all"&&!a.jobs.some(n=>n.stage===i.crmStageFilter)||i.crmOwnerFilter!=="all"&&!a.owners.includes(i.crmOwnerFilter)?!1:t?[a.name,a.primaryContact,a.owner,a.stage,...a.addresses,...a.contacts,...a.jobs.map(n=>n.name)].some(n=>String(n||"").toLowerCase().includes(t)):!0)}function Ir(e,t){return bt(e).find(a=>a.key===t)||null}function Fr(e=p()){return Z(O(e).map(t=>t.owner_name)).sort((t,a)=>t.localeCompare(a))}function gi(e=p()){const t=C().profile.member_id||"",a=z(e).slice().sort(xa),n=a.filter(ia),s=n.filter(y=>y.due===S(0)),o=n.filter(y=>Ra(y.due)<0),l=n.filter(y=>{const L=Ra(y.due);return L>=0&&L<=7}),c=n.filter(y=>y.assignee_id===t),m=n.filter(y=>["review","pending"].includes(y.status)),v=a.filter(y=>y.status==="done"),f=Z(o.concat(s,c,m,l).map(y=>y.id)).map(y=>a.find(L=>L.id===y)).filter(Boolean).sort(xa);return{tasks:a,open:n,dueToday:s,overdue:o,thisWeek:l,assignedToMe:c,review:m,done:v,focus:f}}function vi(e=p()){const t=oe(e).filter(s=>(s.require_approval||s.type==="Client approval")&&!["Archived","Closed","Approved"].includes(s.status)).map(s=>({id:`form:${s.id}`,title:s.title,meta:D(s.linked_job_id)?.name||s.description||"Company form",type:"Form approval",owner:B(s.creator_id),status:s.status,updatedAt:s.updated_at||s.created_at,href:d("forms",{form_id:s.id},e)})),a=z(e).filter(s=>["review","pending"].includes(s.status)).map(s=>({id:`task:${s.id}`,title:s.title,meta:D(s.project_id)?.name||s.description||"Company task",type:"Task review",owner:B(s.assignee_id),status:le(s.status),updatedAt:s.updated_at||s.due,href:d("tasks",{...s.project_id?{job_id:s.project_id}:{},task_id:s.id},e)})),n=i.memberships.filter(s=>s.company_id===e&&s.status!=="active").map(s=>({id:`access:${s.profile_id||s.member_id}`,title:B(s.member_id||s.profile_id),meta:`${A(s.role)} access request`,type:"Access request",owner:"Quest admin",status:A(s.status),updatedAt:new Date().toISOString(),href:d("settings",{tab:"access"},e)}));return t.concat(a,n).sort((s,o)=>Date.parse(o.updatedAt||0)-Date.parse(s.updatedAt||0))}function gt(e=p()){const t=i.activeTimer;return!t||t.company_id!==e?null:t}function yi(e=p()){return i.timeEntries.filter(t=>t.company_id===e).sort((t,a)=>Date.parse(a.started_at||0)-Date.parse(t.started_at||0))}function Ma(e=p(),t=0){return yi(e).filter(a=>Date.parse(a.started_at||0)>=t).reduce((a,n)=>a+T(n.duration_ms),0)}function Ar(e=p(),t=""){i.activeTimer&&_i(!1);const a=t?ta(t):null;i.activeTimer={id:`timer-${crypto.randomUUID()}`,company_id:e,user_id:C().profile.member_id||C().profile.id,task_id:a?.company_id===e?a.id:"",task_title:a?.company_id===e?a.title:"",started_at:new Date().toISOString()},Mi(),i.sync={label:"Clock started locally",mode:"local"},u()}function _i(e=!0){const t=i.activeTimer;if(!t)return;const a=new Date().toISOString(),n=Math.max(0,Date.parse(a)-Date.parse(t.started_at||a));i.timeEntries.unshift({id:`time-${crypto.randomUUID()}`,company_id:t.company_id,user_id:t.user_id,task_id:t.task_id||"",task_title:t.task_title||"",started_at:t.started_at,ended_at:a,duration_ms:n,notes:t.task_title?"Task timer":"General shift"}),i.activeTimer=null,Mi(),i.sync={label:"Clock stopped locally",mode:"local"},e&&u()}function ia(e){return e.status!=="done"}function xa(e,t){const a=Date.parse(e.due||0)-Date.parse(t.due||0);return a||De(t.priority)-De(e.priority)}function be(e=p()){return i.financeInvoices.filter(t=>t.company_id===e).sort(Re("updated_at"))}function hi(e=p()){return i.financePayments.filter(t=>t.company_id===e)}function na(e=p()){return i.financeExpenses.filter(t=>t.company_id===e).sort(Re("updated_at"))}function sa(e=p()){return i.financeVendors.filter(t=>t.company_id===e)}function ge(e){return i.financeInvoices.find(t=>t.id===e)||null}function $i(e){return i.financeExpenses.find(t=>t.id===e)||null}function ra(e){return i.financeVendors.find(t=>t.id===e)||null}function Tt(e){return ra(e)?.name||"No vendor"}function wi(e){return i.financePayments.filter(t=>t.invoice_id===e).sort(Re("received_at"))}function oa(e){return K(wi(e),"amount")}function ae(e){const t=ge(e);return Math.max(0,T(t?.total)-oa(e))}function Si(e){const t=ae(e.id);return t<=0&&T(e.total)>0?"Paid":t<T(e.total)?"Partially paid":e.status==="Sent"&&Qi(e.due_date)>0?"Overdue":e.status}function ki(e=p()){const t=be(e),a=hi(e),n=na(e).filter(c=>["Approved","Paid"].includes(c.status)),s={current:0,thirty:0,sixty:0,overSixty:0};t.forEach(c=>{const m=ae(c.id);if(!m)return;const v=Qi(c.due_date);v<=0?s.current+=m:v<=30?s.thirty+=m:v<=60?s.sixty+=m:s.overSixty+=m});const o=K(a,"amount"),l=K(n,"amount");return{pipeline:K(O(e),"estimate_total"),invoiced:K(t,"total"),collected:o,outstanding:t.reduce((c,m)=>c+ae(m.id),0),expenses:l,net:o-l,aging:s}}function Mr(e=p(),t=""){const a=i.query.trim().toLowerCase();return z(e).filter(n=>t&&n.project_id!==t||i.taskStatusFilter!=="all"&&n.status!==i.taskStatusFilter||i.taskPriorityFilter!=="all"&&n.priority!==i.taskPriorityFilter?!1:a?[n.title,n.description,He(n.type),B(n.assignee_id),D(n.project_id)?.name].some(s=>String(s||"").toLowerCase().includes(a)):!0)}function ji(){const e=qe();return i.companies.filter(t=>e.includes(t.id))}function la(e,t=p()){if(!e)return!0;const a=C().profile;if(i.session?.auth==="supabase"){const o=it(t,a.id);if(!o||o.status!=="active")return!1;if(["owner","developer"].includes(String(o.role).toLowerCase()))return!0;const l=i.roleAssignments.filter(m=>m.company_id===t&&m.profile_id===a.id).map(m=>m.role_id),c=i.rolePermissions.filter(m=>l.includes(m.role_id));if(c.some(m=>(m.permission_key===e||m.permission_key==="*")&&m.effect==="deny"))return!1;if(c.some(m=>(m.permission_key===e||m.permission_key==="*")&&m.effect==="allow"))return!0}const n=String(it(t,a.id)?.role||a.role||"member").toLowerCase(),s=$a[n]||$a.member;return s.includes("*")||s.includes(e)}function qe(){const e=C().profile,t=i.companies.map(s=>s.id);if(i.session?.auth==="supabase"){const s=i.memberships.filter(o=>o.profile_id===e.id&&o.status==="active").map(o=>h(o.company_id));return Z(s).filter(o=>t.includes(o))}if(["developer","admin"].includes(e.role))return Z(t.length?t:Qe.map(s=>h(s.id)));const a=i.memberships.filter(s=>s.profile_id===e.id&&s.status!=="disabled").map(s=>h(s.company_id)),n=a.length?a:e.company_ids||[];return Z(n.map(h)).filter(s=>t.includes(s))}function p(){const e=qe();return e.includes(i.activeCompanyId)?i.activeCompanyId:e[0]||i.activeCompanyId||F()}function F(){return h(Qe[0].id)}function vt(e){const t=h(e);return i.companies.find(a=>a.id===t)||Qe.map(Ve).find(a=>a.id===t)||null}function j(e){const t=vt(e);return t?yt(t):e||"Company"}function yt(e){return e.short_name||e.label||e.name||e.id}function re(e){return vt(e)?.color||"#f0b23b"}function Ze(e){return h(i.jobs.find(t=>t.id===e)?.company_id||"")}function _t(e){const t=C().profile;return i.session?.auth!=="supabase"&&["developer","admin"].includes(t.role)?A(t.role):A(it(e,t.id)?.role||t.role||"member")}function at(e,t){const a=i.memberships.find(n=>n.company_id===e&&(n.member_id===t||n.profile_id===t));return A(a?.role||"member")}function it(e,t){return i.memberships.find(a=>a.company_id===e&&a.profile_id===t)||null}function ca(e=p()){return i.subscriptions.find(t=>t.company_id===e)||null}function da(e=p()){if(i.session?.auth!=="supabase")return!0;const t=ca(e);return!!(!t||["trialing","active","past_due","grace"].includes(t.status)||t.grace_ends_at&&Date.parse(t.grace_ends_at)>Date.now())}function Di(e=p()){const t=ca(e);return t?t.status==="trialing"?`Trial - ${M(t.trial_ends_at)}`:t.status==="active"?"Active subscription":t.status==="past_due"?"Past due grace":t.status==="grace"?`Grace - ${M(t.grace_ends_at)}`:A(t.status):i.session?.auth==="supabase"?"Trial pending":"Demo mode"}function B(e){const t=i.teamMembers.find(a=>a.id===e);return t?.full_name||t?.name||e||"Unassigned"}function ht(e){return i.tasks.filter(t=>t.project_id===e).length}function nt(e){return i.files.filter(t=>t.job_id===e).length}function h(e){return{"quest-roofing":"roofing","quest-drafting":"drafting"}[String(e||"").trim()]||String(e||"").trim()}function Ci(e){const t=new Map;return e.map(Ve).forEach(a=>{!a.id||t.has(a.id)||t.set(a.id,a)}),Array.from(t.values())}function Ve(e){return{id:h(e.id||""),name:String(e.name||e.short_name||e.id||"").trim(),short_name:String(e.short_name||e.label||e.name||e.id||"").trim(),color:String(e.color||"#f0b23b"),label:String(e.label||e.short_name||e.name||e.id||"").trim()}}function ke(e){return{id:String(e.id||""),company_id:h(e.company_id||F()),name:String(e.name||"").trim()||"Untitled Job",client_name:String(e.client_name||"").trim(),contact_name:String(e.contact_name||"").trim(),site_address:String(e.site_address||"").trim(),job_type:String(e.job_type||"Roofing").trim(),stage:Pe.includes(e.stage)?e.stage:"Lead",priority:["Low","Medium","High","Urgent"].includes(e.priority)?e.priority:"Medium",owner_name:String(e.owner_name||"").trim(),scope:String(e.scope||"").trim(),notes:String(e.notes||"").trim(),estimate_total:T(e.estimate_total),invoice_total:T(e.invoice_total),task_count:T(e.task_count),file_count:T(e.file_count),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||new Date().toISOString()}}function je(e){const t=Xe.includes(String(e.priority||"").toLowerCase())?String(e.priority).toLowerCase():"medium",a=Le.includes(String(e.status||"").toLowerCase())?String(e.status).toLowerCase():"todo";return{id:String(e.id||""),title:String(e.title||"").trim()||"Untitled task",description:String(e.description||"").trim(),type:Qa.includes(e.type)?e.type:"admin",label:e.label||null,bid_status:e.bid_status||null,company_id:h(e.company_id||F()),creator_id:String(e.creator_id||"abraham"),assignee_id:String(e.assignee_id||e.creator_id||"abraham"),project_id:String(e.project_id||""),due:String(e.due||S(1)).slice(0,10),due_time:e.due_time||null,reminder_at:e.reminder_at||null,priority:t,urgency:Xe.includes(String(e.urgency||"").toLowerCase())?String(e.urgency).toLowerCase():t,status:a,watchers:Array.isArray(e.watchers)?e.watchers:[],subtasks:Array.isArray(e.subtasks)?e.subtasks:[],activity:Array.isArray(e.activity)?e.activity:[],cleared_at:e.cleared_at||null,created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||new Date().toISOString()}}function Ee(e){const t=String(e.category||e.folder||"Shared");return{id:String(e.id||crypto.randomUUID()),company_id:h(e.company_id||F()),job_id:String(e.job_id||""),folder:String(e.folder||$o(t)),file_name:String(e.file_name||e.name||"Untitled file"),mime_type:String(e.mime_type||"application/octet-stream"),size_bytes:T(e.size_bytes),category:t,bucket_id:e.bucket_id||"quest-job-files",object_path:e.object_path||"",uploaded_by_label:String(e.uploaded_by_label||"Quest HQ"),notes:String(e.notes||""),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function ua(e){return{id:String(e.id||`folder-${crypto.randomUUID()}`),company_id:h(e.company_id||F()),name:String(e.name||"New folder").trim()||"New folder",parent_key:String(e.parent_key||"home"),created_by_label:String(e.created_by_label||"Quest HQ"),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function Je(e){const t=Array.isArray(e.questions)?e.questions.map($t):[],a=Ne.includes(e.type)?e.type:"Internal",n=Kt.includes(e.status)?e.status:"Draft";return{id:String(e.id||`form-${crypto.randomUUID()}`),company_id:h(e.company_id||F()),title:String(e.title||"Untitled form").trim()||"Untitled form",description:String(e.description||"").trim(),type:a,status:n,audience:String(e.audience||"Internal").trim(),creator_id:String(e.creator_id||e.created_by||e.created_by_id||""),linked_job_id:String(e.linked_job_id||e.job_id||""),theme_color:String(e.theme_color||"#f0b23b"),background:String(e.background||"clean"),submit_label:String(e.submit_label||"Submit").trim()||"Submit",collect_email:e.collect_email!==!1,require_approval:e.require_approval===!0,questions:t,created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function $t(e){const t=Ue.some(([n])=>n===e.type)?e.type:"short",a={id:String(e.id||`q-${crypto.randomUUID()}`),type:t,label:String(e.label||"Untitled question").trim()||"Untitled question",help:String(e.help||"").trim(),required:e.required===!0,options:Array.isArray(e.options)?e.options.map(n=>String(n||"").trim()).filter(Boolean):[]};return Oe(a)&&!a.options.length&&(a.options=["Option 1","Option 2"]),a}function pa(e){return{id:String(e.id||`response-${crypto.randomUUID()}`),company_id:h(e.company_id||F()),form_id:String(e.form_id||e.formId||""),submitted_by:String(e.submitted_by||e.submitter_email||"Anonymous"),submitter_email:String(e.submitter_email||""),answers:e.answers&&typeof e.answers=="object"?e.answers:{},created_at:e.created_at||new Date().toISOString()}}function wt(e){const t=T(e.subtotal),a=T(e.tax),n=T(e.total)||t+a;return{id:String(e.id||`invoice-${crypto.randomUUID()}`),company_id:h(e.company_id||F()),job_id:String(e.job_id||""),client_name:String(e.client_name||"").trim(),invoice_number:String(e.invoice_number||`INV-${Date.now()}`).trim(),status:Va.includes(e.status)?e.status:"Draft",issue_date:String(e.issue_date||S(0)).slice(0,10),due_date:String(e.due_date||S(30)).slice(0,10),subtotal:t,tax:a,total:n,notes:String(e.notes||"").trim(),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function St(e){return{id:String(e.id||`payment-${crypto.randomUUID()}`),company_id:h(e.company_id||F()),invoice_id:String(e.invoice_id||""),amount:T(e.amount),method:Ha.includes(e.method)?e.method:"ACH",received_at:String(e.received_at||S(0)).slice(0,10),reference:String(e.reference||"").trim(),notes:String(e.notes||"").trim(),created_at:e.created_at||new Date().toISOString()}}function kt(e){return{id:String(e.id||`expense-${crypto.randomUUID()}`),company_id:h(e.company_id||F()),job_id:String(e.job_id||""),vendor_id:String(e.vendor_id||""),category:pt.includes(e.category)?e.category:"Other",amount:T(e.amount),status:Ja.includes(e.status)?e.status:"Pending",spent_at:String(e.spent_at||S(0)).slice(0,10),notes:String(e.notes||"").trim(),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function jt(e){return{id:String(e.id||`vendor-${crypto.randomUUID()}`),company_id:h(e.company_id||F()),name:String(e.name||"New vendor").trim()||"New vendor",contact_name:String(e.contact_name||"").trim(),email:String(e.email||"").trim(),phone:String(e.phone||"").trim(),category:pt.includes(e.category)?e.category:"Other",status:Ba.includes(e.status)?e.status:"Active",notes:String(e.notes||"").trim(),created_at:e.created_at||new Date().toISOString(),updated_at:e.updated_at||e.created_at||new Date().toISOString()}}function ma(e){return{id:String(e.id||""),name:String(e.name||e.full_name||"").trim(),full_name:String(e.full_name||e.name||"").trim(),email:String(e.email||"").trim(),color:String(e.color||"#f0b23b"),avatar_url:String(e.avatar_url||""),active:e.active!==!1,supervisor_id:String(e.supervisor_id||e.manager_id||""),company_ids:Array.isArray(e.company_ids)?Z(e.company_ids.map(h)):[]}}function st(e){return{company_id:h(e.company_id||""),profile_id:String(e.profile_id||e.member_id||""),member_id:e.member_id?String(e.member_id):"",role:String(e.role||"member"),status:String(e.status||"active")}}function xr(e){return{company_id:h(e.company_id||""),status:String(e.status||"trialing"),plan_code:String(e.plan_code||"quest_company_300"),amount_cents:T(e.amount_cents||3e4),currency:String(e.currency||"usd"),stripe_customer_id:String(e.stripe_customer_id||""),stripe_subscription_id:String(e.stripe_subscription_id||""),current_period_end:e.current_period_end||"",trial_ends_at:e.trial_ends_at||"",grace_ends_at:e.grace_ends_at||""}}function he(e){return{id:String(e.id||""),company_id:h(e.company_id||""),name:String(e.name||"Role").trim()||"Role",color:String(e.color||"#f0b23b"),priority:T(e.priority),is_system:e.is_system===!0,created_by:String(e.created_by||"")}}function Ot(e){return{role_id:String(e.role_id||""),permission_key:String(e.permission_key||""),effect:String(e.effect||"allow")==="deny"?"deny":"allow"}}function qi(e){return{company_id:h(e.company_id||""),profile_id:String(e.profile_id||""),role_id:String(e.role_id||""),assigned_by:String(e.assigned_by||"")}}function Er(e){return{id:String(e.id||""),company_id:h(e.company_id||""),resource_type:String(e.resource_type||""),resource_id:String(e.resource_id||""),principal_type:String(e.principal_type||""),principal_id:String(e.principal_id||""),permission_key:String(e.permission_key||""),effect:String(e.effect||"allow")==="deny"?"deny":"allow"}}function Tr(e){return{id:String(e.id||""),company_id:h(e.company_id||""),resource_type:String(e.resource_type||""),field_key:String(e.field_key||""),role_id:String(e.role_id||""),visibility:["visible","masked","hidden"].includes(e.visibility)?e.visibility:"visible",editable:e.editable!==!1}}function rt(e){return{id:String(e.id||""),company_id:h(e.company_id||""),email:String(e.email||""),role_id:String(e.role_id||""),token:String(e.token||""),status:String(e.status||"pending"),expires_at:e.expires_at||"",invited_by:String(e.invited_by||""),accepted_by:String(e.accepted_by||""),created_at:e.created_at||""}}function Ii(e){return{id:String(e.id||""),company_id:h(e.company_id||""),profile_id:String(e.profile_id||""),requested_email:String(e.requested_email||""),status:String(e.status||"pending"),message:String(e.message||""),reviewed_by:String(e.reviewed_by||""),created_at:e.created_at||""}}function Or(e=p()){return ke({id:"",company_id:e,name:"",stage:"Lead",priority:"Medium",job_type:"Roofing"})}function Rr(e=p(),t=""){return je({id:"",title:"",company_id:e,project_id:t,assignee_id:se(e)[0]?.id||"abraham",creator_id:C().profile.member_id||"abraham",due:S(1),priority:"medium",status:"todo",type:"admin"})}function Pr(e=p()){const t=pe();return wt({id:"",company_id:e,job_id:t?.company_id===e?t.id:"",client_name:t?.company_id===e?t.client_name:"",invoice_number:wo(e),status:"Draft",issue_date:S(0),due_date:S(30),subtotal:t?.company_id===e?t.estimate_total:0,tax:0,notes:""})}function Lr(e=p(),t=""){const a=t?ge(t):be(e).find(s=>ae(s.id)>0),n=a?.company_id===e?a:null;return St({id:"",company_id:e,invoice_id:n?.id||"",amount:n?ae(n.id):0,method:"ACH",received_at:S(0),reference:"",notes:""})}function Nr(e=p(),t=""){return kt({id:"",company_id:e,job_id:pe()?.company_id===e?pe().id:"",vendor_id:t||sa(e)[0]?.id||"",category:"Materials",status:"Pending",amount:0,spent_at:S(0),notes:""})}function Ur(e=p()){return jt({id:"",company_id:e,name:"",category:"Materials",status:"Active"})}function Qr(e){return{id:e.id,title:e.title,description:e.description,type:e.type,label:e.label,bid_status:e.bid_status,company_id:e.company_id,creator_id:e.creator_id,assignee_id:e.assignee_id,project_id:e.project_id||null,due:e.due,due_time:e.due_time,reminder_at:e.reminder_at,priority:e.priority,urgency:e.urgency,status:e.status,watchers:e.watchers,subtasks:e.subtasks,activity:e.activity,cleared_at:e.cleared_at}}function Vr(e){return{company_id:e.company_id,job_id:e.job_id||null,bucket_id:e.bucket_id,object_path:e.object_path,file_name:e.file_name,mime_type:e.mime_type,size_bytes:e.size_bytes,category:e.category,folder:e.folder,uploaded_by_label:e.uploaded_by_label,notes:e.notes}}function C(){return i.session?i.session.auth==="supabase"?i.session:{...i.session,profile:{...Rt().profile,...i.session.profile||{},...i.profileDraft||{}}}:Rt()}function Jr(e,t){return{auth:"supabase",access_token:e.access_token,refresh_token:e.refresh_token,user:{id:e.user.id,email:e.user.email||""},profile:fa(t||{},{id:e.user.id,email:e.user.email||"",full_name:e.user.user_metadata?.full_name||e.user.email||"Quest user",role:"member",member_id:"",company_ids:[],avatar_url:""})}}function Rt(){const e={id:"basic-quest-user",email:"lumen123@quest-hq.local",full_name:"Quest Basic Mode",role:"developer",role_label:"Developer",member_id:"abraham",company_ids:["roofing","drafting","lumen"],avatar_url:"",...i.profileDraft||{}};return{auth:"local-basic",user:{id:e.id,username:we.localUsername,email:e.email},profile:e}}function fa(e,t={}){const a=String(e.role||t.role||"member").toLowerCase();return{id:String(e.id||t.id||""),email:String(e.email||t.email||""),full_name:String(e.full_name||t.full_name||e.email||t.email||"Quest user"),role:a,role_label:A(a),member_id:String(e.member_id||t.member_id||""),company_ids:Array.isArray(e.company_ids)?Z(e.company_ids.map(h)):t.company_ids||[],avatar_url:String(e.avatar_url||t.avatar_url||""),approved:e.approved!==!1,supervisor_id:String(e.supervisor_id||t.supervisor_id||"")}}function V(e,t,a=""){const n=si();return`
    <section class="workspace-head">
      <div class="head-copy">
        <span class="head-symbol">${G(n)}</span>
        <div>
          <div class="context-line"><span>${r(j(p()))}</span><b>${r(_t(p()))}</b></div>
          <h1>${r(e)}</h1>
          <p>${r(t)}</p>
        </div>
      </div>
  ...
  `}function Br(e){return`<section class="metric-grid">${e.map(([t,a])=>`<article class="metric">${G(ri(t),"metric-symbol")}<span>${r(t)}</span><strong>${r(a)}</strong></article>`).join("")}</section>`}function Hr(e){return`
  ...
  `}function N(e){return`<div class="contract-rows">${e.map(([t,a])=>`<div><span>${r(t)}</span><strong>${r(a)}</strong></div>`).join("")}</div>`}function w(e,t,a="",n=!1,s="text",o=""){return`<label class="${r(o)}"><span>${r(e)}</span><input name="${r(t)}" type="${r(s)}" value="${r(a)}" ${n?"required":""} /></label>`}function ie(e,t,a="",n=""){return`<label class="${r(n)}"><span>${r(e)}</span><textarea name="${r(t)}" rows="4">${r(a)}</textarea></label>`}function R(e,t,a,n){return`
    <label><span>${r(e)}</span><select name="${r(t)}">
      ${n.map(([s,o])=>`<option value="${r(s)}" ${String(s)===String(a)?"selected":""}>${r(o)}</option>`).join("")}
    </select></label>
  `}function ba(e){return`<span class="priority ${r(String(e).toLowerCase())}">${r(e)}</span>`}function Fi(e){return`<span class="priority ${r(e)}">${r(A(e))}</span>`}function Ai(e){return`<span class="status-pill ${r(e)}">${r(le(e))}</span>`}function Wr(e){return`<span class="finance-status ${r(_a(e))}">${r(e)}</span>`}function Be(e,t){if(e.avatar_url)return`<span class="${r(t)}"><img src="${r(e.avatar_url)}" alt="" /></span>`;const a=String(e.full_name||e.email||"QB").trim().split(/\s+/).map(n=>n[0]).join("").slice(0,2).toUpperCase()||"QB";return`<span class="${r(t)}">${r(a)}</span>`}function g(e){return`<div class="empty-state">${G("q-empty","empty-symbol")}<span>${r(e)}</span></div>`}function Y(e,t){const a={};return t.forEach(n=>{const s=e.get(n);s&&(a[n]=s)}),a}function Q(){i.session?.auth!=="supabase"&&(x(Lt,i.jobs),x(Nt,i.tasks),x(Ut,i.files),x(Qt,i.driveFolders),x(Ce,i.forms),x(lt,i.formResponses),x(Bt,i.financeInvoices),x(Ht,i.financePayments),x(zt,i.financeExpenses),x(Wt,i.financeVendors),x(ct,i.timeEntries),x(dt,i.activeTimer),x(Vt,i.teamMembers),x(Jt,i.memberships))}function Mi(){i.session?.auth!=="supabase"&&(x(ct,i.timeEntries),x(dt,i.activeTimer))}function $(e,t,a=""){return`<article class="metric">${G(ri(e),"metric-symbol")}<span>${r(e)}</span><strong>${r(t)}</strong>${a?`<small>${r(a)}</small>`:""}</article>`}function de(e,t){return`<div><strong>${r(e)}</strong><span>${r(t)}</span></div>`}function $e(e,t,a,n,s=""){const o=`
    <span><strong>${r(e)}</strong><small>${r(t||"Finance record")}</small></span>
    <b>${r(a)}</b>
    <em>${M(n)}</em>
  `;return s?`<a class="finance-compact-row" href="${b(s)}" data-router>${o}</a>`:`<div class="finance-compact-row">${o}</div>`}function Ea(e,t){const a=me(e);return t==="jobs"?a.filter(n=>n.job_id).length:a.filter(n=>n.folder===t).length}function xi(e="home",t=null){return t?.id?`job:${t.id}`:e||"home"}function Yr(e,t="home",a=null){const n=xi(t,a),s=xe(e).filter(o=>o.parent_key===n).map(o=>Kr(e,o));return a?s:t==="home"?Yt.map(([l,c,m,v])=>({id:l,name:c,caption:m,icon:v,href:b(d("files",{folder:l},e)),countLabel:`${Ea(e,l)} file${Ea(e,l)===1?"":"s"}`,updatedLabel:""})).concat(s):t==="jobs"?O(e).map(l=>({id:`job:${l.id}`,name:l.name,caption:l.client_name||j(e),icon:"ti-folder",href:b(d("files",{folder:"jobs",job_id:l.id},e)),countLabel:`${nt(l.id)} file${nt(l.id)===1?"":"s"}`,updatedLabel:M(l.updated_at)})).concat(s):s}function Kr(e,t){const a=xe(e).filter(o=>o.parent_key===t.id).length,n=me(e).filter(o=>o.folder===t.id).length,s=a+n;return{id:t.id,name:t.name,caption:"Custom folder",icon:"ti-folder",href:b(d("files",{folder:t.id},e)),countLabel:`${s} item${s===1?"":"s"}`,updatedLabel:M(t.updated_at)}}function Gr(e,t,a=null){if(a)return`<span>/</span><a href="${b(d("files",{folder:"jobs"},e))}" data-router>Jobs</a>`;const n=xe(e).find(m=>m.id===t);if(!n)return`<span>/</span><strong>${r(ee(t))}</strong>`;const s=[];let o=n;const l=new Set;for(;o&&!l.has(o.id);)l.add(o.id),s.unshift(o),o=xe(e).find(m=>m.id===o.parent_key);return`${n.parent_key&&!n.parent_key.startsWith("folder-")&&n.parent_key!=="home"?`<span>/</span><a href="${b(d("files",{folder:n.parent_key},e))}" data-router>${r(ee(n.parent_key))}</a>`:""}${s.map((m,v)=>`<span>/</span>${v===s.length-1?`<strong>${r(m.name)}</strong>`:`<a href="${b(d("files",{folder:m.id},e))}" data-router>${r(m.name)}</a>`}`).join("")}`}function Zr(e=p(),t="home",a=""){const n=(i.fileQuery||i.query||"").trim().toLowerCase(),s=i.fileCategoryFilter;let o=me(e);return a?o=o.filter(l=>l.job_id===a):t&&t!=="home"&&(t==="jobs"?o=o.filter(l=>l.job_id):o=o.filter(l=>l.folder===t)),s&&s!=="All categories"&&(o=o.filter(l=>String(l.category||ee(l.folder)).toLowerCase()===s.toLowerCase())),n&&(o=o.filter(l=>[l.file_name,l.category,l.uploaded_by_label,l.notes,l.object_path,D(l.job_id)?.name].some(c=>String(c||"").toLowerCase().includes(n)))),o.sort((l,c)=>new Date(c.created_at||0)-new Date(l.created_at||0))}function ve(e){const t=String(e.mime_type||"").toLowerCase(),a=Ei(e);return t.includes("pdf")||a==="pdf"?"PDF":t.includes("image")||["png","jpg","jpeg","gif","webp","svg"].includes(a)?"Image":t.includes("zip")||["zip","rar","7z"].includes(a)?"Archive":t.includes("spreadsheet")||t.includes("excel")||["xls","xlsx","csv"].includes(a)?"Excel":t.includes("word")||["doc","docx"].includes(a)?"Word":t.includes("text")||["txt","md","json","csv","log"].includes(a)?"Text":t.includes("presentation")||["ppt","pptx"].includes(a)?"PowerPoint":a?a.toUpperCase():ee(e.folder)}function ga(e){const t=ve(e).toLowerCase();return t==="pdf"?"pdf":t==="image"?"image":t==="excel"?"sheet":t==="text"?"text":["word","powerpoint"].includes(t)?"doc":t==="archive"?"zip":"doc"}function Ei(e){return String(e.file_name||"").split(".").pop()?.toLowerCase()||""}function va(e,t=!1){const a=Ui(e);return e.signed_url?`<img src="${r(e.signed_url)}" alt="" />`:`<span class="file-doc-icon ${r(ga(e))} ${t?"large":""}"><i class="ti ${r(a)}"></i></span>`}function Xr(e){const t=ve(e),a=Ei(e);return t==="Image"?a&&a.length<=4?a.toUpperCase():"IMG":t==="Archive"?a&&a.length<=3?a.toUpperCase():"ZIP":t==="Excel"?a==="csv"?"CSV":"XLS":t==="Word"?"DOC":t==="PowerPoint"?"PPT":t==="Text"?a&&a.length<=4?a.toUpperCase():"TXT":t.length<=4?t.toUpperCase():(a||"FILE").slice(0,4).toUpperCase()}function oe(e=p()){return i.forms.filter(t=>t.company_id===e)}function eo(e=p()){const t=i.formQuery.trim().toLowerCase(),a=i.route?.jobId||"";return oe(e).filter(n=>a&&n.linked_job_id!==a||i.formTypeFilter!=="all"&&n.type!==i.formTypeFilter?!1:t?[n.title,n.description,n.type,n.status,n.audience,D(n.linked_job_id)?.name].some(s=>String(s||"").toLowerCase().includes(t)):!0)}function Te(e=p()){const t=i.route?.jobId||"",a=oe(e).filter(o=>!t||o.linked_job_id===t),n=i.route?.params?.get("form_id")||"";if(n&&a.some(o=>o.id===n)&&(i.selectedFormId=n),!a.length)return i.selectedFormId="",i.selectedQuestionId="",null;let s=a.find(o=>o.id===i.selectedFormId)||a[0];return i.selectedFormId=s.id,(!i.selectedQuestionId||!s.questions.some(o=>o.id===i.selectedQuestionId))&&(i.selectedQuestionId=s.questions[0]?.id||""),s}function ye(e){return i.forms.find(t=>t.id===e)||null}function te(){return ye(i.selectedFormId)||Te(p())}function Ti(e=p()){return i.formResponses.filter(t=>t.company_id===e)}function Ct(e){return i.formResponses.filter(t=>t.form_id===e)}function Oi(e){return Array.isArray(e?.questions)?e.questions.length:0}function to(e){const t=String(e?.creator_id||""),a=C().profile;return t?t&&(t===a.member_id||t===a.id)?a.full_name||"Quest Basic Mode":B(t):e?.created_by_label||a.full_name||"Quest HQ"}function Fe(e,t,a="",n=!1,s="text"){return`<label><span>${r(e)}</span><input data-form-field="${r(t)}" type="${r(s)}" value="${r(a)}" ${n?"required":""} /></label>`}function Ri(e,t,a=""){return`<label><span>${r(e)}</span><textarea data-form-field="${r(t)}" rows="3">${r(a)}</textarea></label>`}function Ye(e,t,a,n){return`
    <label><span>${r(e)}</span><select data-form-field="${r(t)}">
      ${n.map(([s,o])=>`<option value="${r(s)}" ${String(s)===String(a)?"selected":""}>${r(o)}</option>`).join("")}
    </select></label>
  `}function Oe(e){return["multiple","checkbox","dropdown"].includes(e.type)}function ao(e){return{short:"ti-letter-t",paragraph:"ti-align-left",multiple:"ti-circle-dot",checkbox:"ti-checkbox",dropdown:"ti-select",date:"ti-calendar",rating:"ti-star",yesno:"ti-circle-check",file:"ti-paperclip"}[e]||"ti-plus"}function io(e){return Ue.find(([t])=>t===e)?.[1]||A(e||"Question")}function X(e,t){return`
  ...
  `}function Pi(e){const t=ye(e.form_id),a=Object.entries(e.answers||{}).map(([n,s])=>{const o=t?.questions.find(c=>c.id===n),l=Array.isArray(s)?s.join(", "):s;return de(o?.label||n,l||"No answer")}).join("");return`
  ...
  `}function Ae(){return[{id:"roof-inspection",title:"Roof Inspection",description:"Leak source, condition, photo handoff, and recommended repair scope.",type:"Inspection",questions:[U("short","Inspection address"),U("multiple","Primary finding",["Active leak","Damaged flashing","Storm damage","Maintenance"]),U("paragraph","Recommended scope"),U("file","Photos")]},{id:"client-approval",title:"Client Approval",description:"Approval, client notes, signature follow-up, and change request capture.",type:"Client approval",questions:[U("short","Client name"),U("yesno","Approved to proceed?"),U("paragraph","Requested changes")]},{id:"service-intake",title:"Service Intake",description:"New request triage for company-level or job-linked work.",type:"Intake",questions:[U("short","Request title"),U("dropdown","Priority",["Low","Medium","High","Urgent"]),U("paragraph","Details")]},{id:"safety-check",title:"Safety Checklist",description:"Crew safety confirmation before field work starts.",type:"Safety",questions:[U("checkbox","PPE confirmed",["Harness","Ladder","Gloves","Eye protection"]),U("yesno","Weather safe?"),U("paragraph","Safety notes")]}]}function no(e=p()){return Je({id:`form-${crypto.randomUUID()}`,company_id:e,title:"Untitled form",description:"",type:"Internal",status:"Draft",audience:"Internal",linked_job_id:i.route?.jobId||"",theme_color:re(e),background:"clean",submit_label:"Submit",collect_email:!0,require_approval:!1,questions:[U("short","First question")]})}function U(e="short",t="Untitled question",a=[]){return $t({id:`q-${crypto.randomUUID()}`,type:e,label:t,required:!1,options:a})}function so(e,t={}){const a=no(e),n=Je({...a,...t,id:t.id||`form-${crypto.randomUUID()}`,company_id:e,questions:(t.questions||a.questions).map(s=>$t(s)),created_at:t.created_at||new Date().toISOString(),updated_at:new Date().toISOString()});return i.forms.unshift(n),i.selectedFormId=n.id,i.selectedQuestionId=n.questions[0]?.id||"",i.formsTab="builder",i.formEditorTab="questions",i.modal="",i.formStartTemplateId="",i.formStartTab="blank",J("New form created"),u(),n}function ro(e){const t=Object.fromEntries(new FormData(e).entries()),a=t.template_id?Ae().find(l=>l.id===t.template_id):null,n=String(t.title||a?.title||"Untitled form").trim()||"Untitled form",s=String(t.description||a?.description||"").trim(),o=a?a.questions.map(l=>({...ot(l),id:`q-${crypto.randomUUID()}`})):[U("short","First question")];so(p(),{title:n,description:s,type:Ne.includes(t.type)?t.type:a?.type||"Internal",audience:String(t.audience||"Internal").trim()||"Internal",creator_id:C().profile.member_id||C().profile.id||"basic-quest-user",linked_job_id:String(t.linked_job_id||""),theme_color:re(p()),background:"clean",submit_label:String(t.submit_label||"Submit").trim()||"Submit",collect_email:t.collect_email==="on",require_approval:t.require_approval==="on",questions:o})}function Ke(e,t=!0){const a=ye(e);a&&(i.selectedFormId=a.id,i.selectedQuestionId=a.questions[0]?.id||"",t&&u())}function J(e="Forms saved locally"){const t=te();t&&(t.updated_at=new Date().toISOString()),x(Ce,i.forms),x(lt,i.formResponses),i.sync={label:e,mode:"live"}}function Ta(e,t){const a=ye(e||i.selectedFormId);a&&(a.status=Kt.includes(t)?t:"Draft",i.selectedFormId=a.id,J(`${a.status} locally`),u())}function oo(e){const t=ye(e||i.selectedFormId);if(!t)return;const a=Je({...ot(t),id:`form-${crypto.randomUUID()}`,title:`${t.title} Copy`,status:"Draft",questions:t.questions.map(n=>({...ot(n),id:`q-${crypto.randomUUID()}`})),created_at:new Date().toISOString(),updated_at:new Date().toISOString()});i.forms.unshift(a),i.selectedFormId=a.id,i.selectedQuestionId=a.questions[0]?.id||"",J("Form duplicated"),u()}function lo(e){const t=e||i.selectedFormId;t&&(i.forms=i.forms.filter(a=>a.id!==t),i.formResponses=i.formResponses.filter(a=>a.form_id!==t),i.selectedFormId=oe(p())[0]?.id||"",i.selectedQuestionId=Te(p())?.questions[0]?.id||"",i.modal="",J("Form deleted locally"),u())}async function co(e){const t=e||i.selectedFormId,a=`${window.location.origin}${b(d("forms",{form_id:t},p()))}`;try{await navigator.clipboard.writeText(a),i.sync={label:"Form link copied",mode:"live"}}catch{i.sync={label:"Copy failed",mode:"local"}}u()}function uo(e){const t=JSON.stringify({company_id:e,forms:oe(e),responses:Ti(e)},null,2);_o(`${e}-forms-export.json`,t,"application/json")}function Li(e){const t=te();if(!t)return;const a=e.dataset.formField;a&&(t[a]=e.type==="checkbox"?e.checked:e.value,t.updated_at=new Date().toISOString(),x(Ce,i.forms))}function Ni(e){const t=te(),a=e.closest("[data-question-id]"),n=t?.questions.find(s=>s.id===a?.dataset.questionId);if(!(!t||!n)){if(i.selectedQuestionId=n.id,e.matches("[data-question-option]")){const s=Number(e.dataset.questionOption);n.options[s]=e.value}else{const s=e.dataset.questionField;if(s==="required")n.required=e.checked;else if(s==="type"){n.type=e.value,Oe(n)&&!n.options.length&&(n.options=["Option 1","Option 2"]),Oe(n)||(n.options=[]),J("Question updated"),u();return}else s&&(n[s]=e.value)}t.updated_at=new Date().toISOString(),x(Ce,i.forms)}}function po(e="multiple"){const t=te();if(!t)return;const a=U(e,Ue.find(([n])=>n===e)?.[1]||"New question");t.questions.push(a),i.selectedQuestionId=a.id,J("Question added"),u()}function mo(e){const t=te(),a=t?.questions.find(o=>o.id===e);if(!t||!a)return;const n=t.questions.findIndex(o=>o.id===e),s=$t({...ot(a),id:`q-${crypto.randomUUID()}`,label:`${a.label} Copy`});t.questions.splice(n+1,0,s),i.selectedQuestionId=s.id,J("Question duplicated"),u()}function fo(e){const t=te();t&&(t.questions=t.questions.filter(a=>a.id!==e),i.selectedQuestionId=t.questions[0]?.id||"",J("Question deleted"),u())}function bo(e,t){const a=te();if(!a||!t)return;const n=a.questions.findIndex(l=>l.id===e),s=n+t;if(n<0||s<0||s>=a.questions.length)return;const[o]=a.questions.splice(n,1);a.questions.splice(s,0,o),i.selectedQuestionId=e,J("Question moved"),u()}function go(e){const a=te()?.questions.find(n=>n.id===e);a&&(a.options=a.options||[],a.options.push(`Option ${a.options.length+1}`),J("Option added"),u())}function vo(e,t){const n=te()?.questions.find(s=>s.id===e);!n||t<0||(n.options.splice(t,1),n.options.length||n.options.push("Option 1"),J("Option removed"),u())}function yo(e){const t=ye(e.dataset.formId);if(!t)return;const a=new FormData(e),n={};t.questions.forEach(s=>{const o=`answer:${s.id}`,l=a.getAll(o).filter(c=>c instanceof File?c.name:String(c||"").trim());n[s.id]=l.length>1?l.map(c=>c instanceof File?c.name:c):l[0]instanceof File?l[0].name:l[0]||""}),i.formResponses.unshift(pa({company_id:t.company_id,form_id:t.id,submitter_email:String(a.get("submitter_email")||""),submitted_by:String(a.get("submitter_email")||C().profile.full_name||"Preview submitter"),answers:n,created_at:new Date().toISOString()})),i.formsTab="responses",i.modal="",J("Preview response saved"),u()}function _o(e,t,a="text/plain"){const n=new Blob([t],{type:a}),s=URL.createObjectURL(n),o=document.createElement("a");o.href=s,o.download=e,o.click(),URL.revokeObjectURL(s)}function ot(e){return JSON.parse(JSON.stringify(e))}function Z(e){return Array.from(new Set(e.map(t=>String(t||"").trim()).filter(Boolean)))}function le(e){return{todo:"To do",pending:"Pending",hold:"On hold",review:"Review",done:"Done"}[e]||A(e)}function He(e){return{lead:"Lead",bid:"Bid",admin:"Admin",invoicing:"Invoicing",ar:"AR",meeting:"Meeting",web_dev:"Web dev"}[e]||A(e)}function ee(e){return Yt.find(([t])=>t===e)?.[1]||i.driveFolders.find(t=>t.id===e)?.name||A(e||"Shared")}function ho(e=p()){return Yt.map(([t,a])=>[t,a]).concat(xe(e).map(t=>[t.id,t.name]))}function $o(e){const t=String(e||"").toLowerCase();return t.includes("photo")?"photos":t.includes("permit")?"permits":t.includes("contract")?"contracts":t.includes("form")?"forms":t.includes("archive")?"archive":"shared"}function Ui(e){const t=ve(e);return t==="Image"?"ti-photo":t==="PDF"?"ti-file-type-pdf":t==="Archive"?"ti-file-zip":t==="Excel"?"ti-file-spreadsheet":t==="Word"?"ti-file-type-doc":t==="PowerPoint"?"ti-file-type-ppt":t==="Text"?"ti-file-text":"ti-file-description"}function A(e){return String(e||"").replace(/[_-]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function S(e=0){return new Date(Date.now()+e*864e5).toISOString().slice(0,10)}function M(e){if(!e)return"No date";const t=new Date(e);return Number.isNaN(t.getTime())?String(e):new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric"}).format(t)}function Oa(e){if(!e)return"No time";const t=new Date(e);return Number.isNaN(t.getTime())?String(e):new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"}).format(t)}function Ge(e){const t=Math.max(0,Math.floor(T(e)/1e3)),a=Math.floor(t/3600),n=Math.floor(t%3600/60);return a?`${a}h ${String(n).padStart(2,"0")}m`:`${n}m`}function ya(e){const t=T(e);if(!t)return"0 B";const a=["B","KB","MB","GB"],n=Math.min(Math.floor(Math.log(t)/Math.log(1024)),a.length-1);return`${(t/1024**n).toFixed(n?1:0)} ${a[n]}`}function Re(e){return(t,a)=>Date.parse(a[e]||a.updated_at||a.created_at||0)-Date.parse(t[e]||t.updated_at||t.created_at||0)}function Qi(e){if(!e)return 0;const t=new Date(`${String(e).slice(0,10)}T00:00:00`);return Number.isNaN(t.getTime())?0:Math.floor((qt().getTime()-t.getTime())/864e5)}function Ra(e){if(!e)return 999;const t=new Date(`${String(e).slice(0,10)}T00:00:00`);return Number.isNaN(t.getTime())?999:Math.floor((t.getTime()-qt().getTime())/864e5)}function wo(e=p()){const t=(yt(vt(e)||{short_name:e})||e||"QH").replace(/[^a-z]/gi,"").slice(0,2).toUpperCase()||"QH",a=be(e).length+1;return`${t}-${String(1e3+a)}`}function qt(){const e=new Date;return e.setHours(0,0,0,0),e}function So(e,t){return`${Vi(e,t)}%`}function Vi(e,t){const a=T(t);return a?Math.max(0,Math.min(100,Math.round(T(e)/a*100))):0}function De(e){return{critical:5,urgent:4,high:3,medium:2,low:1}[String(e||"").toLowerCase()]||0}function _a(e){return String(e||"file").toLowerCase().replace(/[^a-z0-9.]+/g,"-").replace(/^-+|-+$/g,"")||"file"}function K(e,t){return e.reduce((a,n)=>a+T(n[t]),0)}function T(e){const t=Number(e);return Number.isFinite(t)?t:0}function ha(e){return/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(String(e||""))}function Pt(e){const t=String(e||"").trim();return ha(t)||/^[0-9a-f]{8,}$/i.test(t)||/^user[_-]?[0-9a-f-]{8,}$/i.test(t)}function ko(e){const t=String(e||"").trim();return t?t.slice(0,8):""}function _(e){return new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:0}).format(T(e))}function ue(e,t){try{const a=localStorage.getItem(e);return a?JSON.parse(a):t}catch{return t}}function E(e,t){const a=ue(e,t);return Array.isArray(a)&&a.length?a:t}function x(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}}function r(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}
