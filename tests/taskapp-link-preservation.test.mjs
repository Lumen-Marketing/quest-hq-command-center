...
const utilsSource = readFileSync(new URL('../taskmanagement/js/utils.js', import.meta.url), 'utf8');
...
const detailSource = readFileSync(
  new URL('../taskmanagement/js/views/TaskDetailView.js', import.meta.url),
  'utf8',
).replace(/\r\n/g, '\n');
...
const cssSource = readFileSync(
  new URL('../taskmanagement/taskmanagement.css', import.meta.url),
  'utf8',
).replace(/\r\n/g, '\n');
