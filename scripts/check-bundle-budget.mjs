...
import { checkBundleBudget, DEFAULT_BUNDLE_LIMITS } from './bundle-budget-lib.mjs';
...
const failures = checkBundleBudget({ manifest, gzipSizes, limits: DEFAULT_BUNDLE_LIMITS });
if (failures.length) {
