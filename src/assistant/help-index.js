...
export const HELP_TOPICS = [
  {
    ...
    guide: {
      ...
      tip: 'If a module is missing, it may be disabled for this workspace or hidden by your role. Ask the workspace owner to check Setup > Modules and People & Access.',
    },
  },
  {
    id: 'workspace-setup',
    ...
    answer: 'New workspaces open the guided setup automatically. Owners can reopen it later from Setup > Workspaces without changing sibling workspaces.',
    category: 'workspace-setup',
    kind: 'tutorial',
    readingMinutes: 3,
    moduleId: 'setup',
    permission: 'settings.manage',
    route: { section: 'setup', params: { tab: 'workspaces' }, label: 'Open Workspace Setup' },
    guide: {
      ...
      steps: [
        ...
        'To revisit the guide later, open Setup > Workspaces and choose Open setup. This version includes Cancel.',
      ],
  ...
  },
  {
    ...
    route: { section: 'users', params: { tab: 'roles' }, label: 'Open Roles' },
    guide: {
      ...
      steps: [
        'Open Company > People & Access > Roles to review built-in and custom roles and the tools each role can reach.',
  ...
  },
  {
    ...
    answer: 'Company plans make modules available, while each operational workspace independently enables the tools and configuration it needs from Setup > Modules.',
    category: 'workspace-setup',
    kind: 'tutorial',
    readingMinutes: 2,
    moduleId: 'setup',
    permission: 'settings.manage',
    route: { section: 'setup', params: { tab: 'modules' }, label: 'Open Modules' },
    guide: {
      intro: 'Modules are activated per operational workspace, so a Sales workspace can use different tools from Production inside the same company account.',
      steps: [
        'Select the operational workspace you want to configure from the left workspace list.',
        'Open Setup > Modules and review the tools available to that company plan.',
  ...
  },
  {
    ...
    moduleId: 'setup',
    permission: 'settings.manage',
    route: { section: 'setup', params: { tab: 'workspaces', focus: 'create-operational-workspace' }, label: 'Create a Workspace' },
    ...
    guide: {
      ...
      steps: [
        'Select the plus control beside Workspaces in the left rail, or open Setup > Workspaces and choose Create workspace.',
  ...
  },
  {
    ...
    permission: 'users.manage',
    route: { section: 'users', label: 'Open People' },
    answer: 'Invite teammates and set what they can see under Company > People & Access, including members, roles, access, and invites.',
  },
  {
    id: 'switch-company',
