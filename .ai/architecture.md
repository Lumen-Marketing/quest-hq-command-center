...
- Deleting a field stops it being collected and displayed; the values already stored under its id stay in `field_values`. Adding the field back brings them into view again, which makes a mistaken delete recoverable without a restore.
