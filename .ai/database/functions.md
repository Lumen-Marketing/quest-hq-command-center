...
Live public-schema routines captured 2026-07-21T00:27:56.075Z. Execute flags describe role grants visible in the catalog; application authorization must still be enforced by the routine and RLS.
...
| apply_workspace_plugin_preset | target_workspace_id uuid, preset_code text | text[] | yes | volatile | authenticated, service_role |
...
| create_operational_workspace | target_company_id text, workspace_name text, preset_code text, icon_key text | uuid | yes | volatile | authenticated, service_role |
...
| replace_workspace_pipeline_stages | p_workspace_id uuid, p_kind text, p_stages jsonb, p_rename_map jsonb | SETOF pipeline_stages | yes | volatile | authenticated, service_role |
...
| set_workspace_member | target_workspace_id uuid, target_profile_id uuid, target_role_id uuid, next_status text | workspace_memberships | yes | volatile | authenticated, service_role |
| set_workspace_plugin | target_workspace_id uuid, target_plugin_id text, next_status text | text | yes | volatile | authenticated, service_role |
...
| update_operational_workspace | target_workspace_id uuid, workspace_name text, workspace_description text, icon_key text, next_status text | workspaces | yes | volatile | authenticated, service_role |
...
| accounts | workspace_default_on_insert | BEFORE | INSERT | ROW |
| accounts | workspace_record_links_match | AFTER | INSERT | ROW |
| accounts | workspace_record_links_match | AFTER | UPDATE | ROW |
| activities | activities_set_updated_at | BEFORE | UPDATE | ROW |
| activities | workspace_default_on_insert | BEFORE | INSERT | ROW |
| activities | workspace_record_links_match | AFTER | INSERT | ROW |
| activities | workspace_record_links_match | AFTER | UPDATE | ROW |
...
| contacts | workspace_default_on_insert | BEFORE | INSERT | ROW |
| contacts | workspace_record_links_match | AFTER | INSERT | ROW |
| contacts | workspace_record_links_match | AFTER | UPDATE | ROW |
| crm_sites | crm_sites_set_updated_at | BEFORE | UPDATE | ROW |
| crm_sites | workspace_default_on_insert | BEFORE | INSERT | ROW |
| crm_sites | workspace_record_links_match | AFTER | INSERT | ROW |
| crm_sites | workspace_record_links_match | AFTER | UPDATE | ROW |
| deals | deals_set_updated_at | BEFORE | UPDATE | ROW |
| deals | workspace_default_on_insert | BEFORE | INSERT | ROW |
| deals | workspace_record_links_match | AFTER | INSERT | ROW |
| deals | workspace_record_links_match | AFTER | UPDATE | ROW |
...
| job_files | workspace_default_on_insert | BEFORE | INSERT | ROW |
| job_files | workspace_record_links_match | AFTER | INSERT | ROW |
| job_files | workspace_record_links_match | AFTER | UPDATE | ROW |
| jobs | jobs_set_updated_at | BEFORE | UPDATE | ROW |
| jobs | workspace_default_on_insert | BEFORE | INSERT | ROW |
| jobs | workspace_record_links_match | AFTER | INSERT | ROW |
| jobs | workspace_record_links_match | AFTER | UPDATE | ROW |
...
| pipeline_stages | workspace_default_on_insert | BEFORE | INSERT | ROW |
| pipeline_stages | workspace_record_links_match | AFTER | INSERT | ROW |
| pipeline_stages | workspace_record_links_match | AFTER | UPDATE | ROW |
...
| proposal_documents | workspace_default_on_insert | BEFORE | INSERT | ROW |
| proposal_documents | workspace_record_links_match | AFTER | INSERT | ROW |
| proposal_documents | workspace_record_links_match | AFTER | UPDATE | ROW |
...
| tasks | workspace_default_on_insert | BEFORE | INSERT | ROW |
| tasks | workspace_record_links_match | AFTER | INSERT | ROW |
| tasks | workspace_record_links_match | AFTER | UPDATE | ROW |
| underwriting_cases | underwriting_cases_set_updated_at | BEFORE | UPDATE | ROW |
| underwriting_cases | workspace_default_on_insert | BEFORE | INSERT | ROW |
| underwriting_cases | workspace_record_links_match | AFTER | INSERT | ROW |
| underwriting_cases | workspace_record_links_match | AFTER | UPDATE | ROW |
...
| workspace_memberships | workspace_membership_role_matches | AFTER | INSERT | ROW |
| workspace_memberships | workspace_membership_role_matches | AFTER | UPDATE | ROW |
| workspace_memberships | workspace_memberships_set_updated_at | BEFORE | UPDATE | ROW |
| workspace_plugins | workspace_plugins_set_updated_at | BEFORE | UPDATE | ROW |
| workspaces | workspaces_protect_identity | BEFORE | UPDATE | ROW |
| workspaces | workspaces_set_updated_at | BEFORE | UPDATE | ROW |
