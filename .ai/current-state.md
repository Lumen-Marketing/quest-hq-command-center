...
- Apply `20260730192246_additional_command_center_hardening.sql` before deploying its lifecycle-v2 client calls, then verify old-client, current-client, archive, reject, Stripe cancel/reactivate, and manual-reactivation paths against the live catalog.
