...
App.TaskListView = class TaskListView {
  ...
  applyHeader(view) {
    const titles = {
      ...
      'review':    { eyebrow: 'Ops review: verify the update, proof or next step', title: 'Needs review' },
      'noupdate':  { eyebrow: 'Open work with no update yet today', title: 'No update today' },
      'recent':    { eyebrow: 'Completed in the last 7 days', title: 'Recently completed' },
